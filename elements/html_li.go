...
// package html li is generated from configuration file.
// Description:
package elements
...
// Create a new LIElement element.
// This will create a new element with the tag
// "li" during rendering.
func LI(children ...ElementRenderer) *LIElement {
	e := NewElement("li", children...)
	e.IsSelfClosing = false
	e.Descendants = children

	return &LIElement{Element: e}
}

func (e *LIElement) Children(children ...ElementRenderer) *LIElement {
	e.Descendants = append(e.Descendants, children...)
	return e
}

func (e *LIElement) IfChildren(condition bool, children ...ElementRenderer) *LIElement {
	if condition {
		e.Descendants = append(e.Descendants, children...)
	}
	return e
...
func (e *LIElement) TernChildren(condition bool, trueChildren, falseChildren ElementRenderer) *LIElement {
	if condition {
...
func (e *LIElement) Attr(name string, value string) *LIElement {
...
func (e *LIElement) Attrs(attrs ...string) *LIElement {
	if len(attrs)%2 != 0 {
...
func (e *LIElement) AttrsMap(attrs map[string]string) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	for k, v := range attrs {
...
func (e *LIElement) ACCESSKEY(r rune) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
// off/none.
func (e *LIElement) AUTOCAPITALIZE(c LiAutocapitalizeChoice) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
type LiAutocapitalizeChoice string

const (
	// Do not automatically capitalize any text.
	LiAutocapitalize_off LiAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	LiAutocapitalize_none LiAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	LiAutocapitalize_sentences LiAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	LiAutocapitalize_on LiAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	LiAutocapitalize_words LiAutocapitalizeChoice = "words"
...
func (e *LIElement) CONTENTEDITABLE(c LiContenteditableChoice) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
type LiContenteditableChoice string

const (
	// The element is editable.
	LiContenteditable_empty LiContenteditableChoice = ""
	// The element is editable.
	LiContenteditable_true LiContenteditableChoice = "true"
	// The element is not editable.
	LiContenteditable_false LiContenteditableChoice = "false"
...
func (e *LIElement) DIR(c LiDirChoice) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *LIElement) DRAGGABLE(c LiDraggableChoice) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
type LiDraggableChoice string

const (
	// The element is draggable.
	LiDraggable_true LiDraggableChoice = "true"
	// The element is not draggable.
	LiDraggable_false LiDraggableChoice = "false"
	...
	LiDraggable_empty LiDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged
	// For other elements, the event ondragstart must be set for drag and drop to work
...
func (e *LIElement) ENTERKEYHINT(c LiEnterkeyhintChoice) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *LIElement) EXPORTPARTS(s ...string) *LIElement {
	if e.DelimitedStrings == nil {
		e.DelimitedStrings = treemap.New[string, *DelimitedBuilder[string]]()
	}
...
func (e *LIElement) HIDDEN(c LiHiddenChoice) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *LIElement) INERT() *LIElement {
	e.INERTSet(true)
	return e
}
...
func (e *LIElement) INPUTMODE(c LiInputmodeChoice) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
type LiInputmodeChoice string

const (
	// No virtual keyboard
	// For when the page implements its own keyboard input control.
	LiInputmode_none LiInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	LiInputmode_empty LiInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	LiInputmode_text LiInputmodeChoice = "text"
	...
	LiInputmode_decimal LiInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9
	// Devices may or may not show a minus key.
	LiInputmode_numeric LiInputmodeChoice = "numeric"
	...
	// type="tel"> instead.
	LiInputmode_tel LiInputmodeChoice = "tel"
	...
	// instead.
	LiInputmode_search LiInputmodeChoice = "search"
	...
	// instead.
	LiInputmode_email LiInputmodeChoice = "email"
...
// is being applied to.
func (e *LIElement) IS(s string) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *LIElement) ITEMSCOPE() *LIElement {
	e.ITEMSCOPESet(true)
	return e
}
...
func (e *LIElement) PART(s ...string) *LIElement {
	if e.DelimitedStrings == nil {
		e.DelimitedStrings = treemap.New[string, *DelimitedBuilder[string]]()
	}
...
func (e *LIElement) ROLERemove(s string) *LIElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *LIElement) SPELLCHECK(c LiSpellcheckChoice) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
type LiSpellcheckChoice string

const (
	// The element will be checked for spelling errors.
	LiSpellcheck_empty LiSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	LiSpellcheck_true LiSpellcheckChoice = "true"
...
func (e *LIElement) STYLEMap(m map[string]string) *LIElement {
	if e.KVStrings == nil {
		e.KVStrings = treemap.New[string, *KVBuilder]()
	}
	kv, ok := e.KVStrings.Get("style")
...
func (e *LIElement) STYLEPairs(pairs ...string) *LIElement {
	if len(pairs)%2 != 0 {
...
// them unchanged.
func (e *LIElement) TRANSLATE(c LiTranslateChoice) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
type LiTranslateChoice string

const (
	// indicates that the element should be translated when the page is localized.
	LiTranslate_empty LiTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	LiTranslate_yes LiTranslateChoice = "yes"
...
func (e *LIElement) DATASTAR_ATTR(key string, expression string) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-attr
func (e *LIElement) IfDATASTAR_ATTR(condition bool, key string, expression string) *LIElement {
	if condition {
...
func (e *LIElement) DATASTAR_ATTRRemove(key string) *LIElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *LIElement) DATASTAR_BIND(key string, expression string) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-bind
func (e *LIElement) IfDATASTAR_BIND(condition bool, key string, expression string) *LIElement {
	if condition {
...
func (e *LIElement) DATASTAR_BINDRemove(key string) *LIElement {
	if e.StringAttributes == nil {
		return e
	}
...
type LiClassMod customDataKeyModifier
...
func (e *LIElement) DATASTAR_CLASS(key string, expression string, modifiers ...LiClassMod) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m LiClassMod, i int) customDataKeyModifier {
...
// Adds or removes a class to or from an element based on an expression.
func (e *LIElement) IfDATASTAR_CLASS(condition bool, key string, expression string, modifiers ...LiClassMod) *LIElement {
	if condition {
...
func (e *LIElement) DATASTAR_CLASSRemove(key string) *LIElement {
	if e.StringAttributes == nil {
		return e
	}
...
type LiComputedMod customDataKeyModifier
...
func (e *LIElement) DATASTAR_COMPUTED(key string, expression string, modifiers ...LiComputedMod) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m LiComputedMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-computed
func (e *LIElement) IfDATASTAR_COMPUTED(condition bool, key string, expression string, modifiers ...LiComputedMod) *LIElement {
	if condition {
...
func (e *LIElement) DATASTAR_COMPUTEDRemove(key string) *LIElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *LIElement) DATASTAR_EFFECT(expression string) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-effect
func (e *LIElement) IfDATASTAR_EFFECT(condition bool, expression string) *LIElement {
	if condition {
...
func (e *LIElement) DATASTAR_EFFECTRemove() *LIElement {
	if e.StringAttributes == nil {
		return e
	}
...
type LiIgnoreMod customDataKeyModifier

// Only ignore the element itself, not its descendants.
func LiIgnoreModSelf() LiIgnoreMod {
	return func() string {
		return "self"
	}
}
...
func (e *LIElement) DATASTAR_IGNORESet(b bool, modifiers ...LiIgnoreMod) *LIElement {
	key := customDataKey("data-ignore")
	customMods := lo.Map(modifiers, func(m LiIgnoreMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	if e.BoolAttributes == nil {
...
//
// See: https://data-star.dev/reference/attributes#data-ignore
func (e *LIElement) DATASTAR_IGNORE(modifiers ...LiIgnoreMod) *LIElement {
...
func (e *LIElement) DATASTAR_IGNORE_MORPHSet(b bool) *LIElement {
...
//
// See: https://data-star.dev/reference/attributes#data-ignore-morph
func (e *LIElement) DATASTAR_IGNORE_MORPH() *LIElement {
	return e.DATASTAR_IGNORE_MORPHSet(true)
}

type LiIndicatorMod customDataKeyModifier
...
func (e *LIElement) DATASTAR_INDICATOR(expression string, modifiers ...LiIndicatorMod) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m LiIndicatorMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *LIElement) IfDATASTAR_INDICATOR(condition bool, expression string, modifiers ...LiIndicatorMod) *LIElement {
	if condition {
...
func (e *LIElement) DATASTAR_INDICATORRemove() *LIElement {
	if e.StringAttributes == nil {
		return e
	}
...
type LiInitMod customDataKeyModifier

// Delay the event listener in milliseconds.
func LiInitModDelayMs(
	d time.Duration,
) LiInitMod {
	return func() string {
...
func LiInitModViewTransition() LiInitMod {
	return func() string {
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *LIElement) DATASTAR_INIT(expression string, modifiers ...LiInitMod) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m LiInitMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *LIElement) IfDATASTAR_INIT(condition bool, expression string, modifiers ...LiInitMod) *LIElement {
	if condition {
...
func (e *LIElement) DATASTAR_INITRemove() *LIElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *LIElement) DATASTAR_JSON_SIGNALS(expression string, modifiers ...LiJsonSignalsMod) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m LiJsonSignalsMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-json-signals
func (e *LIElement) IfDATASTAR_JSON_SIGNALS(condition bool, expression string, modifiers ...LiJsonSignalsMod) *LIElement {
	if condition {
...
func (e *LIElement) DATASTAR_JSON_SIGNALSRemove() *LIElement {
	if e.StringAttributes == nil {
		return e
	}
...
func LiOnModDebounceMsNoTrailing(
	d time.Duration,
) LiOnMod {
	return func() string {
...
func LiOnModDebounceSecLeading(
	d time.Duration,
) LiOnMod {
	return func() string {
...
func LiOnModDebounceSecNoTrailing(
	d time.Duration,
) LiOnMod {
	return func() string {
...
func LiOnModThrottleMsNoLeading(
	d time.Duration,
) LiOnMod {
	return func() string {
...
func LiOnModThrottleMsTrailing(
	d time.Duration,
) LiOnMod {
	return func() string {
...
func LiOnModThrottleSecNoLeading(
	d time.Duration,
) LiOnMod {
	return func() string {
...
func LiOnModThrottleSecTrailing(
	d time.Duration,
) LiOnMod {
	return func() string {
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func LiOnModViewTransition() LiOnMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *LIElement) DATASTAR_ONRemove(key string) *LIElement {
	if e.StringAttributes == nil {
		return e
	}
...
type LiOnIntersectMod customDataKeyModifier

// Only run the expression once
// Only works with built-in events.
func LiOnIntersectModOnce() LiOnIntersectMod {
	return func() string {
		return "once"
	}
}
...
func LiOnIntersectModHalf() LiOnIntersectMod {
	return func() string {
		return "half"
	}
}
...
func LiOnIntersectModFull() LiOnIntersectMod {
	return func() string {
		return "full"
	}
}
...
// Debounces the event handler
func LiOnIntersectModDebounceMs(
	d time.Duration,
) LiOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms", d.Milliseconds())
...
// Debounce the event listener in milliseconds with leading edge.
func LiOnIntersectModDebounceMsLeading(
	d time.Duration,
) LiOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.leading", d.Milliseconds())
...
// Debounce the event listener in milliseconds without trailing edge.
func LiOnIntersectModDebounceMsNoTrailing(
	d time.Duration,
) LiOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.notrailing", d.Milliseconds())
...
// Debounces the event handler
func LiOnIntersectModDebounceSec(
	d time.Duration,
) LiOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds", int(d.Seconds()))
...
// Debounce the event listener in seconds with leading edge.
func LiOnIntersectModDebounceSecLeading(
	d time.Duration,
) LiOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.leading", int(d.Seconds()))
...
// Debounce the event listener in seconds without trailing edge.
func LiOnIntersectModDebounceSecNoTrailing(
	d time.Duration,
) LiOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.notrailing", int(d.Seconds()))
...
// Throttles the event handler
func LiOnIntersectModThrottleMs(
	d time.Duration,
) LiOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms", d.Milliseconds())
...
// Throttle the event listener in milliseconds without leading edge.
func LiOnIntersectModThrottleMsNoLeading(
	d time.Duration,
) LiOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.noleading", d.Milliseconds())
...
// Throttle the event listener in milliseconds with trailing edge.
func LiOnIntersectModThrottleMsTrailing(
	d time.Duration,
) LiOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.trailing", d.Milliseconds())
...
// Throttles the event listener in seconds.
func LiOnIntersectModThrottleSec(
	d time.Duration,
) LiOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds", int(d.Seconds()))
...
// Throttle the event listener in seconds without leading edge.
func LiOnIntersectModThrottleSecNoLeading(
	d time.Duration,
) LiOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.noleading", int(d.Seconds()))
...
// Throttle the event listener in seconds with trailing edge.
func LiOnIntersectModThrottleSecTrailing(
	d time.Duration,
) LiOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.trailing", int(d.Seconds()))
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func LiOnIntersectModViewTransition() LiOnIntersectMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *LIElement) DATASTAR_ON_INTERSECT(expression string, modifiers ...LiOnIntersectMod) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m LiOnIntersectMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
// Runs an expression when the element intersects with the viewport.
func (e *LIElement) IfDATASTAR_ON_INTERSECT(condition bool, expression string, modifiers ...LiOnIntersectMod) *LIElement {
	if condition {
...
func (e *LIElement) DATASTAR_ON_INTERSECTRemove() *LIElement {
	if e.StringAttributes == nil {
		return e
	}
...
type LiOnIntervalMod customDataKeyModifier

// Sets the interval duration in milliseconds.
func LiOnIntervalModDurationMs(
	d time.Duration,
) LiOnIntervalMod {
	return func() string {
...
func LiOnIntervalModDurationMsLeading(
	d time.Duration,
) LiOnIntervalMod {
	return func() string {
...
func LiOnIntervalModDurationSec(
	d time.Duration,
) LiOnIntervalMod {
	return func() string {
...
// Sets the interval duration in seconds
// Execute the first interval immediately.
func LiOnIntervalModDurationSecLeading(
	d time.Duration,
) LiOnIntervalMod {
	return func() string {
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func LiOnIntervalModViewTransition() LiOnIntervalMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *LIElement) DATASTAR_ON_INTERVAL(expression string, modifiers ...LiOnIntervalMod) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m LiOnIntervalMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on-interval
func (e *LIElement) IfDATASTAR_ON_INTERVAL(condition bool, expression string, modifiers ...LiOnIntervalMod) *LIElement {
	if condition {
...
func (e *LIElement) DATASTAR_ON_INTERVALRemove() *LIElement {
	if e.StringAttributes == nil {
		return e
	}
...
type LiOnSignalPatchMod customDataKeyModifier

// Delay the event listener in milliseconds.
func LiOnSignalPatchModDelayMs(
	d time.Duration,
) LiOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("delay.%dms", d.Milliseconds())
...
// Delay the event listener in seconds.
func LiOnSignalPatchModDelaySec(
	d time.Duration,
) LiOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("delay.%ds", int(d.Seconds()))
...
// Debounces the event handler
func LiOnSignalPatchModDebounceMs(
	d time.Duration,
) LiOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms", d.Milliseconds())
...
// Debounce the event listener in milliseconds with leading edge.
func LiOnSignalPatchModDebounceMsLeading(
	d time.Duration,
) LiOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.leading", d.Milliseconds())
...
// Debounce the event listener in milliseconds without trailing edge.
func LiOnSignalPatchModDebounceMsNoTrailing(
	d time.Duration,
) LiOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.notrailing", d.Milliseconds())
...
// Debounces the event handler
func LiOnSignalPatchModDebounceSec(
	d time.Duration,
) LiOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds", int(d.Seconds()))
...
// Debounce the event listener in seconds with leading edge.
func LiOnSignalPatchModDebounceSecLeading(
	d time.Duration,
) LiOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.leading", int(d.Seconds()))
...
// Debounce the event listener in seconds without trailing edge.
func LiOnSignalPatchModDebounceSecNoTrailing(
	d time.Duration,
) LiOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.notrailing", int(d.Seconds()))
...
// Throttles the event handler
func LiOnSignalPatchModThrottleMs(
	d time.Duration,
) LiOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms", d.Milliseconds())
...
// Throttle the event listener in milliseconds without leading edge.
func LiOnSignalPatchModThrottleMsNoLeading(
	d time.Duration,
) LiOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.noleading", d.Milliseconds())
...
// Throttle the event listener in milliseconds with trailing edge.
func LiOnSignalPatchModThrottleMsTrailing(
	d time.Duration,
) LiOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.trailing", d.Milliseconds())
...
// Throttles the event listener in seconds.
func LiOnSignalPatchModThrottleSec(
	d time.Duration,
) LiOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds", int(d.Seconds()))
...
// Throttle the event listener in seconds without leading edge.
func LiOnSignalPatchModThrottleSecNoLeading(
	d time.Duration,
) LiOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.noleading", int(d.Seconds()))
...
// Throttle the event listener in seconds with trailing edge.
func LiOnSignalPatchModThrottleSecTrailing(
	d time.Duration,
) LiOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.trailing", int(d.Seconds()))
...
func (e *LIElement) DATASTAR_ON_SIGNAL_PATCH(expression string, modifiers ...LiOnSignalPatchMod) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m LiOnSignalPatchMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on-signal-patch
func (e *LIElement) IfDATASTAR_ON_SIGNAL_PATCH(condition bool, expression string, modifiers ...LiOnSignalPatchMod) *LIElement {
	if condition {
...
func (e *LIElement) DATASTAR_ON_SIGNAL_PATCHRemove() *LIElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *LIElement) DATASTAR_ON_SIGNAL_PATCH_FILTER(expression string) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-on-signal-patch-filter
func (e *LIElement) IfDATASTAR_ON_SIGNAL_PATCH_FILTER(condition bool, expression string) *LIElement {
	if condition {
...
func (e *LIElement) DATASTAR_ON_SIGNAL_PATCH_FILTERRemove() *LIElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *LIElement) DATASTAR_PRESERVE_ATTR(expression string) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-preserve-attr
func (e *LIElement) IfDATASTAR_PRESERVE_ATTR(condition bool, expression string) *LIElement {
	if condition {
...
func (e *LIElement) DATASTAR_PRESERVE_ATTRRemove() *LIElement {
	if e.StringAttributes == nil {
		return e
	}
...
type LiRefMod customDataKeyModifier
...
func (e *LIElement) DATASTAR_REF(expression string, modifiers ...LiRefMod) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m LiRefMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-ref
func (e *LIElement) IfDATASTAR_REF(condition bool, expression string, modifiers ...LiRefMod) *LIElement {
	if condition {
...
func (e *LIElement) DATASTAR_SHOW(expression string) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-show
func (e *LIElement) IfDATASTAR_SHOW(condition bool, expression string) *LIElement {
	if condition {
...
func (e *LIElement) DATASTAR_SHOWRemove() *LIElement {
	if e.StringAttributes == nil {
		return e
	}
...
type LiSignalsMod customDataKeyModifier
...
func LiSignalsModIfMissing() LiSignalsMod {
	return func() string {
		return "ifmissing"
	}
}
...
func (e *LIElement) DATASTAR_SIGNALS(key string, expression string, modifiers ...LiSignalsMod) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m LiSignalsMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-signals
func (e *LIElement) IfDATASTAR_SIGNALS(condition bool, key string, expression string, modifiers ...LiSignalsMod) *LIElement {
	if condition {
...
func (e *LIElement) DATASTAR_SIGNALSRemove(key string) *LIElement {
	if e.StringAttributes == nil {
		return e
	}
...
type LiStyleMod customDataKeyModifier
...
func (e *LIElement) DATASTAR_STYLE(key string, expression string, modifiers ...LiStyleMod) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m LiStyleMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-style
func (e *LIElement) IfDATASTAR_STYLE(condition bool, key string, expression string, modifiers ...LiStyleMod) *LIElement {
	if condition {
...
func (e *LIElement) DATASTAR_STYLERemove(key string) *LIElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *LIElement) DATASTAR_TEXT(expression string) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-text
func (e *LIElement) IfDATASTAR_TEXT(condition bool, expression string) *LIElement {
	if condition {
