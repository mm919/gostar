...
// package html mark is generated from configuration file.
// Description:
package elements
...
// Create a new MARKElement element.
// This will create a new element with the tag
// "mark" during rendering.
func MARK(children ...ElementRenderer) *MARKElement {
	e := NewElement("mark", children...)
	e.IsSelfClosing = false
	e.Descendants = children

	return &MARKElement{Element: e}
}

func (e *MARKElement) Children(children ...ElementRenderer) *MARKElement {
	e.Descendants = append(e.Descendants, children...)
	return e
}

func (e *MARKElement) IfChildren(condition bool, children ...ElementRenderer) *MARKElement {
	if condition {
		e.Descendants = append(e.Descendants, children...)
	}
	return e
...
func (e *MARKElement) TernChildren(condition bool, trueChildren, falseChildren ElementRenderer) *MARKElement {
	if condition {
...
func (e *MARKElement) Attr(name string, value string) *MARKElement {
...
func (e *MARKElement) Attrs(attrs ...string) *MARKElement {
	if len(attrs)%2 != 0 {
...
func (e *MARKElement) AttrsMap(attrs map[string]string) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	for k, v := range attrs {
...
func (e *MARKElement) ACCESSKEY(r rune) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
// off/none.
func (e *MARKElement) AUTOCAPITALIZE(c MarkAutocapitalizeChoice) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
type MarkAutocapitalizeChoice string

const (
	// Do not automatically capitalize any text.
	MarkAutocapitalize_off MarkAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	MarkAutocapitalize_none MarkAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	MarkAutocapitalize_sentences MarkAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	MarkAutocapitalize_on MarkAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	MarkAutocapitalize_words MarkAutocapitalizeChoice = "words"
...
func (e *MARKElement) CONTENTEDITABLE(c MarkContenteditableChoice) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
type MarkContenteditableChoice string

const (
	// The element is editable.
	MarkContenteditable_empty MarkContenteditableChoice = ""
	// The element is editable.
	MarkContenteditable_true MarkContenteditableChoice = "true"
	// The element is not editable.
	MarkContenteditable_false MarkContenteditableChoice = "false"
...
func (e *MARKElement) DIR(c MarkDirChoice) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *MARKElement) DRAGGABLE(c MarkDraggableChoice) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
type MarkDraggableChoice string

const (
	// The element is draggable.
	MarkDraggable_true MarkDraggableChoice = "true"
	// The element is not draggable.
	MarkDraggable_false MarkDraggableChoice = "false"
	...
	MarkDraggable_empty MarkDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged
	// For other elements, the event ondragstart must be set for drag and drop to work
...
func (e *MARKElement) ENTERKEYHINT(c MarkEnterkeyhintChoice) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *MARKElement) EXPORTPARTS(s ...string) *MARKElement {
	if e.DelimitedStrings == nil {
		e.DelimitedStrings = treemap.New[string, *DelimitedBuilder[string]]()
	}
...
func (e *MARKElement) HIDDEN(c MarkHiddenChoice) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
type MarkHiddenChoice string

const (
	// set the element to the hidden state
	// Additionally, invalid values set the element to the hidden state.
	MarkHidden_empty MarkHiddenChoice = ""
	// set the element to the hidden state
	// Additionally, invalid values set the element to the hidden state.
	MarkHidden_hidden MarkHiddenChoice = "hidden"
...
// Its purpose is to identify the element when linking (using a fragment
// identifier), scripting, or styling (with CSS).
func (e *MARKElement) IDRemoveF(format string, args ...any) *MARKElement {
...
func (e *MARKElement) INPUTMODE(c MarkInputmodeChoice) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
type MarkInputmodeChoice string

const (
	// No virtual keyboard
	// For when the page implements its own keyboard input control.
	MarkInputmode_none MarkInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	MarkInputmode_empty MarkInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	MarkInputmode_text MarkInputmodeChoice = "text"
	...
	MarkInputmode_decimal MarkInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9
	// Devices may or may not show a minus key.
	MarkInputmode_numeric MarkInputmodeChoice = "numeric"
	...
	// type="tel"> instead.
	MarkInputmode_tel MarkInputmodeChoice = "tel"
	...
	// instead.
	MarkInputmode_search MarkInputmodeChoice = "search"
	...
	// instead.
	MarkInputmode_email MarkInputmodeChoice = "email"
...
// is being applied to.
func (e *MARKElement) IS(s string) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
// successfully defined in the current document, and extends the element type it
// is being applied to.
func (e *MARKElement) ISRemoveF(format string, args ...any) *MARKElement {
...
// The vocabulary defines whether several items with the same global identifier
// can coexist and, if so, how items with the same identifier are handled.
func (e *MARKElement) ITEMIDRemoveF(format string, args ...any) *MARKElement {
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *MARKElement) ITEMPROPRemoveF(format string, args ...any) *MARKElement {
...
// with additional properties The itemref attribute can only be specified on
// elements that have an itemscope attribute specified.
func (e *MARKElement) ITEMREFRemoveF(format string, args ...any) *MARKElement {
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *MARKElement) ITEMTYPERemoveF(format string, args ...any) *MARKElement {
...
// Identifying Languages (BCP47) IETF document
// xml:lang has priority over it.
func (e *MARKElement) LANGRemoveF(format string, args ...any) *MARKElement {
...
// It is a cryptographic nonce (number used once) that is used by Content Security
// Policy to determine whether or not a given inline script is allowed to execute.
func (e *MARKElement) NONCERemoveF(format string, args ...any) *MARKElement {
...
func (e *MARKElement) PART(s ...string) *MARKElement {
	if e.DelimitedStrings == nil {
		e.DelimitedStrings = treemap.New[string, *DelimitedBuilder[string]]()
	}
...
// It is a simple string value that can be used to describe the role of an
// element.
func (e *MARKElement) IfROLE(condition bool, s string) *MARKElement {
	if condition {
		e.ROLE(s)
	}
	return e
...
func (e *MARKElement) ROLERemove(s string) *MARKElement {
	if e.StringAttributes == nil {
		return e
	}
...
// It is a simple string value that can be used to describe the role of an
// element.
func (e *MARKElement) ROLERemoveF(format string, args ...any) *MARKElement {
...
// the <slot> element whose name attribute's value matches that slot attribute's
// value.
func (e *MARKElement) SLOTRemoveF(format string, args ...any) *MARKElement {
...
func (e *MARKElement) SPELLCHECK(c MarkSpellcheckChoice) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
type MarkSpellcheckChoice string

const (
	// The element will be checked for spelling errors.
	MarkSpellcheck_empty MarkSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	MarkSpellcheck_true MarkSpellcheckChoice = "true"
...
func (e *MARKElement) STYLEMap(m map[string]string) *MARKElement {
	if e.KVStrings == nil {
		e.KVStrings = treemap.New[string, *KVBuilder]()
	}
	kv, ok := e.KVStrings.Get("style")
...
func (e *MARKElement) STYLEPairs(pairs ...string) *MARKElement {
	if len(pairs)%2 != 0 {
...
// <input> element, this is not good practice
// Use a <label> instead.
func (e *MARKElement) TITLERemoveF(format string, args ...any) *MARKElement {
...
// them unchanged.
func (e *MARKElement) TRANSLATE(c MarkTranslateChoice) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
type MarkTranslateChoice string

const (
	// indicates that the element should be translated when the page is localized.
	MarkTranslate_empty MarkTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	MarkTranslate_yes MarkTranslateChoice = "yes"
...
func (e *MARKElement) DATASTAR_ATTR(key string, expression string) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-attr
func (e *MARKElement) IfDATASTAR_ATTR(condition bool, key string, expression string) *MARKElement {
	if condition {
...
func (e *MARKElement) DATASTAR_ATTRRemove(key string) *MARKElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *MARKElement) DATASTAR_BIND(key string, expression string) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-bind
func (e *MARKElement) IfDATASTAR_BIND(condition bool, key string, expression string) *MARKElement {
	if condition {
...
func (e *MARKElement) DATASTAR_BINDRemove(key string) *MARKElement {
	if e.StringAttributes == nil {
		return e
	}
...
type MarkClassMod customDataKeyModifier
...
func (e *MARKElement) DATASTAR_CLASS(key string, expression string, modifiers ...MarkClassMod) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m MarkClassMod, i int) customDataKeyModifier {
...
// Adds or removes a class to or from an element based on an expression.
func (e *MARKElement) IfDATASTAR_CLASS(condition bool, key string, expression string, modifiers ...MarkClassMod) *MARKElement {
	if condition {
...
func (e *MARKElement) DATASTAR_CLASSRemove(key string) *MARKElement {
	if e.StringAttributes == nil {
		return e
	}
...
type MarkComputedMod customDataKeyModifier
...
func (e *MARKElement) DATASTAR_COMPUTED(key string, expression string, modifiers ...MarkComputedMod) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m MarkComputedMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-computed
func (e *MARKElement) IfDATASTAR_COMPUTED(condition bool, key string, expression string, modifiers ...MarkComputedMod) *MARKElement {
	if condition {
...
func (e *MARKElement) DATASTAR_COMPUTEDRemove(key string) *MARKElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *MARKElement) DATASTAR_EFFECT(expression string) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-effect
func (e *MARKElement) IfDATASTAR_EFFECT(condition bool, expression string) *MARKElement {
	if condition {
...
func (e *MARKElement) DATASTAR_EFFECTRemove() *MARKElement {
	if e.StringAttributes == nil {
		return e
	}
...
type MarkIgnoreMod customDataKeyModifier

// Only ignore the element itself, not its descendants.
func MarkIgnoreModSelf() MarkIgnoreMod {
	return func() string {
		return "self"
	}
}
...
func (e *MARKElement) DATASTAR_IGNORESet(b bool, modifiers ...MarkIgnoreMod) *MARKElement {
	key := customDataKey("data-ignore")
	customMods := lo.Map(modifiers, func(m MarkIgnoreMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	if e.BoolAttributes == nil {
...
//
// See: https://data-star.dev/reference/attributes#data-ignore
func (e *MARKElement) DATASTAR_IGNORE(modifiers ...MarkIgnoreMod) *MARKElement {
...
func (e *MARKElement) DATASTAR_IGNORE_MORPHSet(b bool) *MARKElement {
...
//
// See: https://data-star.dev/reference/attributes#data-ignore-morph
func (e *MARKElement) DATASTAR_IGNORE_MORPH() *MARKElement {
	return e.DATASTAR_IGNORE_MORPHSet(true)
}

type MarkIndicatorMod customDataKeyModifier
...
func (e *MARKElement) DATASTAR_INDICATOR(expression string, modifiers ...MarkIndicatorMod) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m MarkIndicatorMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *MARKElement) IfDATASTAR_INDICATOR(condition bool, expression string, modifiers ...MarkIndicatorMod) *MARKElement {
	if condition {
...
func (e *MARKElement) DATASTAR_INDICATORRemove() *MARKElement {
	if e.StringAttributes == nil {
		return e
	}
...
type MarkInitMod customDataKeyModifier

// Delay the event listener in milliseconds.
func MarkInitModDelayMs(
	d time.Duration,
) MarkInitMod {
	return func() string {
...
func MarkInitModViewTransition() MarkInitMod {
	return func() string {
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *MARKElement) DATASTAR_INIT(expression string, modifiers ...MarkInitMod) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m MarkInitMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *MARKElement) IfDATASTAR_INIT(condition bool, expression string, modifiers ...MarkInitMod) *MARKElement {
	if condition {
...
func (e *MARKElement) DATASTAR_INITRemove() *MARKElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *MARKElement) DATASTAR_JSON_SIGNALS(expression string, modifiers ...MarkJsonSignalsMod) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m MarkJsonSignalsMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-json-signals
func (e *MARKElement) IfDATASTAR_JSON_SIGNALS(condition bool, expression string, modifiers ...MarkJsonSignalsMod) *MARKElement {
	if condition {
...
func (e *MARKElement) DATASTAR_JSON_SIGNALSRemove() *MARKElement {
	if e.StringAttributes == nil {
		return e
	}
...
type MarkOnMod customDataKeyModifier

// Only run the expression once
// Only works with built-in events.
func MarkOnModOnce() MarkOnMod {
	return func() string {
		return "once"
	}
}
...
// Only works with built-in events.
func MarkOnModPassive() MarkOnMod {
	return func() string {
		return "passive"
	}
}
...
// Only works with built-in events.
func MarkOnModCapture() MarkOnMod {
	return func() string {
		return "capture"
	}
}
...
func MarkOnModDebounceMsLeading(
	d time.Duration,
) MarkOnMod {
	return func() string {
...
func MarkOnModDebounceMsNoTrailing(
	d time.Duration,
) MarkOnMod {
	return func() string {
...
func MarkOnModDebounceSecLeading(
	d time.Duration,
) MarkOnMod {
	return func() string {
...
func MarkOnModDebounceSecNoTrailing(
	d time.Duration,
) MarkOnMod {
	return func() string {
...
func MarkOnModThrottleMsNoLeading(
	d time.Duration,
) MarkOnMod {
	return func() string {
...
func MarkOnModThrottleMsTrailing(
	d time.Duration,
) MarkOnMod {
	return func() string {
...
func MarkOnModThrottleSecNoLeading(
	d time.Duration,
) MarkOnMod {
	return func() string {
...
func MarkOnModThrottleSecTrailing(
	d time.Duration,
) MarkOnMod {
	return func() string {
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func MarkOnModViewTransition() MarkOnMod {
	return func() string {
		return "viewtransition"
	}
}
...
func MarkOnModWindow() MarkOnMod {
	return func() string {
		return "window"
	}
}
...
func MarkOnModPrevent() MarkOnMod {
	return func() string {
		return "prevent"
	}
}
...
func MarkOnModOutside() MarkOnMod {
	return func() string {
		return "outside"
	}
}
...
func (e *MARKElement) DATASTAR_ON(key string, expression string, modifiers ...MarkOnMod) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m MarkOnMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on
func (e *MARKElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...MarkOnMod) *MARKElement {
	if condition {
...
func (e *MARKElement) DATASTAR_ONRemove(key string) *MARKElement {
	if e.StringAttributes == nil {
		return e
	}
...
type MarkOnIntersectMod customDataKeyModifier

// Only run the expression once
// Only works with built-in events.
func MarkOnIntersectModOnce() MarkOnIntersectMod {
	return func() string {
		return "once"
	}
}
...
func MarkOnIntersectModHalf() MarkOnIntersectMod {
	return func() string {
		return "half"
	}
}
...
func MarkOnIntersectModFull() MarkOnIntersectMod {
	return func() string {
		return "full"
	}
}
...
// Delay the event listener in milliseconds.
func MarkOnIntersectModDelayMs(
	d time.Duration,
) MarkOnIntersectMod {
	return func() string {
		return fmt.Sprintf("delay.%dms", d.Milliseconds())
...
// Delay the event listener in seconds.
func MarkOnIntersectModDelaySec(
	d time.Duration,
) MarkOnIntersectMod {
	return func() string {
		return fmt.Sprintf("delay.%ds", int(d.Seconds()))
...
// Debounces the event handler
func MarkOnIntersectModDebounceMs(
	d time.Duration,
) MarkOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms", d.Milliseconds())
...
// Debounce the event listener in milliseconds with leading edge.
func MarkOnIntersectModDebounceMsLeading(
	d time.Duration,
) MarkOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.leading", d.Milliseconds())
...
// Debounce the event listener in milliseconds without trailing edge.
func MarkOnIntersectModDebounceMsNoTrailing(
	d time.Duration,
) MarkOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.notrailing", d.Milliseconds())
...
// Debounces the event handler
func MarkOnIntersectModDebounceSec(
	d time.Duration,
) MarkOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds", int(d.Seconds()))
...
// Debounce the event listener in seconds with leading edge.
func MarkOnIntersectModDebounceSecLeading(
	d time.Duration,
) MarkOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.leading", int(d.Seconds()))
...
// Debounce the event listener in seconds without trailing edge.
func MarkOnIntersectModDebounceSecNoTrailing(
	d time.Duration,
) MarkOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.notrailing", int(d.Seconds()))
...
// Throttles the event handler
func MarkOnIntersectModThrottleMs(
	d time.Duration,
) MarkOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms", d.Milliseconds())
...
// Throttle the event listener in milliseconds without leading edge.
func MarkOnIntersectModThrottleMsNoLeading(
	d time.Duration,
) MarkOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.noleading", d.Milliseconds())
...
// Throttle the event listener in milliseconds with trailing edge.
func MarkOnIntersectModThrottleMsTrailing(
	d time.Duration,
) MarkOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.trailing", d.Milliseconds())
...
// Throttles the event listener in seconds.
func MarkOnIntersectModThrottleSec(
	d time.Duration,
) MarkOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds", int(d.Seconds()))
...
// Throttle the event listener in seconds without leading edge.
func MarkOnIntersectModThrottleSecNoLeading(
	d time.Duration,
) MarkOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.noleading", int(d.Seconds()))
...
// Throttle the event listener in seconds with trailing edge.
func MarkOnIntersectModThrottleSecTrailing(
	d time.Duration,
) MarkOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.trailing", int(d.Seconds()))
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func MarkOnIntersectModViewTransition() MarkOnIntersectMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *MARKElement) DATASTAR_ON_INTERSECT(expression string, modifiers ...MarkOnIntersectMod) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m MarkOnIntersectMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
// Runs an expression when the element intersects with the viewport.
func (e *MARKElement) IfDATASTAR_ON_INTERSECT(condition bool, expression string, modifiers ...MarkOnIntersectMod) *MARKElement {
	if condition {
...
func (e *MARKElement) DATASTAR_ON_INTERSECTRemove() *MARKElement {
	if e.StringAttributes == nil {
		return e
	}
...
type MarkOnIntervalMod customDataKeyModifier

// Sets the interval duration in milliseconds.
func MarkOnIntervalModDurationMs(
	d time.Duration,
) MarkOnIntervalMod {
	return func() string {
...
func MarkOnIntervalModDurationMsLeading(
	d time.Duration,
) MarkOnIntervalMod {
	return func() string {
...
func MarkOnIntervalModDurationSec(
	d time.Duration,
) MarkOnIntervalMod {
	return func() string {
...
// Sets the interval duration in seconds
// Execute the first interval immediately.
func MarkOnIntervalModDurationSecLeading(
	d time.Duration,
) MarkOnIntervalMod {
	return func() string {
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func MarkOnIntervalModViewTransition() MarkOnIntervalMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *MARKElement) DATASTAR_ON_INTERVAL(expression string, modifiers ...MarkOnIntervalMod) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m MarkOnIntervalMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on-interval
func (e *MARKElement) IfDATASTAR_ON_INTERVAL(condition bool, expression string, modifiers ...MarkOnIntervalMod) *MARKElement {
	if condition {
...
func (e *MARKElement) DATASTAR_ON_INTERVALRemove() *MARKElement {
	if e.StringAttributes == nil {
		return e
	}
...
type MarkOnSignalPatchMod customDataKeyModifier

// Delay the event listener in milliseconds.
func MarkOnSignalPatchModDelayMs(
	d time.Duration,
) MarkOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("delay.%dms", d.Milliseconds())
	}
}
...
// Delay the event listener in seconds.
func MarkOnSignalPatchModDelaySec(
	d time.Duration,
) MarkOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("delay.%ds", int(d.Seconds()))
...
// Debounces the event handler
func MarkOnSignalPatchModDebounceMs(
	d time.Duration,
) MarkOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms", d.Milliseconds())
...
// Debounce the event listener in milliseconds with leading edge.
func MarkOnSignalPatchModDebounceMsLeading(
	d time.Duration,
) MarkOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.leading", d.Milliseconds())
...
// Debounce the event listener in milliseconds without trailing edge.
func MarkOnSignalPatchModDebounceMsNoTrailing(
	d time.Duration,
) MarkOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.notrailing", d.Milliseconds())
...
// Debounces the event handler
func MarkOnSignalPatchModDebounceSec(
	d time.Duration,
) MarkOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds", int(d.Seconds()))
...
// Debounce the event listener in seconds with leading edge.
func MarkOnSignalPatchModDebounceSecLeading(
	d time.Duration,
) MarkOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.leading", int(d.Seconds()))
...
// Debounce the event listener in seconds without trailing edge.
func MarkOnSignalPatchModDebounceSecNoTrailing(
	d time.Duration,
) MarkOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.notrailing", int(d.Seconds()))
...
// Throttles the event handler
func MarkOnSignalPatchModThrottleMs(
	d time.Duration,
) MarkOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms", d.Milliseconds())
...
// Throttle the event listener in milliseconds without leading edge.
func MarkOnSignalPatchModThrottleMsNoLeading(
	d time.Duration,
) MarkOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.noleading", d.Milliseconds())
...
// Throttle the event listener in milliseconds with trailing edge.
func MarkOnSignalPatchModThrottleMsTrailing(
	d time.Duration,
) MarkOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.trailing", d.Milliseconds())
...
// Throttles the event listener in seconds.
func MarkOnSignalPatchModThrottleSec(
	d time.Duration,
) MarkOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds", int(d.Seconds()))
...
// Throttle the event listener in seconds without leading edge.
func MarkOnSignalPatchModThrottleSecNoLeading(
	d time.Duration,
) MarkOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.noleading", int(d.Seconds()))
...
// Throttle the event listener in seconds with trailing edge.
func MarkOnSignalPatchModThrottleSecTrailing(
	d time.Duration,
) MarkOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.trailing", int(d.Seconds()))
...
func (e *MARKElement) DATASTAR_ON_SIGNAL_PATCH(expression string, modifiers ...MarkOnSignalPatchMod) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m MarkOnSignalPatchMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on-signal-patch
func (e *MARKElement) IfDATASTAR_ON_SIGNAL_PATCH(condition bool, expression string, modifiers ...MarkOnSignalPatchMod) *MARKElement {
	if condition {
...
func (e *MARKElement) DATASTAR_ON_SIGNAL_PATCHRemove() *MARKElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *MARKElement) DATASTAR_ON_SIGNAL_PATCH_FILTER(expression string) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-on-signal-patch-filter
func (e *MARKElement) IfDATASTAR_ON_SIGNAL_PATCH_FILTER(condition bool, expression string) *MARKElement {
	if condition {
...
func (e *MARKElement) DATASTAR_ON_SIGNAL_PATCH_FILTERRemove() *MARKElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *MARKElement) DATASTAR_PRESERVE_ATTR(expression string) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-preserve-attr
func (e *MARKElement) IfDATASTAR_PRESERVE_ATTR(condition bool, expression string) *MARKElement {
	if condition {
...
func (e *MARKElement) DATASTAR_PRESERVE_ATTRRemove() *MARKElement {
	if e.StringAttributes == nil {
		return e
	}
...
type MarkRefMod customDataKeyModifier
...
func (e *MARKElement) DATASTAR_REF(expression string, modifiers ...MarkRefMod) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m MarkRefMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-ref
func (e *MARKElement) IfDATASTAR_REF(condition bool, expression string, modifiers ...MarkRefMod) *MARKElement {
	if condition {
...
func (e *MARKElement) DATASTAR_SHOW(expression string) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-show
func (e *MARKElement) IfDATASTAR_SHOW(condition bool, expression string) *MARKElement {
	if condition {
...
func (e *MARKElement) DATASTAR_SHOWRemove() *MARKElement {
	if e.StringAttributes == nil {
		return e
	}
...
type MarkSignalsMod customDataKeyModifier
...
func MarkSignalsModIfMissing() MarkSignalsMod {
	return func() string {
		return "ifmissing"
	}
}
...
func (e *MARKElement) DATASTAR_SIGNALS(key string, expression string, modifiers ...MarkSignalsMod) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m MarkSignalsMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-signals
func (e *MARKElement) IfDATASTAR_SIGNALS(condition bool, key string, expression string, modifiers ...MarkSignalsMod) *MARKElement {
	if condition {
...
func (e *MARKElement) DATASTAR_SIGNALSRemove(key string) *MARKElement {
	if e.StringAttributes == nil {
		return e
	}
...
type MarkStyleMod customDataKeyModifier
...
func (e *MARKElement) DATASTAR_STYLE(key string, expression string, modifiers ...MarkStyleMod) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m MarkStyleMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-style
func (e *MARKElement) IfDATASTAR_STYLE(condition bool, key string, expression string, modifiers ...MarkStyleMod) *MARKElement {
	if condition {
...
func (e *MARKElement) DATASTAR_STYLERemove(key string) *MARKElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *MARKElement) DATASTAR_TEXT(expression string) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-text
func (e *MARKElement) IfDATASTAR_TEXT(condition bool, expression string) *MARKElement {
	if condition {
