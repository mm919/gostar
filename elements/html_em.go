...
// package html em is generated from configuration file.
// Description:
package elements
...
// The <em> element can be nested, with each level of nesting indicating a greater
// degree of emphasis.
type EMElement struct {
	*Element
}

// Create a new EMElement element.
...
func (e *EMElement) Attr(name string, value string) *EMElement {
...
func (e *EMElement) Attrs(attrs ...string) *EMElement {
	if len(attrs)%2 != 0 {
...
func (e *EMElement) AttrsMap(attrs map[string]string) *EMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	for k, v := range attrs {
...
func (e *EMElement) CustomData(key, value string) *EMElement {
...
func (e *EMElement) IfCustomData(condition bool, key, value string) *EMElement {
	if condition {
...
func (e *EMElement) CustomDataF(key, format string, args ...any) *EMElement {
	return e.CustomData(key, fmt.Sprintf(format, args...))
}

func (e *EMElement) IfCustomDataF(condition bool, key, format string, args ...any) *EMElement {
	if condition {
...
func (e *EMElement) CustomDataRemove(key string) *EMElement {
	if e.CustomDataAttributes == nil {
		return e
	}
...
const (
	...
	EmAutocapitalize_off EmAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	EmAutocapitalize_none EmAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	EmAutocapitalize_sentences EmAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	EmAutocapitalize_on EmAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	EmAutocapitalize_words EmAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	EmAutocapitalize_characters EmAutocapitalizeChoice = "characters"
)
...
func (e *EMElement) AUTOCAPITALIZERemove(c EmAutocapitalizeChoice) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
// sighted user on a small device will equally miss the context created by the
// preceding content.
func (e *EMElement) AUTOFOCUSRemove(b bool) *EMElement {
	if e.BoolAttributes == nil {
		return e
	}
...
const (
	...
	EmContenteditable_empty EmContenteditableChoice = ""
	// The element is editable.
	EmContenteditable_true EmContenteditableChoice = "true"
	// The element is not editable.
	EmContenteditable_false EmContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	EmContenteditable_plaintext_only EmContenteditableChoice = "plaintext-only"
)
...
func (e *EMElement) CONTENTEDITABLERemove(c EmContenteditableChoice) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *EMElement) DIRRemove(c EmDirChoice) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
const (
	...
	EmDraggable_true EmDraggableChoice = "true"
	// The element is not draggable.
	EmDraggable_false EmDraggableChoice = "false"
	...
	EmDraggable_empty EmDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged
	// For other elements, the event ondragstart must be set for drag and drop to work
	EmDraggable_auto EmDraggableChoice = "auto"
)
...
func (e *EMElement) DRAGGABLERemove(c EmDraggableChoice) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
const (
	...
	EmHidden_empty EmHiddenChoice = ""
	// set the element to the hidden state
	// Additionally, invalid values set the element to the hidden state.
	EmHidden_hidden EmHiddenChoice = "hidden"
	...
	//
	EmHidden_until_found EmHiddenChoice = "until-found"
)
...
func (e *EMElement) HIDDENRemove(c EmHiddenChoice) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *EMElement) IDRemove(s string) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
// Its purpose is to identify the element when linking (using a fragment
// identifier), scripting, or styling (with CSS).
func (e *EMElement) IDRemoveF(format string, args ...any) *EMElement {
...
// Hides the element and its content from assistive technologies by excluding them
// from the accessibility tree.
func (e *EMElement) INERTRemove(b bool) *EMElement {
	if e.BoolAttributes == nil {
		return e
	}
...
const (
	...
	EmInputmode_none EmInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	EmInputmode_empty EmInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	EmInputmode_text EmInputmodeChoice = "text"
	...
	EmInputmode_decimal EmInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9
	// Devices may or may not show a minus key.
	EmInputmode_numeric EmInputmodeChoice = "numeric"
	...
	// type="tel"> instead.
	EmInputmode_tel EmInputmodeChoice = "tel"
	...
	// instead.
	EmInputmode_search EmInputmodeChoice = "search"
	...
	// instead.
	EmInputmode_email EmInputmodeChoice = "email"
	...
	EmInputmode_url EmInputmodeChoice = "url"
)
...
func (e *EMElement) INPUTMODERemove(c EmInputmodeChoice) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *EMElement) ISRemove(s string) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
// successfully defined in the current document, and extends the element type it
// is being applied to.
func (e *EMElement) ISRemoveF(format string, args ...any) *EMElement {
...
func (e *EMElement) ITEMIDRemove(s string) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
// The vocabulary defines whether several items with the same global identifier
// can coexist and, if so, how items with the same identifier are handled.
func (e *EMElement) ITEMIDRemoveF(format string, args ...any) *EMElement {
...
func (e *EMElement) ITEMPROPRemove(s string) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *EMElement) ITEMPROPRemoveF(format string, args ...any) *EMElement {
...
func (e *EMElement) ITEMREFRemove(s string) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
// with additional properties The itemref attribute can only be specified on
// elements that have an itemscope attribute specified.
func (e *EMElement) ITEMREFRemoveF(format string, args ...any) *EMElement {
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *EMElement) ITEMSCOPERemove(b bool) *EMElement {
	if e.BoolAttributes == nil {
		return e
	}
...
func (e *EMElement) ITEMTYPERemove(s string) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *EMElement) ITEMTYPERemoveF(format string, args ...any) *EMElement {
...
func (e *EMElement) LANGRemove(s string) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
// Identifying Languages (BCP47) IETF document
// xml:lang has priority over it.
func (e *EMElement) LANGRemoveF(format string, args ...any) *EMElement {
...
func (e *EMElement) NONCERemove(s string) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
// It is a cryptographic nonce (number used once) that is used by Content Security
// Policy to determine whether or not a given inline script is allowed to execute.
func (e *EMElement) NONCERemoveF(format string, args ...any) *EMElement {
...
const (
	...
	// on-screen at a time.
	EmPopover_auto EmPopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting outside
	// the popover area, and generally only allow one popover to be displayed
	// on-screen at a time.
	EmPopover_empty EmPopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases such
	// as nested popovers in menus.
	EmPopover_manual EmPopoverChoice = "manual"
)
...
func (e *EMElement) POPOVERRemove(c EmPopoverChoice) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *EMElement) ROLERemove(s string) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
// It is a simple string value that can be used to describe the role of an
// element.
func (e *EMElement) ROLERemoveF(format string, args ...any) *EMElement {
...
func (e *EMElement) SLOTRemove(s string) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
// the <slot> element whose name attribute's value matches that slot attribute's
// value.
func (e *EMElement) SLOTRemoveF(format string, args ...any) *EMElement {
...
const (
	...
	EmSpellcheck_empty EmSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	EmSpellcheck_true EmSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	EmSpellcheck_false EmSpellcheckChoice = "false"
)
...
func (e *EMElement) SPELLCHECKRemove(c EmSpellcheckChoice) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *EMElement) STYLEF(k string, format string, args ...any) *EMElement {
...
// font, size, and more
// Styles are written in CSS.
func (e *EMElement) IfSTYLE(condition bool, k string, v string) *EMElement {
	if condition {
		e.STYLE(k, v)
	}
	return e
...
// font, size, and more
// Styles are written in CSS.
func (e *EMElement) STYLE(k string, v string) *EMElement {
	if e.KVStrings == nil {
...
// font, size, and more
// Styles are written in CSS.
func (e *EMElement) IfSTYLEF(condition bool, k string, format string, args ...any) *EMElement {
	if condition {
...
// font, size, and more
// Styles are written in CSS.
func (e *EMElement) IfSTYLEPairs(condition bool, pairs ...string) *EMElement {
	if condition {
		e.STYLEPairs(pairs...)
	}
	return e
...
func (e *EMElement) TABINDEXRemove(i int) *EMElement {
	if e.IntAttributes == nil {
		return e
	}
...
func (e *EMElement) TITLERemove(s string) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
// <input> element, this is not good practice
// Use a <label> instead.
func (e *EMElement) TITLERemoveF(format string, args ...any) *EMElement {
...
const (
	...
	EmTranslate_empty EmTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	EmTranslate_yes EmTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	EmTranslate_no EmTranslateChoice = "no"
)
...
func (e *EMElement) TRANSLATERemove(c EmTranslateChoice) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *EMElement) DATASTAR_ATTR(key string, expression string) *EMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-attr
func (e *EMElement) IfDATASTAR_ATTR(condition bool, key string, expression string) *EMElement {
	if condition {
...
func (e *EMElement) DATASTAR_ATTRRemove(key string) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *EMElement) DATASTAR_BIND(key string, expression string) *EMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-bind
func (e *EMElement) IfDATASTAR_BIND(condition bool, key string, expression string) *EMElement {
	if condition {
...
func (e *EMElement) DATASTAR_BINDRemove(key string) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
type EmClassMod customDataKeyModifier
...
func (e *EMElement) DATASTAR_CLASS(key string, expression string, modifiers ...EmClassMod) *EMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m EmClassMod, i int) customDataKeyModifier {
...
// Adds or removes a class to or from an element based on an expression.
func (e *EMElement) IfDATASTAR_CLASS(condition bool, key string, expression string, modifiers ...EmClassMod) *EMElement {
	if condition {
...
func (e *EMElement) DATASTAR_CLASSRemove(key string) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
type EmComputedMod customDataKeyModifier
...
func (e *EMElement) DATASTAR_COMPUTED(key string, expression string, modifiers ...EmComputedMod) *EMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m EmComputedMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-computed
func (e *EMElement) IfDATASTAR_COMPUTED(condition bool, key string, expression string, modifiers ...EmComputedMod) *EMElement {
	if condition {
...
func (e *EMElement) DATASTAR_COMPUTEDRemove(key string) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *EMElement) DATASTAR_EFFECT(expression string) *EMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-effect
func (e *EMElement) IfDATASTAR_EFFECT(condition bool, expression string) *EMElement {
	if condition {
...
func (e *EMElement) DATASTAR_EFFECTRemove() *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
type EmIgnoreMod customDataKeyModifier

// Only ignore the element itself, not its descendants.
func EmIgnoreModSelf() EmIgnoreMod {
	return func() string {
		return "self"
	}
}
...
func (e *EMElement) DATASTAR_IGNORESet(b bool, modifiers ...EmIgnoreMod) *EMElement {
	key := customDataKey("data-ignore")
	customMods := lo.Map(modifiers, func(m EmIgnoreMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	if e.BoolAttributes == nil {
...
//
// See: https://data-star.dev/reference/attributes#data-ignore
func (e *EMElement) DATASTAR_IGNORE(modifiers ...EmIgnoreMod) *EMElement {
...
func (e *EMElement) DATASTAR_IGNORE_MORPHSet(b bool) *EMElement {
...
//
// See: https://data-star.dev/reference/attributes#data-ignore-morph
func (e *EMElement) DATASTAR_IGNORE_MORPH() *EMElement {
	return e.DATASTAR_IGNORE_MORPHSet(true)
}

type EmIndicatorMod customDataKeyModifier
...
func (e *EMElement) DATASTAR_INDICATOR(expression string, modifiers ...EmIndicatorMod) *EMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m EmIndicatorMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *EMElement) IfDATASTAR_INDICATOR(condition bool, expression string, modifiers ...EmIndicatorMod) *EMElement {
	if condition {
...
func (e *EMElement) DATASTAR_INDICATORRemove() *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
type EmInitMod customDataKeyModifier

// Delay the event listener in milliseconds.
func EmInitModDelayMs(
	d time.Duration,
) EmInitMod {
	return func() string {
...
func EmInitModViewTransition() EmInitMod {
	return func() string {
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *EMElement) DATASTAR_INIT(expression string, modifiers ...EmInitMod) *EMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m EmInitMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *EMElement) IfDATASTAR_INIT(condition bool, expression string, modifiers ...EmInitMod) *EMElement {
	if condition {
...
func (e *EMElement) DATASTAR_INITRemove() *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *EMElement) DATASTAR_JSON_SIGNALS(expression string, modifiers ...EmJsonSignalsMod) *EMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m EmJsonSignalsMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-json-signals
func (e *EMElement) IfDATASTAR_JSON_SIGNALS(condition bool, expression string, modifiers ...EmJsonSignalsMod) *EMElement {
	if condition {
...
func (e *EMElement) DATASTAR_JSON_SIGNALSRemove() *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
func EmOnModDebounceMsNoTrailing(
	d time.Duration,
) EmOnMod {
	return func() string {
...
func EmOnModDebounceSecLeading(
	d time.Duration,
) EmOnMod {
	return func() string {
...
func EmOnModDebounceSecNoTrailing(
	d time.Duration,
) EmOnMod {
	return func() string {
...
func EmOnModThrottleMsNoLeading(
	d time.Duration,
) EmOnMod {
	return func() string {
...
func EmOnModThrottleMsTrailing(
	d time.Duration,
) EmOnMod {
	return func() string {
...
func EmOnModThrottleSecNoLeading(
	d time.Duration,
) EmOnMod {
	return func() string {
...
func EmOnModThrottleSecTrailing(
	d time.Duration,
) EmOnMod {
	return func() string {
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func EmOnModViewTransition() EmOnMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *EMElement) DATASTAR_ON(key string, expression string, modifiers ...EmOnMod) *EMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m EmOnMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on
func (e *EMElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...EmOnMod) *EMElement {
	if condition {
...
func (e *EMElement) DATASTAR_ONRemove(key string) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
type EmOnIntersectMod customDataKeyModifier

// Only run the expression once
// Only works with built-in events.
func EmOnIntersectModOnce() EmOnIntersectMod {
	return func() string {
		return "once"
	}
}
...
func EmOnIntersectModHalf() EmOnIntersectMod {
	return func() string {
		return "half"
	}
}
...
func EmOnIntersectModFull() EmOnIntersectMod {
	return func() string {
		return "full"
	}
}
...
// Debounces the event handler
func EmOnIntersectModDebounceMs(
	d time.Duration,
) EmOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms", d.Milliseconds())
...
// Debounce the event listener in milliseconds with leading edge.
func EmOnIntersectModDebounceMsLeading(
	d time.Duration,
) EmOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.leading", d.Milliseconds())
...
// Debounce the event listener in milliseconds without trailing edge.
func EmOnIntersectModDebounceMsNoTrailing(
	d time.Duration,
) EmOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.notrailing", d.Milliseconds())
...
// Debounces the event handler
func EmOnIntersectModDebounceSec(
	d time.Duration,
) EmOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds", int(d.Seconds()))
...
// Debounce the event listener in seconds with leading edge.
func EmOnIntersectModDebounceSecLeading(
	d time.Duration,
) EmOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.leading", int(d.Seconds()))
...
// Debounce the event listener in seconds without trailing edge.
func EmOnIntersectModDebounceSecNoTrailing(
	d time.Duration,
) EmOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.notrailing", int(d.Seconds()))
...
// Throttles the event handler
func EmOnIntersectModThrottleMs(
	d time.Duration,
) EmOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms", d.Milliseconds())
...
// Throttle the event listener in milliseconds without leading edge.
func EmOnIntersectModThrottleMsNoLeading(
	d time.Duration,
) EmOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.noleading", d.Milliseconds())
...
// Throttle the event listener in milliseconds with trailing edge.
func EmOnIntersectModThrottleMsTrailing(
	d time.Duration,
) EmOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.trailing", d.Milliseconds())
...
// Throttles the event listener in seconds.
func EmOnIntersectModThrottleSec(
	d time.Duration,
) EmOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds", int(d.Seconds()))
...
// Throttle the event listener in seconds without leading edge.
func EmOnIntersectModThrottleSecNoLeading(
	d time.Duration,
) EmOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.noleading", int(d.Seconds()))
...
// Throttle the event listener in seconds with trailing edge.
func EmOnIntersectModThrottleSecTrailing(
	d time.Duration,
) EmOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.trailing", int(d.Seconds()))
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func EmOnIntersectModViewTransition() EmOnIntersectMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *EMElement) DATASTAR_ON_INTERSECT(expression string, modifiers ...EmOnIntersectMod) *EMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m EmOnIntersectMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
// Runs an expression when the element intersects with the viewport.
func (e *EMElement) IfDATASTAR_ON_INTERSECT(condition bool, expression string, modifiers ...EmOnIntersectMod) *EMElement {
	if condition {
...
func (e *EMElement) DATASTAR_ON_INTERSECTRemove() *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
type EmOnIntervalMod customDataKeyModifier

// Sets the interval duration in milliseconds.
func EmOnIntervalModDurationMs(
	d time.Duration,
) EmOnIntervalMod {
	return func() string {
...
func EmOnIntervalModDurationMsLeading(
	d time.Duration,
) EmOnIntervalMod {
	return func() string {
...
func EmOnIntervalModDurationSec(
	d time.Duration,
) EmOnIntervalMod {
	return func() string {
...
// Sets the interval duration in seconds
// Execute the first interval immediately.
func EmOnIntervalModDurationSecLeading(
	d time.Duration,
) EmOnIntervalMod {
	return func() string {
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func EmOnIntervalModViewTransition() EmOnIntervalMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *EMElement) DATASTAR_ON_INTERVAL(expression string, modifiers ...EmOnIntervalMod) *EMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m EmOnIntervalMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on-interval
func (e *EMElement) IfDATASTAR_ON_INTERVAL(condition bool, expression string, modifiers ...EmOnIntervalMod) *EMElement {
	if condition {
...
func (e *EMElement) DATASTAR_ON_INTERVALRemove() *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
type EmOnSignalPatchMod customDataKeyModifier

// Delay the event listener in milliseconds.
func EmOnSignalPatchModDelayMs(
	d time.Duration,
) EmOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("delay.%dms", d.Milliseconds())
...
// Delay the event listener in seconds.
func EmOnSignalPatchModDelaySec(
	d time.Duration,
) EmOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("delay.%ds", int(d.Seconds()))
...
// Debounces the event handler
func EmOnSignalPatchModDebounceMs(
	d time.Duration,
) EmOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms", d.Milliseconds())
...
// Debounce the event listener in milliseconds with leading edge.
func EmOnSignalPatchModDebounceMsLeading(
	d time.Duration,
) EmOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.leading", d.Milliseconds())
...
// Debounce the event listener in milliseconds without trailing edge.
func EmOnSignalPatchModDebounceMsNoTrailing(
	d time.Duration,
) EmOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.notrailing", d.Milliseconds())
...
// Debounces the event handler
func EmOnSignalPatchModDebounceSec(
	d time.Duration,
) EmOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds", int(d.Seconds()))
...
// Debounce the event listener in seconds with leading edge.
func EmOnSignalPatchModDebounceSecLeading(
	d time.Duration,
) EmOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.leading", int(d.Seconds()))
...
// Debounce the event listener in seconds without trailing edge.
func EmOnSignalPatchModDebounceSecNoTrailing(
	d time.Duration,
) EmOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.notrailing", int(d.Seconds()))
...
// Throttles the event handler
func EmOnSignalPatchModThrottleMs(
	d time.Duration,
) EmOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms", d.Milliseconds())
...
// Throttle the event listener in milliseconds without leading edge.
func EmOnSignalPatchModThrottleMsNoLeading(
	d time.Duration,
) EmOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.noleading", d.Milliseconds())
...
// Throttle the event listener in milliseconds with trailing edge.
func EmOnSignalPatchModThrottleMsTrailing(
	d time.Duration,
) EmOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.trailing", d.Milliseconds())
...
// Throttles the event listener in seconds.
func EmOnSignalPatchModThrottleSec(
	d time.Duration,
) EmOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds", int(d.Seconds()))
...
// Throttle the event listener in seconds without leading edge.
func EmOnSignalPatchModThrottleSecNoLeading(
	d time.Duration,
) EmOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.noleading", int(d.Seconds()))
...
// Throttle the event listener in seconds with trailing edge.
func EmOnSignalPatchModThrottleSecTrailing(
	d time.Duration,
) EmOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.trailing", int(d.Seconds()))
...
func (e *EMElement) DATASTAR_ON_SIGNAL_PATCH(expression string, modifiers ...EmOnSignalPatchMod) *EMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m EmOnSignalPatchMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on-signal-patch
func (e *EMElement) IfDATASTAR_ON_SIGNAL_PATCH(condition bool, expression string, modifiers ...EmOnSignalPatchMod) *EMElement {
	if condition {
...
func (e *EMElement) DATASTAR_ON_SIGNAL_PATCHRemove() *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *EMElement) DATASTAR_ON_SIGNAL_PATCH_FILTER(expression string) *EMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-on-signal-patch-filter
func (e *EMElement) IfDATASTAR_ON_SIGNAL_PATCH_FILTER(condition bool, expression string) *EMElement {
	if condition {
...
func (e *EMElement) DATASTAR_ON_SIGNAL_PATCH_FILTERRemove() *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *EMElement) DATASTAR_PRESERVE_ATTR(expression string) *EMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-preserve-attr
func (e *EMElement) IfDATASTAR_PRESERVE_ATTR(condition bool, expression string) *EMElement {
	if condition {
...
func (e *EMElement) DATASTAR_PRESERVE_ATTRRemove() *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
type EmRefMod customDataKeyModifier
...
func (e *EMElement) DATASTAR_REF(expression string, modifiers ...EmRefMod) *EMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m EmRefMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-ref
func (e *EMElement) IfDATASTAR_REF(condition bool, expression string, modifiers ...EmRefMod) *EMElement {
	if condition {
...
func (e *EMElement) DATASTAR_REFRemove() *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *EMElement) DATASTAR_SHOW(expression string) *EMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-show
func (e *EMElement) IfDATASTAR_SHOW(condition bool, expression string) *EMElement {
	if condition {
...
func (e *EMElement) DATASTAR_SHOWRemove() *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
type EmSignalsMod customDataKeyModifier
...
func EmSignalsModIfMissing() EmSignalsMod {
	return func() string {
		return "ifmissing"
	}
}
...
func (e *EMElement) DATASTAR_SIGNALS(key string, expression string, modifiers ...EmSignalsMod) *EMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m EmSignalsMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-signals
func (e *EMElement) IfDATASTAR_SIGNALS(condition bool, key string, expression string, modifiers ...EmSignalsMod) *EMElement {
	if condition {
...
func (e *EMElement) DATASTAR_SIGNALSRemove(key string) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
type EmStyleMod customDataKeyModifier
...
func (e *EMElement) DATASTAR_STYLE(key string, expression string, modifiers ...EmStyleMod) *EMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m EmStyleMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-style
func (e *EMElement) IfDATASTAR_STYLE(condition bool, key string, expression string, modifiers ...EmStyleMod) *EMElement {
	if condition {
...
func (e *EMElement) DATASTAR_STYLERemove(key string) *EMElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *EMElement) DATASTAR_TEXT(expression string) *EMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-text
func (e *EMElement) IfDATASTAR_TEXT(condition bool, expression string) *EMElement {
	if condition {
...
func (e *EMElement) DATASTAR_TEXTRemove() *EMElement {
	if e.StringAttributes == nil {
		return e
	}
