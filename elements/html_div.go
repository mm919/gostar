...
// package html div is generated from configuration file.
// Description:
package elements
...
// Use it to group elements for purposes such as styling (using the class or id
// attributes), marking a section of a document in a different language (using the
// lang attribute), and so on.
type DIVElement struct {
	*Element
}

// Create a new DIVElement element.
// This will create a new element with the tag
// "div" during rendering.
func DIV(children ...ElementRenderer) *DIVElement {
	e := NewElement("div", children...)
	e.IsSelfClosing = false
	e.Descendants = children

	return &DIVElement{Element: e}
}

func (e *DIVElement) Children(children ...ElementRenderer) *DIVElement {
	e.Descendants = append(e.Descendants, children...)
	return e
}

func (e *DIVElement) IfChildren(condition bool, children ...ElementRenderer) *DIVElement {
	if condition {
		e.Descendants = append(e.Descendants, children...)
	}
	return e
...
func (e *DIVElement) TernChildren(condition bool, trueChildren, falseChildren ElementRenderer) *DIVElement {
	if condition {
...
func (e *DIVElement) Attr(name string, value string) *DIVElement {
...
func (e *DIVElement) Attrs(attrs ...string) *DIVElement {
	if len(attrs)%2 != 0 {
...
func (e *DIVElement) AttrsMap(attrs map[string]string) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	for k, v := range attrs {
...
func (e *DIVElement) ACCESSKEY(r rune) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
// off/none.
func (e *DIVElement) AUTOCAPITALIZE(c DivAutocapitalizeChoice) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
type DivAutocapitalizeChoice string

const (
	// Do not automatically capitalize any text.
	DivAutocapitalize_off DivAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	DivAutocapitalize_none DivAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	DivAutocapitalize_sentences DivAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	DivAutocapitalize_on DivAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	DivAutocapitalize_words DivAutocapitalizeChoice = "words"
...
func (e *DIVElement) CONTENTEDITABLE(c DivContenteditableChoice) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
type DivContenteditableChoice string

const (
	// The element is editable.
	DivContenteditable_empty DivContenteditableChoice = ""
	// The element is editable.
	DivContenteditable_true DivContenteditableChoice = "true"
	// The element is not editable.
	DivContenteditable_false DivContenteditableChoice = "false"
...
func (e *DIVElement) DIR(c DivDirChoice) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *DIVElement) DRAGGABLE(c DivDraggableChoice) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
type DivDraggableChoice string

const (
	// The element is draggable.
	DivDraggable_true DivDraggableChoice = "true"
	// The element is not draggable.
	DivDraggable_false DivDraggableChoice = "false"
	...
	DivDraggable_empty DivDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged
	// For other elements, the event ondragstart must be set for drag and drop to work
...
func (e *DIVElement) ENTERKEYHINT(c DivEnterkeyhintChoice) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *DIVElement) EXPORTPARTS(s ...string) *DIVElement {
	if e.DelimitedStrings == nil {
		e.DelimitedStrings = treemap.New[string, *DelimitedBuilder[string]]()
	}
...
func (e *DIVElement) HIDDEN(c DivHiddenChoice) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *DIVElement) INPUTMODE(c DivInputmodeChoice) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
type DivInputmodeChoice string

const (
	// No virtual keyboard
	// For when the page implements its own keyboard input control.
	DivInputmode_none DivInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	DivInputmode_empty DivInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	DivInputmode_text DivInputmodeChoice = "text"
	...
	DivInputmode_decimal DivInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9
	// Devices may or may not show a minus key.
	DivInputmode_numeric DivInputmodeChoice = "numeric"
	...
	// type="tel"> instead.
	DivInputmode_tel DivInputmodeChoice = "tel"
	...
	// instead.
	DivInputmode_search DivInputmodeChoice = "search"
	...
	// instead.
	DivInputmode_email DivInputmodeChoice = "email"
...
// is being applied to.
func (e *DIVElement) IS(s string) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *DIVElement) PART(s ...string) *DIVElement {
	if e.DelimitedStrings == nil {
		e.DelimitedStrings = treemap.New[string, *DelimitedBuilder[string]]()
	}
...
// styling.
func (e *DIVElement) POPOVER(c DivPopoverChoice) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
const (
	...
	// on-screen at a time.
	DivPopover_auto DivPopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting outside
	// the popover area, and generally only allow one popover to be displayed
	// on-screen at a time.
	DivPopover_empty DivPopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases such
	// as nested popovers in menus.
	DivPopover_manual DivPopoverChoice = "manual"
)
...
func (e *DIVElement) POPOVERRemove(c DivPopoverChoice) *DIVElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *DIVElement) ROLERemove(s string) *DIVElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *DIVElement) SPELLCHECK(c DivSpellcheckChoice) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
type DivSpellcheckChoice string

const (
	// The element will be checked for spelling errors.
	DivSpellcheck_empty DivSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	DivSpellcheck_true DivSpellcheckChoice = "true"
...
func (e *DIVElement) STYLEMap(m map[string]string) *DIVElement {
	if e.KVStrings == nil {
		e.KVStrings = treemap.New[string, *KVBuilder]()
	}
	kv, ok := e.KVStrings.Get("style")
...
func (e *DIVElement) STYLEPairs(pairs ...string) *DIVElement {
	if len(pairs)%2 != 0 {
...
// them unchanged.
func (e *DIVElement) TRANSLATE(c DivTranslateChoice) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
type DivTranslateChoice string

const (
	// indicates that the element should be translated when the page is localized.
	DivTranslate_empty DivTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	DivTranslate_yes DivTranslateChoice = "yes"
...
func (e *DIVElement) DATASTAR_ATTR(key string, expression string) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-attr
func (e *DIVElement) IfDATASTAR_ATTR(condition bool, key string, expression string) *DIVElement {
	if condition {
...
func (e *DIVElement) DATASTAR_ATTRRemove(key string) *DIVElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *DIVElement) DATASTAR_BIND(key string, expression string) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-bind
func (e *DIVElement) IfDATASTAR_BIND(condition bool, key string, expression string) *DIVElement {
	if condition {
...
func (e *DIVElement) DATASTAR_BINDRemove(key string) *DIVElement {
	if e.StringAttributes == nil {
		return e
	}
...
type DivClassMod customDataKeyModifier
...
func (e *DIVElement) DATASTAR_CLASS(key string, expression string, modifiers ...DivClassMod) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m DivClassMod, i int) customDataKeyModifier {
...
// Adds or removes a class to or from an element based on an expression.
func (e *DIVElement) IfDATASTAR_CLASS(condition bool, key string, expression string, modifiers ...DivClassMod) *DIVElement {
	if condition {
...
func (e *DIVElement) DATASTAR_CLASSRemove(key string) *DIVElement {
	if e.StringAttributes == nil {
		return e
	}
...
type DivComputedMod customDataKeyModifier
...
func (e *DIVElement) DATASTAR_COMPUTED(key string, expression string, modifiers ...DivComputedMod) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m DivComputedMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-computed
func (e *DIVElement) IfDATASTAR_COMPUTED(condition bool, key string, expression string, modifiers ...DivComputedMod) *DIVElement {
	if condition {
...
func (e *DIVElement) DATASTAR_COMPUTEDRemove(key string) *DIVElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *DIVElement) DATASTAR_EFFECT(expression string) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-effect
func (e *DIVElement) IfDATASTAR_EFFECT(condition bool, expression string) *DIVElement {
	if condition {
...
func (e *DIVElement) DATASTAR_EFFECTRemove() *DIVElement {
	if e.StringAttributes == nil {
		return e
	}
...
type DivIgnoreMod customDataKeyModifier

// Only ignore the element itself, not its descendants.
func DivIgnoreModSelf() DivIgnoreMod {
	return func() string {
		return "self"
	}
}
...
func (e *DIVElement) DATASTAR_IGNORESet(b bool, modifiers ...DivIgnoreMod) *DIVElement {
	key := customDataKey("data-ignore")
	customMods := lo.Map(modifiers, func(m DivIgnoreMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	if e.BoolAttributes == nil {
...
//
// See: https://data-star.dev/reference/attributes#data-ignore
func (e *DIVElement) DATASTAR_IGNORE(modifiers ...DivIgnoreMod) *DIVElement {
...
func (e *DIVElement) DATASTAR_IGNORE_MORPHSet(b bool) *DIVElement {
...
//
// See: https://data-star.dev/reference/attributes#data-ignore-morph
func (e *DIVElement) DATASTAR_IGNORE_MORPH() *DIVElement {
	return e.DATASTAR_IGNORE_MORPHSet(true)
}

type DivIndicatorMod customDataKeyModifier
...
func (e *DIVElement) DATASTAR_INDICATOR(expression string, modifiers ...DivIndicatorMod) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m DivIndicatorMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *DIVElement) IfDATASTAR_INDICATOR(condition bool, expression string, modifiers ...DivIndicatorMod) *DIVElement {
	if condition {
...
func (e *DIVElement) DATASTAR_INDICATORRemove() *DIVElement {
	if e.StringAttributes == nil {
		return e
	}
...
type DivInitMod customDataKeyModifier

// Delay the event listener in milliseconds.
func DivInitModDelayMs(
	d time.Duration,
) DivInitMod {
	return func() string {
...
func DivInitModViewTransition() DivInitMod {
	return func() string {
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *DIVElement) DATASTAR_INIT(expression string, modifiers ...DivInitMod) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m DivInitMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *DIVElement) IfDATASTAR_INIT(condition bool, expression string, modifiers ...DivInitMod) *DIVElement {
	if condition {
...
func (e *DIVElement) DATASTAR_INITRemove() *DIVElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *DIVElement) DATASTAR_JSON_SIGNALS(expression string, modifiers ...DivJsonSignalsMod) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m DivJsonSignalsMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-json-signals
func (e *DIVElement) IfDATASTAR_JSON_SIGNALS(condition bool, expression string, modifiers ...DivJsonSignalsMod) *DIVElement {
	if condition {
...
func (e *DIVElement) DATASTAR_JSON_SIGNALSRemove() *DIVElement {
	if e.StringAttributes == nil {
		return e
	}
...
func DivOnModDebounceMsLeading(
	d time.Duration,
) DivOnMod {
	return func() string {
...
func DivOnModDebounceMsNoTrailing(
	d time.Duration,
) DivOnMod {
	return func() string {
...
func DivOnModDebounceSecLeading(
	d time.Duration,
) DivOnMod {
	return func() string {
...
func DivOnModDebounceSecNoTrailing(
	d time.Duration,
) DivOnMod {
	return func() string {
...
func DivOnModThrottleMsNoLeading(
	d time.Duration,
) DivOnMod {
	return func() string {
...
func DivOnModThrottleMsTrailing(
	d time.Duration,
) DivOnMod {
	return func() string {
...
func DivOnModThrottleSecNoLeading(
	d time.Duration,
) DivOnMod {
	return func() string {
...
func DivOnModThrottleSecTrailing(
	d time.Duration,
) DivOnMod {
	return func() string {
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func DivOnModViewTransition() DivOnMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *DIVElement) DATASTAR_ONRemove(key string) *DIVElement {
	if e.StringAttributes == nil {
		return e
	}
...
type DivOnIntersectMod customDataKeyModifier

// Only run the expression once
// Only works with built-in events.
func DivOnIntersectModOnce() DivOnIntersectMod {
	return func() string {
		return "once"
	}
}
...
func DivOnIntersectModHalf() DivOnIntersectMod {
	return func() string {
		return "half"
	}
}
...
func DivOnIntersectModFull() DivOnIntersectMod {
	return func() string {
		return "full"
	}
}
...
// Delay the event listener in seconds.
func DivOnIntersectModDelaySec(
	d time.Duration,
) DivOnIntersectMod {
	return func() string {
		return fmt.Sprintf("delay.%ds", int(d.Seconds()))
...
// Debounces the event handler
func DivOnIntersectModDebounceMs(
	d time.Duration,
) DivOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms", d.Milliseconds())
...
// Debounce the event listener in milliseconds with leading edge.
func DivOnIntersectModDebounceMsLeading(
	d time.Duration,
) DivOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.leading", d.Milliseconds())
...
// Debounce the event listener in milliseconds without trailing edge.
func DivOnIntersectModDebounceMsNoTrailing(
	d time.Duration,
) DivOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.notrailing", d.Milliseconds())
...
// Debounces the event handler
func DivOnIntersectModDebounceSec(
	d time.Duration,
) DivOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds", int(d.Seconds()))
...
// Debounce the event listener in seconds with leading edge.
func DivOnIntersectModDebounceSecLeading(
	d time.Duration,
) DivOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.leading", int(d.Seconds()))
...
// Debounce the event listener in seconds without trailing edge.
func DivOnIntersectModDebounceSecNoTrailing(
	d time.Duration,
) DivOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.notrailing", int(d.Seconds()))
...
// Throttles the event handler
func DivOnIntersectModThrottleMs(
	d time.Duration,
) DivOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms", d.Milliseconds())
...
// Throttle the event listener in milliseconds without leading edge.
func DivOnIntersectModThrottleMsNoLeading(
	d time.Duration,
) DivOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.noleading", d.Milliseconds())
...
// Throttle the event listener in milliseconds with trailing edge.
func DivOnIntersectModThrottleMsTrailing(
	d time.Duration,
) DivOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.trailing", d.Milliseconds())
...
// Throttles the event listener in seconds.
func DivOnIntersectModThrottleSec(
	d time.Duration,
) DivOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds", int(d.Seconds()))
...
// Throttle the event listener in seconds without leading edge.
func DivOnIntersectModThrottleSecNoLeading(
	d time.Duration,
) DivOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.noleading", int(d.Seconds()))
...
// Throttle the event listener in seconds with trailing edge.
func DivOnIntersectModThrottleSecTrailing(
	d time.Duration,
) DivOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.trailing", int(d.Seconds()))
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func DivOnIntersectModViewTransition() DivOnIntersectMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *DIVElement) DATASTAR_ON_INTERSECT(expression string, modifiers ...DivOnIntersectMod) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m DivOnIntersectMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
// Runs an expression when the element intersects with the viewport.
func (e *DIVElement) IfDATASTAR_ON_INTERSECT(condition bool, expression string, modifiers ...DivOnIntersectMod) *DIVElement {
	if condition {
...
func (e *DIVElement) DATASTAR_ON_INTERSECTRemove() *DIVElement {
	if e.StringAttributes == nil {
		return e
	}
...
type DivOnIntervalMod customDataKeyModifier

// Sets the interval duration in milliseconds.
func DivOnIntervalModDurationMs(
	d time.Duration,
) DivOnIntervalMod {
	return func() string {
...
func DivOnIntervalModDurationMsLeading(
	d time.Duration,
) DivOnIntervalMod {
	return func() string {
...
func DivOnIntervalModDurationSec(
	d time.Duration,
) DivOnIntervalMod {
	return func() string {
...
// Sets the interval duration in seconds
// Execute the first interval immediately.
func DivOnIntervalModDurationSecLeading(
	d time.Duration,
) DivOnIntervalMod {
	return func() string {
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func DivOnIntervalModViewTransition() DivOnIntervalMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *DIVElement) DATASTAR_ON_INTERVAL(expression string, modifiers ...DivOnIntervalMod) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m DivOnIntervalMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on-interval
func (e *DIVElement) IfDATASTAR_ON_INTERVAL(condition bool, expression string, modifiers ...DivOnIntervalMod) *DIVElement {
	if condition {
...
func (e *DIVElement) DATASTAR_ON_INTERVALRemove() *DIVElement {
	if e.StringAttributes == nil {
		return e
	}
...
type DivOnSignalPatchMod customDataKeyModifier

// Delay the event listener in milliseconds.
func DivOnSignalPatchModDelayMs(
	d time.Duration,
) DivOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("delay.%dms", d.Milliseconds())
...
// Delay the event listener in seconds.
func DivOnSignalPatchModDelaySec(
	d time.Duration,
) DivOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("delay.%ds", int(d.Seconds()))
...
// Debounces the event handler
func DivOnSignalPatchModDebounceMs(
	d time.Duration,
) DivOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms", d.Milliseconds())
...
// Debounce the event listener in milliseconds with leading edge.
func DivOnSignalPatchModDebounceMsLeading(
	d time.Duration,
) DivOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.leading", d.Milliseconds())
...
// Debounce the event listener in milliseconds without trailing edge.
func DivOnSignalPatchModDebounceMsNoTrailing(
	d time.Duration,
) DivOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.notrailing", d.Milliseconds())
...
// Debounces the event handler
func DivOnSignalPatchModDebounceSec(
	d time.Duration,
) DivOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds", int(d.Seconds()))
...
// Debounce the event listener in seconds with leading edge.
func DivOnSignalPatchModDebounceSecLeading(
	d time.Duration,
) DivOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.leading", int(d.Seconds()))
...
// Debounce the event listener in seconds without trailing edge.
func DivOnSignalPatchModDebounceSecNoTrailing(
	d time.Duration,
) DivOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.notrailing", int(d.Seconds()))
...
// Throttles the event handler
func DivOnSignalPatchModThrottleMs(
	d time.Duration,
) DivOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms", d.Milliseconds())
...
// Throttle the event listener in milliseconds without leading edge.
func DivOnSignalPatchModThrottleMsNoLeading(
	d time.Duration,
) DivOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.noleading", d.Milliseconds())
...
// Throttle the event listener in milliseconds with trailing edge.
func DivOnSignalPatchModThrottleMsTrailing(
	d time.Duration,
) DivOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.trailing", d.Milliseconds())
...
// Throttles the event listener in seconds.
func DivOnSignalPatchModThrottleSec(
	d time.Duration,
) DivOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds", int(d.Seconds()))
...
// Throttle the event listener in seconds without leading edge.
func DivOnSignalPatchModThrottleSecNoLeading(
	d time.Duration,
) DivOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.noleading", int(d.Seconds()))
...
// Throttle the event listener in seconds with trailing edge.
func DivOnSignalPatchModThrottleSecTrailing(
	d time.Duration,
) DivOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.trailing", int(d.Seconds()))
...
func (e *DIVElement) DATASTAR_ON_SIGNAL_PATCH(expression string, modifiers ...DivOnSignalPatchMod) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m DivOnSignalPatchMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on-signal-patch
func (e *DIVElement) IfDATASTAR_ON_SIGNAL_PATCH(condition bool, expression string, modifiers ...DivOnSignalPatchMod) *DIVElement {
	if condition {
...
func (e *DIVElement) DATASTAR_ON_SIGNAL_PATCHRemove() *DIVElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *DIVElement) DATASTAR_ON_SIGNAL_PATCH_FILTER(expression string) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-on-signal-patch-filter
func (e *DIVElement) IfDATASTAR_ON_SIGNAL_PATCH_FILTER(condition bool, expression string) *DIVElement {
	if condition {
...
func (e *DIVElement) DATASTAR_ON_SIGNAL_PATCH_FILTERRemove() *DIVElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *DIVElement) DATASTAR_PRESERVE_ATTR(expression string) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-preserve-attr
func (e *DIVElement) IfDATASTAR_PRESERVE_ATTR(condition bool, expression string) *DIVElement {
	if condition {
...
func (e *DIVElement) DATASTAR_PRESERVE_ATTRRemove() *DIVElement {
	if e.StringAttributes == nil {
		return e
	}
...
type DivRefMod customDataKeyModifier
...
func (e *DIVElement) DATASTAR_REF(expression string, modifiers ...DivRefMod) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m DivRefMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-ref
func (e *DIVElement) IfDATASTAR_REF(condition bool, expression string, modifiers ...DivRefMod) *DIVElement {
	if condition {
...
func (e *DIVElement) DATASTAR_SHOW(expression string) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-show
func (e *DIVElement) IfDATASTAR_SHOW(condition bool, expression string) *DIVElement {
	if condition {
...
func (e *DIVElement) DATASTAR_SHOWRemove() *DIVElement {
	if e.StringAttributes == nil {
		return e
	}
...
type DivSignalsMod customDataKeyModifier
...
func DivSignalsModIfMissing() DivSignalsMod {
	return func() string {
		return "ifmissing"
	}
}
...
func (e *DIVElement) DATASTAR_SIGNALS(key string, expression string, modifiers ...DivSignalsMod) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m DivSignalsMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-signals
func (e *DIVElement) IfDATASTAR_SIGNALS(condition bool, key string, expression string, modifiers ...DivSignalsMod) *DIVElement {
	if condition {
...
func (e *DIVElement) DATASTAR_SIGNALSRemove(key string) *DIVElement {
	if e.StringAttributes == nil {
		return e
	}
...
type DivStyleMod customDataKeyModifier
...
func (e *DIVElement) DATASTAR_STYLE(key string, expression string, modifiers ...DivStyleMod) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m DivStyleMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-style
func (e *DIVElement) IfDATASTAR_STYLE(condition bool, key string, expression string, modifiers ...DivStyleMod) *DIVElement {
	if condition {
...
func (e *DIVElement) DATASTAR_STYLERemove(key string) *DIVElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *DIVElement) DATASTAR_TEXT(expression string) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-text
func (e *DIVElement) IfDATASTAR_TEXT(condition bool, expression string) *DIVElement {
	if condition {
