...
// package html code is generated from configuration file.
// Description:
package elements
...
// Create a new CODEElement element.
...
func (e *CODEElement) IfCustomData(condition bool, key, value string) *CODEElement {
	if condition {
...
func (e *CODEElement) CustomDataF(key, format string, args ...any) *CODEElement {
	return e.CustomData(key, fmt.Sprintf(format, args...))
}

func (e *CODEElement) IfCustomDataF(condition bool, key, format string, args ...any) *CODEElement {
	if condition {
...
const (
	...
	CodeAutocapitalize_off CodeAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	CodeAutocapitalize_none CodeAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	CodeAutocapitalize_sentences CodeAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	CodeAutocapitalize_on CodeAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	CodeAutocapitalize_words CodeAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	CodeAutocapitalize_characters CodeAutocapitalizeChoice = "characters"
)
...
func (e *CODEElement) AUTOCAPITALIZERemove(c CodeAutocapitalizeChoice) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
// sighted user on a small device will equally miss the context created by the
// preceding content.
func (e *CODEElement) AUTOFOCUSRemove(b bool) *CODEElement {
	if e.BoolAttributes == nil {
		return e
	}
...
const (
	...
	CodeContenteditable_empty CodeContenteditableChoice = ""
	// The element is editable.
	CodeContenteditable_true CodeContenteditableChoice = "true"
	// The element is not editable.
	CodeContenteditable_false CodeContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	CodeContenteditable_plaintext_only CodeContenteditableChoice = "plaintext-only"
)
...
func (e *CODEElement) CONTENTEDITABLERemove(c CodeContenteditableChoice) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
const (
	...
	CodeDir_auto CodeDirChoice = "auto"
)
...
func (e *CODEElement) DIRRemove(c CodeDirChoice) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
const (
	...
	CodeDraggable_true CodeDraggableChoice = "true"
	// The element is not draggable.
	CodeDraggable_false CodeDraggableChoice = "false"
	...
	CodeDraggable_empty CodeDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged
	// For other elements, the event ondragstart must be set for drag and drop to work
	CodeDraggable_auto CodeDraggableChoice = "auto"
)
...
func (e *CODEElement) DRAGGABLERemove(c CodeDraggableChoice) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
const (
	...
	CodeHidden_empty CodeHiddenChoice = ""
	// set the element to the hidden state
	// Additionally, invalid values set the element to the hidden state.
	CodeHidden_hidden CodeHiddenChoice = "hidden"
	...
	//
	CodeHidden_until_found CodeHiddenChoice = "until-found"
)
...
func (e *CODEElement) HIDDENRemove(c CodeHiddenChoice) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *CODEElement) IDRemove(s string) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
// Hides the element and its content from assistive technologies by excluding them
// from the accessibility tree.
func (e *CODEElement) INERTRemove(b bool) *CODEElement {
	if e.BoolAttributes == nil {
		return e
	}
...
const (
	...
	CodeInputmode_none CodeInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	CodeInputmode_empty CodeInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	CodeInputmode_text CodeInputmodeChoice = "text"
	...
	CodeInputmode_decimal CodeInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9
	// Devices may or may not show a minus key.
	CodeInputmode_numeric CodeInputmodeChoice = "numeric"
	...
	// type="tel"> instead.
	CodeInputmode_tel CodeInputmodeChoice = "tel"
	...
	// instead.
	CodeInputmode_search CodeInputmodeChoice = "search"
	...
	// instead.
	CodeInputmode_email CodeInputmodeChoice = "email"
	...
	CodeInputmode_url CodeInputmodeChoice = "url"
)
...
func (e *CODEElement) INPUTMODERemove(c CodeInputmodeChoice) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *CODEElement) ISRemove(s string) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *CODEElement) ITEMIDRemove(s string) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *CODEElement) ITEMPROPRemove(s string) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *CODEElement) ITEMREFRemove(s string) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *CODEElement) ITEMSCOPERemove(b bool) *CODEElement {
	if e.BoolAttributes == nil {
		return e
	}
...
func (e *CODEElement) ITEMTYPERemove(s string) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *CODEElement) LANGRemove(s string) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *CODEElement) NONCERemove(s string) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *CODEElement) ROLERemove(s string) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *CODEElement) SLOTRemove(s string) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
const (
	...
	CodeSpellcheck_empty CodeSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	CodeSpellcheck_true CodeSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	CodeSpellcheck_false CodeSpellcheckChoice = "false"
)
...
func (e *CODEElement) SPELLCHECKRemove(c CodeSpellcheckChoice) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *CODEElement) STYLEF(k string, format string, args ...any) *CODEElement {
...
// font, size, and more
// Styles are written in CSS.
func (e *CODEElement) IfSTYLE(condition bool, k string, v string) *CODEElement {
	if condition {
		e.STYLE(k, v)
	}
	return e
...
// font, size, and more
// Styles are written in CSS.
func (e *CODEElement) STYLE(k string, v string) *CODEElement {
	if e.KVStrings == nil {
...
// font, size, and more
// Styles are written in CSS.
func (e *CODEElement) IfSTYLEF(condition bool, k string, format string, args ...any) *CODEElement {
	if condition {
...
// font, size, and more
// Styles are written in CSS.
func (e *CODEElement) IfSTYLEPairs(condition bool, pairs ...string) *CODEElement {
	if condition {
		e.STYLEPairs(pairs...)
	}
	return e
...
func (e *CODEElement) TABINDEXRemove(i int) *CODEElement {
	if e.IntAttributes == nil {
		return e
	}
...
func (e *CODEElement) TITLERemove(s string) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
const (
	...
	CodeTranslate_empty CodeTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	CodeTranslate_yes CodeTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	CodeTranslate_no CodeTranslateChoice = "no"
)
...
func (e *CODEElement) TRANSLATERemove(c CodeTranslateChoice) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *CODEElement) DATASTAR_ATTR(key string, expression string) *CODEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-attr
func (e *CODEElement) IfDATASTAR_ATTR(condition bool, key string, expression string) *CODEElement {
	if condition {
...
func (e *CODEElement) DATASTAR_ATTRRemove(key string) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *CODEElement) DATASTAR_BIND(key string, expression string) *CODEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-bind
func (e *CODEElement) IfDATASTAR_BIND(condition bool, key string, expression string) *CODEElement {
	if condition {
...
func (e *CODEElement) DATASTAR_BINDRemove(key string) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
type CodeClassMod customDataKeyModifier
...
func (e *CODEElement) DATASTAR_CLASS(key string, expression string, modifiers ...CodeClassMod) *CODEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m CodeClassMod, i int) customDataKeyModifier {
...
// Adds or removes a class to or from an element based on an expression.
func (e *CODEElement) IfDATASTAR_CLASS(condition bool, key string, expression string, modifiers ...CodeClassMod) *CODEElement {
	if condition {
...
func (e *CODEElement) DATASTAR_CLASSRemove(key string) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
type CodeComputedMod customDataKeyModifier
...
func (e *CODEElement) DATASTAR_COMPUTED(key string, expression string, modifiers ...CodeComputedMod) *CODEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m CodeComputedMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-computed
func (e *CODEElement) IfDATASTAR_COMPUTED(condition bool, key string, expression string, modifiers ...CodeComputedMod) *CODEElement {
	if condition {
...
func (e *CODEElement) DATASTAR_COMPUTEDRemove(key string) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *CODEElement) DATASTAR_EFFECT(expression string) *CODEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-effect
func (e *CODEElement) IfDATASTAR_EFFECT(condition bool, expression string) *CODEElement {
	if condition {
...
func (e *CODEElement) DATASTAR_EFFECTRemove() *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
type CodeIgnoreMod customDataKeyModifier

// Only ignore the element itself, not its descendants.
func CodeIgnoreModSelf() CodeIgnoreMod {
	return func() string {
		return "self"
	}
}
...
func (e *CODEElement) DATASTAR_IGNORESet(b bool, modifiers ...CodeIgnoreMod) *CODEElement {
	key := customDataKey("data-ignore")
	customMods := lo.Map(modifiers, func(m CodeIgnoreMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	if e.BoolAttributes == nil {
...
//
// See: https://data-star.dev/reference/attributes#data-ignore
func (e *CODEElement) DATASTAR_IGNORE(modifiers ...CodeIgnoreMod) *CODEElement {
...
func (e *CODEElement) DATASTAR_IGNORE_MORPHSet(b bool) *CODEElement {
...
//
// See: https://data-star.dev/reference/attributes#data-ignore-morph
func (e *CODEElement) DATASTAR_IGNORE_MORPH() *CODEElement {
	return e.DATASTAR_IGNORE_MORPHSet(true)
}

type CodeIndicatorMod customDataKeyModifier
...
func (e *CODEElement) DATASTAR_INDICATOR(expression string, modifiers ...CodeIndicatorMod) *CODEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m CodeIndicatorMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *CODEElement) IfDATASTAR_INDICATOR(condition bool, expression string, modifiers ...CodeIndicatorMod) *CODEElement {
	if condition {
...
func (e *CODEElement) DATASTAR_INDICATORRemove() *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
type CodeInitMod customDataKeyModifier

// Delay the event listener in milliseconds.
func CodeInitModDelayMs(
	d time.Duration,
) CodeInitMod {
	return func() string {
...
func CodeInitModViewTransition() CodeInitMod {
	return func() string {
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *CODEElement) DATASTAR_INIT(expression string, modifiers ...CodeInitMod) *CODEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m CodeInitMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *CODEElement) IfDATASTAR_INIT(condition bool, expression string, modifiers ...CodeInitMod) *CODEElement {
	if condition {
...
func (e *CODEElement) DATASTAR_INITRemove() *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *CODEElement) DATASTAR_JSON_SIGNALS(expression string, modifiers ...CodeJsonSignalsMod) *CODEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m CodeJsonSignalsMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-json-signals
func (e *CODEElement) IfDATASTAR_JSON_SIGNALS(condition bool, expression string, modifiers ...CodeJsonSignalsMod) *CODEElement {
	if condition {
...
func (e *CODEElement) DATASTAR_JSON_SIGNALSRemove() *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
// Only works with built-in events.
func CodeOnModPassive() CodeOnMod {
	return func() string {
		return "passive"
	}
}
...
// Only works with built-in events.
func CodeOnModCapture() CodeOnMod {
	return func() string {
		return "capture"
	}
}
...
func CodeOnModDebounceMsLeading(
	d time.Duration,
) CodeOnMod {
	return func() string {
...
func CodeOnModDebounceMsNoTrailing(
	d time.Duration,
) CodeOnMod {
	return func() string {
...
func CodeOnModDebounceSecLeading(
	d time.Duration,
) CodeOnMod {
	return func() string {
...
func CodeOnModDebounceSecNoTrailing(
	d time.Duration,
) CodeOnMod {
	return func() string {
...
func CodeOnModThrottleMsNoLeading(
	d time.Duration,
) CodeOnMod {
	return func() string {
...
func CodeOnModThrottleMsTrailing(
	d time.Duration,
) CodeOnMod {
	return func() string {
...
func CodeOnModThrottleSecNoLeading(
	d time.Duration,
) CodeOnMod {
	return func() string {
...
func CodeOnModThrottleSecTrailing(
	d time.Duration,
) CodeOnMod {
	return func() string {
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func CodeOnModViewTransition() CodeOnMod {
	return func() string {
		return "viewtransition"
	}
}
...
func CodeOnModWindow() CodeOnMod {
	return func() string {
		return "window"
	}
}
...
func CodeOnModPrevent() CodeOnMod {
	return func() string {
		return "prevent"
	}
}
...
func CodeOnModOutside() CodeOnMod {
	return func() string {
		return "outside"
	}
}
...
func (e *CODEElement) DATASTAR_ONRemove(key string) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
type CodeOnIntersectMod customDataKeyModifier

// Only run the expression once
// Only works with built-in events.
func CodeOnIntersectModOnce() CodeOnIntersectMod {
	return func() string {
		return "once"
	}
}
...
func CodeOnIntersectModHalf() CodeOnIntersectMod {
	return func() string {
		return "half"
	}
}
...
func CodeOnIntersectModFull() CodeOnIntersectMod {
	return func() string {
		return "full"
	}
}
...
// Delay the event listener in milliseconds.
func CodeOnIntersectModDelayMs(
	d time.Duration,
) CodeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("delay.%dms", d.Milliseconds())
...
// Delay the event listener in seconds.
func CodeOnIntersectModDelaySec(
	d time.Duration,
) CodeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("delay.%ds", int(d.Seconds()))
...
// Debounces the event handler
func CodeOnIntersectModDebounceMs(
	d time.Duration,
) CodeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms", d.Milliseconds())
...
// Debounce the event listener in milliseconds with leading edge.
func CodeOnIntersectModDebounceMsLeading(
	d time.Duration,
) CodeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.leading", d.Milliseconds())
...
// Debounce the event listener in milliseconds without trailing edge.
func CodeOnIntersectModDebounceMsNoTrailing(
	d time.Duration,
) CodeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.notrailing", d.Milliseconds())
...
// Debounces the event handler
func CodeOnIntersectModDebounceSec(
	d time.Duration,
) CodeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds", int(d.Seconds()))
...
// Debounce the event listener in seconds with leading edge.
func CodeOnIntersectModDebounceSecLeading(
	d time.Duration,
) CodeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.leading", int(d.Seconds()))
...
// Debounce the event listener in seconds without trailing edge.
func CodeOnIntersectModDebounceSecNoTrailing(
	d time.Duration,
) CodeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.notrailing", int(d.Seconds()))
...
// Throttles the event handler
func CodeOnIntersectModThrottleMs(
	d time.Duration,
) CodeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms", d.Milliseconds())
...
// Throttle the event listener in milliseconds without leading edge.
func CodeOnIntersectModThrottleMsNoLeading(
	d time.Duration,
) CodeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.noleading", d.Milliseconds())
...
// Throttle the event listener in milliseconds with trailing edge.
func CodeOnIntersectModThrottleMsTrailing(
	d time.Duration,
) CodeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.trailing", d.Milliseconds())
...
// Throttles the event listener in seconds.
func CodeOnIntersectModThrottleSec(
	d time.Duration,
) CodeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds", int(d.Seconds()))
...
// Throttle the event listener in seconds without leading edge.
func CodeOnIntersectModThrottleSecNoLeading(
	d time.Duration,
) CodeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.noleading", int(d.Seconds()))
...
// Throttle the event listener in seconds with trailing edge.
func CodeOnIntersectModThrottleSecTrailing(
	d time.Duration,
) CodeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.trailing", int(d.Seconds()))
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func CodeOnIntersectModViewTransition() CodeOnIntersectMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *CODEElement) DATASTAR_ON_INTERSECT(expression string, modifiers ...CodeOnIntersectMod) *CODEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m CodeOnIntersectMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
// Runs an expression when the element intersects with the viewport.
func (e *CODEElement) IfDATASTAR_ON_INTERSECT(condition bool, expression string, modifiers ...CodeOnIntersectMod) *CODEElement {
	if condition {
...
func (e *CODEElement) DATASTAR_ON_INTERSECTRemove() *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
type CodeOnIntervalMod customDataKeyModifier

// Sets the interval duration in milliseconds.
func CodeOnIntervalModDurationMs(
	d time.Duration,
) CodeOnIntervalMod {
	return func() string {
...
func CodeOnIntervalModDurationMsLeading(
	d time.Duration,
) CodeOnIntervalMod {
	return func() string {
...
func CodeOnIntervalModDurationSec(
	d time.Duration,
) CodeOnIntervalMod {
	return func() string {
...
// Sets the interval duration in seconds
// Execute the first interval immediately.
func CodeOnIntervalModDurationSecLeading(
	d time.Duration,
) CodeOnIntervalMod {
	return func() string {
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func CodeOnIntervalModViewTransition() CodeOnIntervalMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *CODEElement) DATASTAR_ON_INTERVAL(expression string, modifiers ...CodeOnIntervalMod) *CODEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m CodeOnIntervalMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on-interval
func (e *CODEElement) IfDATASTAR_ON_INTERVAL(condition bool, expression string, modifiers ...CodeOnIntervalMod) *CODEElement {
	if condition {
...
func (e *CODEElement) DATASTAR_ON_INTERVALRemove() *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
type CodeOnSignalPatchMod customDataKeyModifier

// Delay the event listener in milliseconds.
func CodeOnSignalPatchModDelayMs(
	d time.Duration,
) CodeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("delay.%dms", d.Milliseconds())
	}
}
...
// Delay the event listener in seconds.
func CodeOnSignalPatchModDelaySec(
	d time.Duration,
) CodeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("delay.%ds", int(d.Seconds()))
...
// Debounces the event handler
func CodeOnSignalPatchModDebounceMs(
	d time.Duration,
) CodeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms", d.Milliseconds())
...
// Debounce the event listener in milliseconds with leading edge.
func CodeOnSignalPatchModDebounceMsLeading(
	d time.Duration,
) CodeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.leading", d.Milliseconds())
...
// Debounce the event listener in milliseconds without trailing edge.
func CodeOnSignalPatchModDebounceMsNoTrailing(
	d time.Duration,
) CodeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.notrailing", d.Milliseconds())
...
// Debounces the event handler
func CodeOnSignalPatchModDebounceSec(
	d time.Duration,
) CodeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds", int(d.Seconds()))
...
// Debounce the event listener in seconds with leading edge.
func CodeOnSignalPatchModDebounceSecLeading(
	d time.Duration,
) CodeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.leading", int(d.Seconds()))
...
// Debounce the event listener in seconds without trailing edge.
func CodeOnSignalPatchModDebounceSecNoTrailing(
	d time.Duration,
) CodeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.notrailing", int(d.Seconds()))
...
// Throttles the event handler
func CodeOnSignalPatchModThrottleMs(
	d time.Duration,
) CodeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms", d.Milliseconds())
...
// Throttle the event listener in milliseconds without leading edge.
func CodeOnSignalPatchModThrottleMsNoLeading(
	d time.Duration,
) CodeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.noleading", d.Milliseconds())
...
// Throttle the event listener in milliseconds with trailing edge.
func CodeOnSignalPatchModThrottleMsTrailing(
	d time.Duration,
) CodeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.trailing", d.Milliseconds())
...
// Throttles the event listener in seconds.
func CodeOnSignalPatchModThrottleSec(
	d time.Duration,
) CodeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds", int(d.Seconds()))
...
// Throttle the event listener in seconds without leading edge.
func CodeOnSignalPatchModThrottleSecNoLeading(
	d time.Duration,
) CodeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.noleading", int(d.Seconds()))
...
// Throttle the event listener in seconds with trailing edge.
func CodeOnSignalPatchModThrottleSecTrailing(
	d time.Duration,
) CodeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.trailing", int(d.Seconds()))
...
func (e *CODEElement) DATASTAR_ON_SIGNAL_PATCH(expression string, modifiers ...CodeOnSignalPatchMod) *CODEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m CodeOnSignalPatchMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on-signal-patch
func (e *CODEElement) IfDATASTAR_ON_SIGNAL_PATCH(condition bool, expression string, modifiers ...CodeOnSignalPatchMod) *CODEElement {
	if condition {
...
func (e *CODEElement) DATASTAR_ON_SIGNAL_PATCHRemove() *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *CODEElement) DATASTAR_ON_SIGNAL_PATCH_FILTER(expression string) *CODEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-on-signal-patch-filter
func (e *CODEElement) IfDATASTAR_ON_SIGNAL_PATCH_FILTER(condition bool, expression string) *CODEElement {
	if condition {
...
func (e *CODEElement) DATASTAR_ON_SIGNAL_PATCH_FILTERRemove() *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *CODEElement) DATASTAR_PRESERVE_ATTR(expression string) *CODEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-preserve-attr
func (e *CODEElement) IfDATASTAR_PRESERVE_ATTR(condition bool, expression string) *CODEElement {
	if condition {
...
func (e *CODEElement) DATASTAR_PRESERVE_ATTRRemove() *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
type CodeRefMod customDataKeyModifier
...
func (e *CODEElement) DATASTAR_REF(expression string, modifiers ...CodeRefMod) *CODEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m CodeRefMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-ref
func (e *CODEElement) IfDATASTAR_REF(condition bool, expression string, modifiers ...CodeRefMod) *CODEElement {
	if condition {
...
func (e *CODEElement) DATASTAR_REFRemove() *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *CODEElement) DATASTAR_SHOW(expression string) *CODEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-show
func (e *CODEElement) IfDATASTAR_SHOW(condition bool, expression string) *CODEElement {
	if condition {
...
func (e *CODEElement) DATASTAR_SHOWRemove() *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
type CodeSignalsMod customDataKeyModifier
...
func CodeSignalsModIfMissing() CodeSignalsMod {
	return func() string {
		return "ifmissing"
	}
}
...
func (e *CODEElement) DATASTAR_SIGNALS(key string, expression string, modifiers ...CodeSignalsMod) *CODEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m CodeSignalsMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-signals
func (e *CODEElement) IfDATASTAR_SIGNALS(condition bool, key string, expression string, modifiers ...CodeSignalsMod) *CODEElement {
	if condition {
...
func (e *CODEElement) DATASTAR_SIGNALSRemove(key string) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
type CodeStyleMod customDataKeyModifier
...
func (e *CODEElement) DATASTAR_STYLE(key string, expression string, modifiers ...CodeStyleMod) *CODEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m CodeStyleMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-style
func (e *CODEElement) IfDATASTAR_STYLE(condition bool, key string, expression string, modifiers ...CodeStyleMod) *CODEElement {
	if condition {
...
func (e *CODEElement) DATASTAR_STYLERemove(key string) *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *CODEElement) DATASTAR_TEXT(expression string) *CODEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-text
func (e *CODEElement) IfDATASTAR_TEXT(condition bool, expression string) *CODEElement {
	if condition {
...
func (e *CODEElement) DATASTAR_TEXTRemove() *CODEElement {
	if e.StringAttributes == nil {
		return e
	}
