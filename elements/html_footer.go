...
// package html footer is generated from configuration file.
// Description:
package elements
...
// Create a new FOOTERElement element.
// This will create a new element with the tag
// "footer" during rendering.
...
func (e *FOOTERElement) Attr(name string, value string) *FOOTERElement {
...
func (e *FOOTERElement) Attrs(attrs ...string) *FOOTERElement {
	if len(attrs)%2 != 0 {
...
func (e *FOOTERElement) AttrsMap(attrs map[string]string) *FOOTERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	for k, v := range attrs {
...
const (
	...
	FooterAutocapitalize_off FooterAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	FooterAutocapitalize_none FooterAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	FooterAutocapitalize_sentences FooterAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	FooterAutocapitalize_on FooterAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	FooterAutocapitalize_words FooterAutocapitalizeChoice = "words"
...
const (
	...
	FooterContenteditable_empty FooterContenteditableChoice = ""
	// The element is editable.
	FooterContenteditable_true FooterContenteditableChoice = "true"
	// The element is not editable.
	FooterContenteditable_false FooterContenteditableChoice = "false"
...
const (
	...
	FooterDraggable_true FooterDraggableChoice = "true"
	// The element is not draggable.
	FooterDraggable_false FooterDraggableChoice = "false"
	...
	FooterDraggable_empty FooterDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged
	// For other elements, the event ondragstart must be set for drag and drop to work
...
const (
	...
	FooterHidden_empty FooterHiddenChoice = ""
	// set the element to the hidden state
	// Additionally, invalid values set the element to the hidden state.
	FooterHidden_hidden FooterHiddenChoice = "hidden"
...
// Its purpose is to identify the element when linking (using a fragment
// identifier), scripting, or styling (with CSS).
func (e *FOOTERElement) IDRemoveF(format string, args ...any) *FOOTERElement {
...
const (
	...
	FooterInputmode_none FooterInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	FooterInputmode_empty FooterInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	FooterInputmode_text FooterInputmodeChoice = "text"
	...
	FooterInputmode_decimal FooterInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9
	// Devices may or may not show a minus key.
	FooterInputmode_numeric FooterInputmodeChoice = "numeric"
	...
	// type="tel"> instead.
	FooterInputmode_tel FooterInputmodeChoice = "tel"
	...
	// instead.
	FooterInputmode_search FooterInputmodeChoice = "search"
	...
	// instead.
	FooterInputmode_email FooterInputmodeChoice = "email"
...
// successfully defined in the current document, and extends the element type it
// is being applied to.
func (e *FOOTERElement) ISRemoveF(format string, args ...any) *FOOTERElement {
...
// The vocabulary defines whether several items with the same global identifier
// can coexist and, if so, how items with the same identifier are handled.
func (e *FOOTERElement) ITEMIDRemoveF(format string, args ...any) *FOOTERElement {
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *FOOTERElement) ITEMPROPRemoveF(format string, args ...any) *FOOTERElement {
...
// with additional properties The itemref attribute can only be specified on
// elements that have an itemscope attribute specified.
func (e *FOOTERElement) ITEMREFRemoveF(format string, args ...any) *FOOTERElement {
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *FOOTERElement) ITEMTYPERemoveF(format string, args ...any) *FOOTERElement {
...
// Identifying Languages (BCP47) IETF document
// xml:lang has priority over it.
func (e *FOOTERElement) LANGRemoveF(format string, args ...any) *FOOTERElement {
...
// It is a cryptographic nonce (number used once) that is used by Content Security
// Policy to determine whether or not a given inline script is allowed to execute.
func (e *FOOTERElement) NONCERemoveF(format string, args ...any) *FOOTERElement {
...
const (
	...
	// on-screen at a time.
	FooterPopover_auto FooterPopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting outside
	// the popover area, and generally only allow one popover to be displayed
	// on-screen at a time.
	FooterPopover_empty FooterPopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases such
	// as nested popovers in menus.
	FooterPopover_manual FooterPopoverChoice = "manual"
)
...
func (e *FOOTERElement) POPOVERRemove(c FooterPopoverChoice) *FOOTERElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *FOOTERElement) ROLERemove(s string) *FOOTERElement {
	if e.StringAttributes == nil {
		return e
	}
...
// It is a simple string value that can be used to describe the role of an
// element.
func (e *FOOTERElement) ROLERemoveF(format string, args ...any) *FOOTERElement {
...
// the <slot> element whose name attribute's value matches that slot attribute's
// value.
func (e *FOOTERElement) SLOTRemoveF(format string, args ...any) *FOOTERElement {
...
const (
	...
	FooterSpellcheck_empty FooterSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	FooterSpellcheck_true FooterSpellcheckChoice = "true"
...
// <input> element, this is not good practice
// Use a <label> instead.
func (e *FOOTERElement) TITLERemoveF(format string, args ...any) *FOOTERElement {
...
const (
	...
	FooterTranslate_empty FooterTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	FooterTranslate_yes FooterTranslateChoice = "yes"
...
func (e *FOOTERElement) DATASTAR_ATTR(key string, expression string) *FOOTERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-attr
func (e *FOOTERElement) IfDATASTAR_ATTR(condition bool, key string, expression string) *FOOTERElement {
	if condition {
...
func (e *FOOTERElement) DATASTAR_ATTRRemove(key string) *FOOTERElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *FOOTERElement) DATASTAR_BIND(key string, expression string) *FOOTERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-bind
func (e *FOOTERElement) IfDATASTAR_BIND(condition bool, key string, expression string) *FOOTERElement {
	if condition {
...
func (e *FOOTERElement) DATASTAR_BINDRemove(key string) *FOOTERElement {
	if e.StringAttributes == nil {
		return e
	}
...
type FooterClassMod customDataKeyModifier
...
func (e *FOOTERElement) DATASTAR_CLASS(key string, expression string, modifiers ...FooterClassMod) *FOOTERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m FooterClassMod, i int) customDataKeyModifier {
...
// Adds or removes a class to or from an element based on an expression.
func (e *FOOTERElement) IfDATASTAR_CLASS(condition bool, key string, expression string, modifiers ...FooterClassMod) *FOOTERElement {
	if condition {
...
func (e *FOOTERElement) DATASTAR_CLASSRemove(key string) *FOOTERElement {
	if e.StringAttributes == nil {
		return e
	}
...
type FooterComputedMod customDataKeyModifier
...
func (e *FOOTERElement) DATASTAR_COMPUTED(key string, expression string, modifiers ...FooterComputedMod) *FOOTERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m FooterComputedMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-computed
func (e *FOOTERElement) IfDATASTAR_COMPUTED(condition bool, key string, expression string, modifiers ...FooterComputedMod) *FOOTERElement {
	if condition {
...
func (e *FOOTERElement) DATASTAR_COMPUTEDRemove(key string) *FOOTERElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *FOOTERElement) DATASTAR_EFFECT(expression string) *FOOTERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-effect
func (e *FOOTERElement) IfDATASTAR_EFFECT(condition bool, expression string) *FOOTERElement {
	if condition {
...
func (e *FOOTERElement) DATASTAR_EFFECTRemove() *FOOTERElement {
	if e.StringAttributes == nil {
		return e
	}
...
type FooterIgnoreMod customDataKeyModifier

// Only ignore the element itself, not its descendants.
func FooterIgnoreModSelf() FooterIgnoreMod {
	return func() string {
		return "self"
	}
}
...
func (e *FOOTERElement) DATASTAR_IGNORESet(b bool, modifiers ...FooterIgnoreMod) *FOOTERElement {
	key := customDataKey("data-ignore")
	customMods := lo.Map(modifiers, func(m FooterIgnoreMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	if e.BoolAttributes == nil {
...
//
// See: https://data-star.dev/reference/attributes#data-ignore
func (e *FOOTERElement) DATASTAR_IGNORE(modifiers ...FooterIgnoreMod) *FOOTERElement {
...
func (e *FOOTERElement) DATASTAR_IGNORE_MORPHSet(b bool) *FOOTERElement {
...
//
// See: https://data-star.dev/reference/attributes#data-ignore-morph
func (e *FOOTERElement) DATASTAR_IGNORE_MORPH() *FOOTERElement {
	return e.DATASTAR_IGNORE_MORPHSet(true)
}

type FooterIndicatorMod customDataKeyModifier
...
func (e *FOOTERElement) DATASTAR_INDICATOR(expression string, modifiers ...FooterIndicatorMod) *FOOTERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m FooterIndicatorMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *FOOTERElement) IfDATASTAR_INDICATOR(condition bool, expression string, modifiers ...FooterIndicatorMod) *FOOTERElement {
	if condition {
...
func (e *FOOTERElement) DATASTAR_INDICATORRemove() *FOOTERElement {
	if e.StringAttributes == nil {
		return e
	}
...
type FooterInitMod customDataKeyModifier

// Delay the event listener in milliseconds.
func FooterInitModDelayMs(
	d time.Duration,
) FooterInitMod {
	return func() string {
...
func FooterInitModViewTransition() FooterInitMod {
	return func() string {
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *FOOTERElement) DATASTAR_INIT(expression string, modifiers ...FooterInitMod) *FOOTERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m FooterInitMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *FOOTERElement) IfDATASTAR_INIT(condition bool, expression string, modifiers ...FooterInitMod) *FOOTERElement {
	if condition {
...
func (e *FOOTERElement) DATASTAR_INITRemove() *FOOTERElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *FOOTERElement) DATASTAR_JSON_SIGNALS(expression string, modifiers ...FooterJsonSignalsMod) *FOOTERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m FooterJsonSignalsMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-json-signals
func (e *FOOTERElement) IfDATASTAR_JSON_SIGNALS(condition bool, expression string, modifiers ...FooterJsonSignalsMod) *FOOTERElement {
	if condition {
...
func (e *FOOTERElement) DATASTAR_JSON_SIGNALSRemove() *FOOTERElement {
	if e.StringAttributes == nil {
		return e
	}
...
type FooterOnMod customDataKeyModifier

// Only run the expression once
// Only works with built-in events.
func FooterOnModOnce() FooterOnMod {
	return func() string {
		return "once"
	}
}
...
// Only works with built-in events.
func FooterOnModPassive() FooterOnMod {
	return func() string {
		return "passive"
	}
}
...
// Only works with built-in events.
func FooterOnModCapture() FooterOnMod {
	return func() string {
		return "capture"
	}
}
...
func FooterOnModDebounceMsLeading(
	d time.Duration,
) FooterOnMod {
	return func() string {
...
func FooterOnModDebounceMsNoTrailing(
	d time.Duration,
) FooterOnMod {
	return func() string {
...
func FooterOnModDebounceSecLeading(
	d time.Duration,
) FooterOnMod {
	return func() string {
...
func FooterOnModDebounceSecNoTrailing(
	d time.Duration,
) FooterOnMod {
	return func() string {
...
func FooterOnModThrottleMsNoLeading(
	d time.Duration,
) FooterOnMod {
	return func() string {
...
func FooterOnModThrottleMsTrailing(
	d time.Duration,
) FooterOnMod {
	return func() string {
...
func FooterOnModThrottleSecNoLeading(
	d time.Duration,
) FooterOnMod {
	return func() string {
...
func FooterOnModThrottleSecTrailing(
	d time.Duration,
) FooterOnMod {
	return func() string {
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func FooterOnModViewTransition() FooterOnMod {
	return func() string {
		return "viewtransition"
	}
}
...
func FooterOnModWindow() FooterOnMod {
	return func() string {
		return "window"
	}
}
...
func FooterOnModPrevent() FooterOnMod {
	return func() string {
		return "prevent"
	}
}
...
func FooterOnModOutside() FooterOnMod {
	return func() string {
		return "outside"
	}
}
...
func FooterOnModStop() FooterOnMod {
	return func() string {
		return "stop"
	}
}
...
func (e *FOOTERElement) DATASTAR_ON(key string, expression string, modifiers ...FooterOnMod) *FOOTERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m FooterOnMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on
func (e *FOOTERElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...FooterOnMod) *FOOTERElement {
	if condition {
...
func (e *FOOTERElement) DATASTAR_ONRemove(key string) *FOOTERElement {
	if e.StringAttributes == nil {
		return e
	}
...
type FooterOnIntersectMod customDataKeyModifier

// Only run the expression once
// Only works with built-in events.
func FooterOnIntersectModOnce() FooterOnIntersectMod {
	return func() string {
		return "once"
	}
}
...
func FooterOnIntersectModHalf() FooterOnIntersectMod {
	return func() string {
		return "half"
	}
}
...
func FooterOnIntersectModFull() FooterOnIntersectMod {
	return func() string {
		return "full"
	}
}
...
// Delay the event listener in milliseconds.
func FooterOnIntersectModDelayMs(
	d time.Duration,
) FooterOnIntersectMod {
	return func() string {
		return fmt.Sprintf("delay.%dms", d.Milliseconds())
	}
}
...
// Delay the event listener in seconds.
func FooterOnIntersectModDelaySec(
	d time.Duration,
) FooterOnIntersectMod {
	return func() string {
		return fmt.Sprintf("delay.%ds", int(d.Seconds()))
...
// Debounces the event handler
func FooterOnIntersectModDebounceMs(
	d time.Duration,
) FooterOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms", d.Milliseconds())
...
// Debounce the event listener in milliseconds with leading edge.
func FooterOnIntersectModDebounceMsLeading(
	d time.Duration,
) FooterOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.leading", d.Milliseconds())
...
// Debounce the event listener in milliseconds without trailing edge.
func FooterOnIntersectModDebounceMsNoTrailing(
	d time.Duration,
) FooterOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.notrailing", d.Milliseconds())
...
// Debounces the event handler
func FooterOnIntersectModDebounceSec(
	d time.Duration,
) FooterOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds", int(d.Seconds()))
...
// Debounce the event listener in seconds with leading edge.
func FooterOnIntersectModDebounceSecLeading(
	d time.Duration,
) FooterOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.leading", int(d.Seconds()))
...
// Debounce the event listener in seconds without trailing edge.
func FooterOnIntersectModDebounceSecNoTrailing(
	d time.Duration,
) FooterOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.notrailing", int(d.Seconds()))
...
// Throttles the event handler
func FooterOnIntersectModThrottleMs(
	d time.Duration,
) FooterOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms", d.Milliseconds())
...
// Throttle the event listener in milliseconds without leading edge.
func FooterOnIntersectModThrottleMsNoLeading(
	d time.Duration,
) FooterOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.noleading", d.Milliseconds())
...
// Throttle the event listener in milliseconds with trailing edge.
func FooterOnIntersectModThrottleMsTrailing(
	d time.Duration,
) FooterOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.trailing", d.Milliseconds())
...
// Throttles the event listener in seconds.
func FooterOnIntersectModThrottleSec(
	d time.Duration,
) FooterOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds", int(d.Seconds()))
...
// Throttle the event listener in seconds without leading edge.
func FooterOnIntersectModThrottleSecNoLeading(
	d time.Duration,
) FooterOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.noleading", int(d.Seconds()))
...
// Throttle the event listener in seconds with trailing edge.
func FooterOnIntersectModThrottleSecTrailing(
	d time.Duration,
) FooterOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.trailing", int(d.Seconds()))
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func FooterOnIntersectModViewTransition() FooterOnIntersectMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *FOOTERElement) DATASTAR_ON_INTERSECT(expression string, modifiers ...FooterOnIntersectMod) *FOOTERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m FooterOnIntersectMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
// Runs an expression when the element intersects with the viewport.
func (e *FOOTERElement) IfDATASTAR_ON_INTERSECT(condition bool, expression string, modifiers ...FooterOnIntersectMod) *FOOTERElement {
	if condition {
...
func (e *FOOTERElement) DATASTAR_ON_INTERSECTRemove() *FOOTERElement {
	if e.StringAttributes == nil {
		return e
	}
...
type FooterOnIntervalMod customDataKeyModifier

// Sets the interval duration in milliseconds.
func FooterOnIntervalModDurationMs(
	d time.Duration,
) FooterOnIntervalMod {
	return func() string {
...
func FooterOnIntervalModDurationMsLeading(
	d time.Duration,
) FooterOnIntervalMod {
	return func() string {
...
func FooterOnIntervalModDurationSec(
	d time.Duration,
) FooterOnIntervalMod {
	return func() string {
...
// Sets the interval duration in seconds
// Execute the first interval immediately.
func FooterOnIntervalModDurationSecLeading(
	d time.Duration,
) FooterOnIntervalMod {
	return func() string {
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func FooterOnIntervalModViewTransition() FooterOnIntervalMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *FOOTERElement) DATASTAR_ON_INTERVAL(expression string, modifiers ...FooterOnIntervalMod) *FOOTERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m FooterOnIntervalMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on-interval
func (e *FOOTERElement) IfDATASTAR_ON_INTERVAL(condition bool, expression string, modifiers ...FooterOnIntervalMod) *FOOTERElement {
	if condition {
...
func (e *FOOTERElement) DATASTAR_ON_INTERVALRemove() *FOOTERElement {
	if e.StringAttributes == nil {
		return e
	}
...
type FooterOnSignalPatchMod customDataKeyModifier

// Delay the event listener in milliseconds.
func FooterOnSignalPatchModDelayMs(
	d time.Duration,
) FooterOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("delay.%dms", d.Milliseconds())
	}
}
...
// Delay the event listener in seconds.
func FooterOnSignalPatchModDelaySec(
	d time.Duration,
) FooterOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("delay.%ds", int(d.Seconds()))
...
// Debounces the event handler
func FooterOnSignalPatchModDebounceMs(
	d time.Duration,
) FooterOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms", d.Milliseconds())
...
// Debounce the event listener in milliseconds with leading edge.
func FooterOnSignalPatchModDebounceMsLeading(
	d time.Duration,
) FooterOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.leading", d.Milliseconds())
...
// Debounce the event listener in milliseconds without trailing edge.
func FooterOnSignalPatchModDebounceMsNoTrailing(
	d time.Duration,
) FooterOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.notrailing", d.Milliseconds())
...
// Debounces the event handler
func FooterOnSignalPatchModDebounceSec(
	d time.Duration,
) FooterOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds", int(d.Seconds()))
...
// Debounce the event listener in seconds with leading edge.
func FooterOnSignalPatchModDebounceSecLeading(
	d time.Duration,
) FooterOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.leading", int(d.Seconds()))
...
// Debounce the event listener in seconds without trailing edge.
func FooterOnSignalPatchModDebounceSecNoTrailing(
	d time.Duration,
) FooterOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.notrailing", int(d.Seconds()))
...
// Throttles the event handler
func FooterOnSignalPatchModThrottleMs(
	d time.Duration,
) FooterOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms", d.Milliseconds())
...
// Throttle the event listener in milliseconds without leading edge.
func FooterOnSignalPatchModThrottleMsNoLeading(
	d time.Duration,
) FooterOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.noleading", d.Milliseconds())
...
// Throttle the event listener in milliseconds with trailing edge.
func FooterOnSignalPatchModThrottleMsTrailing(
	d time.Duration,
) FooterOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.trailing", d.Milliseconds())
...
// Throttles the event listener in seconds.
func FooterOnSignalPatchModThrottleSec(
	d time.Duration,
) FooterOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds", int(d.Seconds()))
...
// Throttle the event listener in seconds without leading edge.
func FooterOnSignalPatchModThrottleSecNoLeading(
	d time.Duration,
) FooterOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.noleading", int(d.Seconds()))
...
// Throttle the event listener in seconds with trailing edge.
func FooterOnSignalPatchModThrottleSecTrailing(
	d time.Duration,
) FooterOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.trailing", int(d.Seconds()))
...
func (e *FOOTERElement) DATASTAR_ON_SIGNAL_PATCH(expression string, modifiers ...FooterOnSignalPatchMod) *FOOTERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m FooterOnSignalPatchMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on-signal-patch
func (e *FOOTERElement) IfDATASTAR_ON_SIGNAL_PATCH(condition bool, expression string, modifiers ...FooterOnSignalPatchMod) *FOOTERElement {
	if condition {
...
func (e *FOOTERElement) DATASTAR_ON_SIGNAL_PATCHRemove() *FOOTERElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *FOOTERElement) DATASTAR_ON_SIGNAL_PATCH_FILTER(expression string) *FOOTERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-on-signal-patch-filter
func (e *FOOTERElement) IfDATASTAR_ON_SIGNAL_PATCH_FILTER(condition bool, expression string) *FOOTERElement {
	if condition {
...
func (e *FOOTERElement) DATASTAR_ON_SIGNAL_PATCH_FILTERRemove() *FOOTERElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *FOOTERElement) DATASTAR_PRESERVE_ATTR(expression string) *FOOTERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-preserve-attr
func (e *FOOTERElement) IfDATASTAR_PRESERVE_ATTR(condition bool, expression string) *FOOTERElement {
	if condition {
...
func (e *FOOTERElement) DATASTAR_PRESERVE_ATTRRemove() *FOOTERElement {
	if e.StringAttributes == nil {
		return e
	}
...
type FooterRefMod customDataKeyModifier
...
func (e *FOOTERElement) DATASTAR_REF(expression string, modifiers ...FooterRefMod) *FOOTERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m FooterRefMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-ref
func (e *FOOTERElement) IfDATASTAR_REF(condition bool, expression string, modifiers ...FooterRefMod) *FOOTERElement {
	if condition {
...
func (e *FOOTERElement) DATASTAR_SHOW(expression string) *FOOTERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-show
func (e *FOOTERElement) IfDATASTAR_SHOW(condition bool, expression string) *FOOTERElement {
	if condition {
...
func (e *FOOTERElement) DATASTAR_SHOWRemove() *FOOTERElement {
	if e.StringAttributes == nil {
		return e
	}
...
type FooterSignalsMod customDataKeyModifier
...
func FooterSignalsModIfMissing() FooterSignalsMod {
	return func() string {
		return "ifmissing"
	}
}
...
func (e *FOOTERElement) DATASTAR_SIGNALS(key string, expression string, modifiers ...FooterSignalsMod) *FOOTERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m FooterSignalsMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-signals
func (e *FOOTERElement) IfDATASTAR_SIGNALS(condition bool, key string, expression string, modifiers ...FooterSignalsMod) *FOOTERElement {
	if condition {
...
func (e *FOOTERElement) DATASTAR_SIGNALSRemove(key string) *FOOTERElement {
	if e.StringAttributes == nil {
		return e
	}
...
type FooterStyleMod customDataKeyModifier
...
func (e *FOOTERElement) DATASTAR_STYLE(key string, expression string, modifiers ...FooterStyleMod) *FOOTERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m FooterStyleMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-style
func (e *FOOTERElement) IfDATASTAR_STYLE(condition bool, key string, expression string, modifiers ...FooterStyleMod) *FOOTERElement {
	if condition {
...
func (e *FOOTERElement) DATASTAR_STYLERemove(key string) *FOOTERElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *FOOTERElement) DATASTAR_TEXT(expression string) *FOOTERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-text
func (e *FOOTERElement) IfDATASTAR_TEXT(condition bool, expression string) *FOOTERElement {
	if condition {
