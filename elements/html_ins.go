...
// package html ins is generated from configuration file.
// Description:
package elements
...
// Create a new INSElement element.
// This will create a new element with the tag
// "ins" during rendering.
...
func (e *INSElement) Attr(name string, value string) *INSElement {
...
func (e *INSElement) Attrs(attrs ...string) *INSElement {
	if len(attrs)%2 != 0 {
...
func (e *INSElement) AttrsMap(attrs map[string]string) *INSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	for k, v := range attrs {
...
func (e *INSElement) IfCustomData(condition bool, key, value string) *INSElement {
	if condition {
...
func (e *INSElement) CustomDataF(key, format string, args ...any) *INSElement {
	return e.CustomData(key, fmt.Sprintf(format, args...))
}

func (e *INSElement) IfCustomDataF(condition bool, key, format string, args ...any) *INSElement {
	if condition {
...
func (e *INSElement) CITERemove(s string) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
// Contains a URI which points to the source of the quote or change.
func (e *INSElement) CITERemoveF(format string, args ...any) *INSElement {
...
func (e *INSElement) DATETIMERemove(s string) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
// Indicates the date and time associated with the element.
func (e *INSElement) DATETIMERemoveF(format string, args ...any) *INSElement {
...
const (
	...
	InsAutocapitalize_off InsAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	InsAutocapitalize_none InsAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	InsAutocapitalize_sentences InsAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	InsAutocapitalize_on InsAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	InsAutocapitalize_words InsAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	InsAutocapitalize_characters InsAutocapitalizeChoice = "characters"
)
...
func (e *INSElement) AUTOCAPITALIZERemove(c InsAutocapitalizeChoice) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
// sighted user on a small device will equally miss the context created by the
// preceding content.
func (e *INSElement) AUTOFOCUSRemove(b bool) *INSElement {
	if e.BoolAttributes == nil {
		return e
	}
...
const (
	...
	InsContenteditable_empty InsContenteditableChoice = ""
	// The element is editable.
	InsContenteditable_true InsContenteditableChoice = "true"
	// The element is not editable.
	InsContenteditable_false InsContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	InsContenteditable_plaintext_only InsContenteditableChoice = "plaintext-only"
)
...
func (e *INSElement) CONTENTEDITABLERemove(c InsContenteditableChoice) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *INSElement) DIRRemove(c InsDirChoice) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
const (
	...
	InsDraggable_true InsDraggableChoice = "true"
	// The element is not draggable.
	InsDraggable_false InsDraggableChoice = "false"
	...
	InsDraggable_empty InsDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged
	// For other elements, the event ondragstart must be set for drag and drop to work
	InsDraggable_auto InsDraggableChoice = "auto"
)
...
func (e *INSElement) DRAGGABLERemove(c InsDraggableChoice) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
const (
	...
	InsHidden_empty InsHiddenChoice = ""
	// set the element to the hidden state
	// Additionally, invalid values set the element to the hidden state.
	InsHidden_hidden InsHiddenChoice = "hidden"
	...
	//
	InsHidden_until_found InsHiddenChoice = "until-found"
)
...
func (e *INSElement) HIDDENRemove(c InsHiddenChoice) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *INSElement) IDRemove(s string) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
// Its purpose is to identify the element when linking (using a fragment
// identifier), scripting, or styling (with CSS).
func (e *INSElement) IDRemoveF(format string, args ...any) *INSElement {
...
// Hides the element and its content from assistive technologies by excluding them
// from the accessibility tree.
func (e *INSElement) INERTRemove(b bool) *INSElement {
	if e.BoolAttributes == nil {
		return e
	}
...
const (
	...
	InsInputmode_none InsInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	InsInputmode_empty InsInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	InsInputmode_text InsInputmodeChoice = "text"
	...
	InsInputmode_decimal InsInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9
	// Devices may or may not show a minus key.
	InsInputmode_numeric InsInputmodeChoice = "numeric"
	...
	// type="tel"> instead.
	InsInputmode_tel InsInputmodeChoice = "tel"
	...
	// instead.
	InsInputmode_search InsInputmodeChoice = "search"
	...
	// instead.
	InsInputmode_email InsInputmodeChoice = "email"
	...
	InsInputmode_url InsInputmodeChoice = "url"
)
...
func (e *INSElement) INPUTMODERemove(c InsInputmodeChoice) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *INSElement) ISRemove(s string) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
// successfully defined in the current document, and extends the element type it
// is being applied to.
func (e *INSElement) ISRemoveF(format string, args ...any) *INSElement {
...
func (e *INSElement) ITEMIDRemove(s string) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
// The vocabulary defines whether several items with the same global identifier
// can coexist and, if so, how items with the same identifier are handled.
func (e *INSElement) ITEMIDRemoveF(format string, args ...any) *INSElement {
...
func (e *INSElement) ITEMPROPRemove(s string) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *INSElement) ITEMPROPRemoveF(format string, args ...any) *INSElement {
...
func (e *INSElement) ITEMREFRemove(s string) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
// with additional properties The itemref attribute can only be specified on
// elements that have an itemscope attribute specified.
func (e *INSElement) ITEMREFRemoveF(format string, args ...any) *INSElement {
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *INSElement) ITEMSCOPERemove(b bool) *INSElement {
	if e.BoolAttributes == nil {
		return e
	}
...
func (e *INSElement) ITEMTYPERemove(s string) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *INSElement) ITEMTYPERemoveF(format string, args ...any) *INSElement {
...
func (e *INSElement) LANGRemove(s string) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
// Identifying Languages (BCP47) IETF document
// xml:lang has priority over it.
func (e *INSElement) LANGRemoveF(format string, args ...any) *INSElement {
...
func (e *INSElement) NONCERemove(s string) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
// It is a cryptographic nonce (number used once) that is used by Content Security
// Policy to determine whether or not a given inline script is allowed to execute.
func (e *INSElement) NONCERemoveF(format string, args ...any) *INSElement {
...
const (
	...
	// on-screen at a time.
	InsPopover_auto InsPopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting outside
	// the popover area, and generally only allow one popover to be displayed
	// on-screen at a time.
	InsPopover_empty InsPopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases such
	// as nested popovers in menus.
	InsPopover_manual InsPopoverChoice = "manual"
)
...
func (e *INSElement) POPOVERRemove(c InsPopoverChoice) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *INSElement) ROLERemove(s string) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
// It is a simple string value that can be used to describe the role of an
// element.
func (e *INSElement) ROLERemoveF(format string, args ...any) *INSElement {
...
func (e *INSElement) SLOTRemove(s string) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
// the <slot> element whose name attribute's value matches that slot attribute's
// value.
func (e *INSElement) SLOTRemoveF(format string, args ...any) *INSElement {
...
const (
	...
	InsSpellcheck_empty InsSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	InsSpellcheck_true InsSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	InsSpellcheck_false InsSpellcheckChoice = "false"
)
...
func (e *INSElement) SPELLCHECKRemove(c InsSpellcheckChoice) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *INSElement) STYLEF(k string, format string, args ...any) *INSElement {
...
// font, size, and more
// Styles are written in CSS.
func (e *INSElement) IfSTYLE(condition bool, k string, v string) *INSElement {
	if condition {
		e.STYLE(k, v)
	}
	return e
...
// font, size, and more
// Styles are written in CSS.
func (e *INSElement) STYLE(k string, v string) *INSElement {
	if e.KVStrings == nil {
...
// font, size, and more
// Styles are written in CSS.
func (e *INSElement) IfSTYLEF(condition bool, k string, format string, args ...any) *INSElement {
	if condition {
...
// font, size, and more
// Styles are written in CSS.
func (e *INSElement) IfSTYLEPairs(condition bool, pairs ...string) *INSElement {
	if condition {
		e.STYLEPairs(pairs...)
	}
	return e
...
func (e *INSElement) TABINDEXRemove(i int) *INSElement {
	if e.IntAttributes == nil {
		return e
	}
...
func (e *INSElement) TITLERemove(s string) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
// <input> element, this is not good practice
// Use a <label> instead.
func (e *INSElement) TITLERemoveF(format string, args ...any) *INSElement {
...
const (
	...
	InsTranslate_empty InsTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	InsTranslate_yes InsTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	InsTranslate_no InsTranslateChoice = "no"
)
...
func (e *INSElement) TRANSLATERemove(c InsTranslateChoice) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *INSElement) DATASTAR_ATTR(key string, expression string) *INSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-attr
func (e *INSElement) IfDATASTAR_ATTR(condition bool, key string, expression string) *INSElement {
	if condition {
...
func (e *INSElement) DATASTAR_ATTRRemove(key string) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *INSElement) DATASTAR_BIND(key string, expression string) *INSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-bind
func (e *INSElement) IfDATASTAR_BIND(condition bool, key string, expression string) *INSElement {
	if condition {
...
func (e *INSElement) DATASTAR_BINDRemove(key string) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
type InsClassMod customDataKeyModifier
...
func (e *INSElement) DATASTAR_CLASS(key string, expression string, modifiers ...InsClassMod) *INSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m InsClassMod, i int) customDataKeyModifier {
...
// Adds or removes a class to or from an element based on an expression.
func (e *INSElement) IfDATASTAR_CLASS(condition bool, key string, expression string, modifiers ...InsClassMod) *INSElement {
	if condition {
...
func (e *INSElement) DATASTAR_CLASSRemove(key string) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
type InsComputedMod customDataKeyModifier
...
func (e *INSElement) DATASTAR_COMPUTED(key string, expression string, modifiers ...InsComputedMod) *INSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m InsComputedMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-computed
func (e *INSElement) IfDATASTAR_COMPUTED(condition bool, key string, expression string, modifiers ...InsComputedMod) *INSElement {
	if condition {
...
func (e *INSElement) DATASTAR_COMPUTEDRemove(key string) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *INSElement) DATASTAR_EFFECT(expression string) *INSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-effect
func (e *INSElement) IfDATASTAR_EFFECT(condition bool, expression string) *INSElement {
	if condition {
...
func (e *INSElement) DATASTAR_EFFECTRemove() *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
type InsIgnoreMod customDataKeyModifier

// Only ignore the element itself, not its descendants.
func InsIgnoreModSelf() InsIgnoreMod {
	return func() string {
		return "self"
	}
}
...
func (e *INSElement) DATASTAR_IGNORESet(b bool, modifiers ...InsIgnoreMod) *INSElement {
	key := customDataKey("data-ignore")
	customMods := lo.Map(modifiers, func(m InsIgnoreMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	if e.BoolAttributes == nil {
...
//
// See: https://data-star.dev/reference/attributes#data-ignore
func (e *INSElement) DATASTAR_IGNORE(modifiers ...InsIgnoreMod) *INSElement {
...
func (e *INSElement) DATASTAR_IGNORE_MORPHSet(b bool) *INSElement {
...
//
// See: https://data-star.dev/reference/attributes#data-ignore-morph
func (e *INSElement) DATASTAR_IGNORE_MORPH() *INSElement {
	return e.DATASTAR_IGNORE_MORPHSet(true)
}

type InsIndicatorMod customDataKeyModifier
...
func (e *INSElement) DATASTAR_INDICATOR(expression string, modifiers ...InsIndicatorMod) *INSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m InsIndicatorMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *INSElement) IfDATASTAR_INDICATOR(condition bool, expression string, modifiers ...InsIndicatorMod) *INSElement {
	if condition {
...
func (e *INSElement) DATASTAR_INDICATORRemove() *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
type InsInitMod customDataKeyModifier

// Delay the event listener in milliseconds.
func InsInitModDelayMs(
	d time.Duration,
) InsInitMod {
	return func() string {
...
func InsInitModViewTransition() InsInitMod {
	return func() string {
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *INSElement) DATASTAR_INIT(expression string, modifiers ...InsInitMod) *INSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m InsInitMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *INSElement) IfDATASTAR_INIT(condition bool, expression string, modifiers ...InsInitMod) *INSElement {
	if condition {
...
func (e *INSElement) DATASTAR_INITRemove() *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *INSElement) DATASTAR_JSON_SIGNALS(expression string, modifiers ...InsJsonSignalsMod) *INSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m InsJsonSignalsMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-json-signals
func (e *INSElement) IfDATASTAR_JSON_SIGNALS(condition bool, expression string, modifiers ...InsJsonSignalsMod) *INSElement {
	if condition {
...
func (e *INSElement) DATASTAR_JSON_SIGNALSRemove() *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
type InsOnMod customDataKeyModifier

// Only run the expression once
// Only works with built-in events.
func InsOnModOnce() InsOnMod {
	return func() string {
		return "once"
	}
}
...
func InsOnModDebounceMsLeading(
	d time.Duration,
) InsOnMod {
	return func() string {
...
func InsOnModDebounceMsNoTrailing(
	d time.Duration,
) InsOnMod {
	return func() string {
...
func InsOnModDebounceSecLeading(
	d time.Duration,
) InsOnMod {
	return func() string {
...
func InsOnModDebounceSecNoTrailing(
	d time.Duration,
) InsOnMod {
	return func() string {
...
func InsOnModThrottleMsNoLeading(
	d time.Duration,
) InsOnMod {
	return func() string {
...
func InsOnModThrottleMsTrailing(
	d time.Duration,
) InsOnMod {
	return func() string {
...
func InsOnModThrottleSecNoLeading(
	d time.Duration,
) InsOnMod {
	return func() string {
...
func InsOnModThrottleSecTrailing(
	d time.Duration,
) InsOnMod {
	return func() string {
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func InsOnModViewTransition() InsOnMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *INSElement) DATASTAR_ON(key string, expression string, modifiers ...InsOnMod) *INSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m InsOnMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on
func (e *INSElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...InsOnMod) *INSElement {
	if condition {
...
func (e *INSElement) DATASTAR_ONRemove(key string) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
type InsOnIntersectMod customDataKeyModifier

// Only run the expression once
// Only works with built-in events.
func InsOnIntersectModOnce() InsOnIntersectMod {
	return func() string {
		return "once"
	}
}
...
func InsOnIntersectModHalf() InsOnIntersectMod {
	return func() string {
		return "half"
	}
}
...
func InsOnIntersectModFull() InsOnIntersectMod {
	return func() string {
		return "full"
	}
}
...
// Delay the event listener in seconds.
func InsOnIntersectModDelaySec(
	d time.Duration,
) InsOnIntersectMod {
	return func() string {
		return fmt.Sprintf("delay.%ds", int(d.Seconds()))
...
// Debounces the event handler
func InsOnIntersectModDebounceMs(
	d time.Duration,
) InsOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms", d.Milliseconds())
...
// Debounce the event listener in milliseconds with leading edge.
func InsOnIntersectModDebounceMsLeading(
	d time.Duration,
) InsOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.leading", d.Milliseconds())
...
// Debounce the event listener in milliseconds without trailing edge.
func InsOnIntersectModDebounceMsNoTrailing(
	d time.Duration,
) InsOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.notrailing", d.Milliseconds())
...
// Debounces the event handler
func InsOnIntersectModDebounceSec(
	d time.Duration,
) InsOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds", int(d.Seconds()))
...
// Debounce the event listener in seconds with leading edge.
func InsOnIntersectModDebounceSecLeading(
	d time.Duration,
) InsOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.leading", int(d.Seconds()))
...
// Debounce the event listener in seconds without trailing edge.
func InsOnIntersectModDebounceSecNoTrailing(
	d time.Duration,
) InsOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.notrailing", int(d.Seconds()))
...
// Throttles the event handler
func InsOnIntersectModThrottleMs(
	d time.Duration,
) InsOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms", d.Milliseconds())
...
// Throttle the event listener in milliseconds without leading edge.
func InsOnIntersectModThrottleMsNoLeading(
	d time.Duration,
) InsOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.noleading", d.Milliseconds())
...
// Throttle the event listener in milliseconds with trailing edge.
func InsOnIntersectModThrottleMsTrailing(
	d time.Duration,
) InsOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.trailing", d.Milliseconds())
...
// Throttles the event listener in seconds.
func InsOnIntersectModThrottleSec(
	d time.Duration,
) InsOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds", int(d.Seconds()))
...
// Throttle the event listener in seconds without leading edge.
func InsOnIntersectModThrottleSecNoLeading(
	d time.Duration,
) InsOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.noleading", int(d.Seconds()))
...
// Throttle the event listener in seconds with trailing edge.
func InsOnIntersectModThrottleSecTrailing(
	d time.Duration,
) InsOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.trailing", int(d.Seconds()))
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func InsOnIntersectModViewTransition() InsOnIntersectMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *INSElement) DATASTAR_ON_INTERSECT(expression string, modifiers ...InsOnIntersectMod) *INSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m InsOnIntersectMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
// Runs an expression when the element intersects with the viewport.
func (e *INSElement) IfDATASTAR_ON_INTERSECT(condition bool, expression string, modifiers ...InsOnIntersectMod) *INSElement {
	if condition {
...
func (e *INSElement) DATASTAR_ON_INTERSECTRemove() *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
type InsOnIntervalMod customDataKeyModifier

// Sets the interval duration in milliseconds.
func InsOnIntervalModDurationMs(
	d time.Duration,
) InsOnIntervalMod {
	return func() string {
...
func InsOnIntervalModDurationMsLeading(
	d time.Duration,
) InsOnIntervalMod {
	return func() string {
...
func InsOnIntervalModDurationSec(
	d time.Duration,
) InsOnIntervalMod {
	return func() string {
...
// Sets the interval duration in seconds
// Execute the first interval immediately.
func InsOnIntervalModDurationSecLeading(
	d time.Duration,
) InsOnIntervalMod {
	return func() string {
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func InsOnIntervalModViewTransition() InsOnIntervalMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *INSElement) DATASTAR_ON_INTERVAL(expression string, modifiers ...InsOnIntervalMod) *INSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m InsOnIntervalMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on-interval
func (e *INSElement) IfDATASTAR_ON_INTERVAL(condition bool, expression string, modifiers ...InsOnIntervalMod) *INSElement {
	if condition {
...
func (e *INSElement) DATASTAR_ON_INTERVALRemove() *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
type InsOnSignalPatchMod customDataKeyModifier

// Delay the event listener in milliseconds.
func InsOnSignalPatchModDelayMs(
	d time.Duration,
) InsOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("delay.%dms", d.Milliseconds())
...
// Delay the event listener in seconds.
func InsOnSignalPatchModDelaySec(
	d time.Duration,
) InsOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("delay.%ds", int(d.Seconds()))
...
// Debounces the event handler
func InsOnSignalPatchModDebounceMs(
	d time.Duration,
) InsOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms", d.Milliseconds())
...
// Debounce the event listener in milliseconds with leading edge.
func InsOnSignalPatchModDebounceMsLeading(
	d time.Duration,
) InsOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.leading", d.Milliseconds())
...
// Debounce the event listener in milliseconds without trailing edge.
func InsOnSignalPatchModDebounceMsNoTrailing(
	d time.Duration,
) InsOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.notrailing", d.Milliseconds())
...
// Debounces the event handler
func InsOnSignalPatchModDebounceSec(
	d time.Duration,
) InsOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds", int(d.Seconds()))
...
// Debounce the event listener in seconds with leading edge.
func InsOnSignalPatchModDebounceSecLeading(
	d time.Duration,
) InsOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.leading", int(d.Seconds()))
...
// Debounce the event listener in seconds without trailing edge.
func InsOnSignalPatchModDebounceSecNoTrailing(
	d time.Duration,
) InsOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.notrailing", int(d.Seconds()))
...
// Throttles the event handler
func InsOnSignalPatchModThrottleMs(
	d time.Duration,
) InsOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms", d.Milliseconds())
...
// Throttle the event listener in milliseconds without leading edge.
func InsOnSignalPatchModThrottleMsNoLeading(
	d time.Duration,
) InsOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.noleading", d.Milliseconds())
...
// Throttle the event listener in milliseconds with trailing edge.
func InsOnSignalPatchModThrottleMsTrailing(
	d time.Duration,
) InsOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.trailing", d.Milliseconds())
...
// Throttles the event listener in seconds.
func InsOnSignalPatchModThrottleSec(
	d time.Duration,
) InsOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds", int(d.Seconds()))
...
// Throttle the event listener in seconds without leading edge.
func InsOnSignalPatchModThrottleSecNoLeading(
	d time.Duration,
) InsOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.noleading", int(d.Seconds()))
...
// Throttle the event listener in seconds with trailing edge.
func InsOnSignalPatchModThrottleSecTrailing(
	d time.Duration,
) InsOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.trailing", int(d.Seconds()))
...
func (e *INSElement) DATASTAR_ON_SIGNAL_PATCH(expression string, modifiers ...InsOnSignalPatchMod) *INSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m InsOnSignalPatchMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on-signal-patch
func (e *INSElement) IfDATASTAR_ON_SIGNAL_PATCH(condition bool, expression string, modifiers ...InsOnSignalPatchMod) *INSElement {
	if condition {
...
func (e *INSElement) DATASTAR_ON_SIGNAL_PATCHRemove() *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *INSElement) DATASTAR_ON_SIGNAL_PATCH_FILTER(expression string) *INSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-on-signal-patch-filter
func (e *INSElement) IfDATASTAR_ON_SIGNAL_PATCH_FILTER(condition bool, expression string) *INSElement {
	if condition {
...
func (e *INSElement) DATASTAR_ON_SIGNAL_PATCH_FILTERRemove() *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *INSElement) DATASTAR_PRESERVE_ATTR(expression string) *INSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-preserve-attr
func (e *INSElement) IfDATASTAR_PRESERVE_ATTR(condition bool, expression string) *INSElement {
	if condition {
...
func (e *INSElement) DATASTAR_PRESERVE_ATTRRemove() *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
type InsRefMod customDataKeyModifier
...
func (e *INSElement) DATASTAR_REF(expression string, modifiers ...InsRefMod) *INSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m InsRefMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-ref
func (e *INSElement) IfDATASTAR_REF(condition bool, expression string, modifiers ...InsRefMod) *INSElement {
	if condition {
...
func (e *INSElement) DATASTAR_REFRemove() *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *INSElement) DATASTAR_SHOW(expression string) *INSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-show
func (e *INSElement) IfDATASTAR_SHOW(condition bool, expression string) *INSElement {
	if condition {
...
func (e *INSElement) DATASTAR_SHOWRemove() *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
type InsSignalsMod customDataKeyModifier
...
func InsSignalsModIfMissing() InsSignalsMod {
	return func() string {
		return "ifmissing"
	}
}
...
func (e *INSElement) DATASTAR_SIGNALS(key string, expression string, modifiers ...InsSignalsMod) *INSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m InsSignalsMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-signals
func (e *INSElement) IfDATASTAR_SIGNALS(condition bool, key string, expression string, modifiers ...InsSignalsMod) *INSElement {
	if condition {
...
func (e *INSElement) DATASTAR_SIGNALSRemove(key string) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
type InsStyleMod customDataKeyModifier
...
func (e *INSElement) DATASTAR_STYLE(key string, expression string, modifiers ...InsStyleMod) *INSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m InsStyleMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-style
func (e *INSElement) IfDATASTAR_STYLE(condition bool, key string, expression string, modifiers ...InsStyleMod) *INSElement {
	if condition {
...
func (e *INSElement) DATASTAR_STYLERemove(key string) *INSElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *INSElement) DATASTAR_TEXT(expression string) *INSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-text
func (e *INSElement) IfDATASTAR_TEXT(condition bool, expression string) *INSElement {
	if condition {
...
func (e *INSElement) DATASTAR_TEXTRemove() *INSElement {
	if e.StringAttributes == nil {
		return e
	}
