...
// package html h5 is generated from configuration file.
// Description:
package elements
...
// Create a new H5Element element.
...
func (e *H5Element) Attr(name string, value string) *H5Element {
...
func (e *H5Element) Attrs(attrs ...string) *H5Element {
	if len(attrs)%2 != 0 {
...
func (e *H5Element) AttrsMap(attrs map[string]string) *H5Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	for k, v := range attrs {
...
func (e *H5Element) IfCustomData(condition bool, key, value string) *H5Element {
	if condition {
...
func (e *H5Element) CustomDataF(key, format string, args ...any) *H5Element {
	return e.CustomData(key, fmt.Sprintf(format, args...))
}

func (e *H5Element) IfCustomDataF(condition bool, key, format string, args ...any) *H5Element {
	if condition {
...
const (
	...
	H5Autocapitalize_off H5AutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	H5Autocapitalize_none H5AutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	H5Autocapitalize_sentences H5AutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	H5Autocapitalize_on H5AutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	H5Autocapitalize_words H5AutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	H5Autocapitalize_characters H5AutocapitalizeChoice = "characters"
)
...
func (e *H5Element) AUTOCAPITALIZERemove(c H5AutocapitalizeChoice) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
// sighted user on a small device will equally miss the context created by the
// preceding content.
func (e *H5Element) AUTOFOCUSRemove(b bool) *H5Element {
	if e.BoolAttributes == nil {
		return e
	}
...
const (
	...
	H5Contenteditable_empty H5ContenteditableChoice = ""
	// The element is editable.
	H5Contenteditable_true H5ContenteditableChoice = "true"
	// The element is not editable.
	H5Contenteditable_false H5ContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	H5Contenteditable_plaintext_only H5ContenteditableChoice = "plaintext-only"
)
...
func (e *H5Element) CONTENTEDITABLERemove(c H5ContenteditableChoice) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *H5Element) DIRRemove(c H5DirChoice) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
const (
	...
	H5Draggable_true H5DraggableChoice = "true"
	// The element is not draggable.
	H5Draggable_false H5DraggableChoice = "false"
	...
	H5Draggable_empty H5DraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged
	// For other elements, the event ondragstart must be set for drag and drop to work
	H5Draggable_auto H5DraggableChoice = "auto"
)
...
func (e *H5Element) DRAGGABLERemove(c H5DraggableChoice) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
const (
	...
	H5Hidden_empty H5HiddenChoice = ""
	// set the element to the hidden state
	// Additionally, invalid values set the element to the hidden state.
	H5Hidden_hidden H5HiddenChoice = "hidden"
	...
	//
	H5Hidden_until_found H5HiddenChoice = "until-found"
)
...
func (e *H5Element) HIDDENRemove(c H5HiddenChoice) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *H5Element) IDRemove(s string) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
// Its purpose is to identify the element when linking (using a fragment
// identifier), scripting, or styling (with CSS).
func (e *H5Element) IDRemoveF(format string, args ...any) *H5Element {
...
// Hides the element and its content from assistive technologies by excluding them
// from the accessibility tree.
func (e *H5Element) INERTRemove(b bool) *H5Element {
	if e.BoolAttributes == nil {
		return e
	}
...
const (
	...
	H5Inputmode_none H5InputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	H5Inputmode_empty H5InputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	H5Inputmode_text H5InputmodeChoice = "text"
	...
	H5Inputmode_decimal H5InputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9
	// Devices may or may not show a minus key.
	H5Inputmode_numeric H5InputmodeChoice = "numeric"
	...
	// type="tel"> instead.
	H5Inputmode_tel H5InputmodeChoice = "tel"
	...
	// instead.
	H5Inputmode_search H5InputmodeChoice = "search"
	...
	// instead.
	H5Inputmode_email H5InputmodeChoice = "email"
	...
	H5Inputmode_url H5InputmodeChoice = "url"
)
...
func (e *H5Element) INPUTMODERemove(c H5InputmodeChoice) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *H5Element) ISRemove(s string) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
// successfully defined in the current document, and extends the element type it
// is being applied to.
func (e *H5Element) ISRemoveF(format string, args ...any) *H5Element {
...
func (e *H5Element) ITEMIDRemove(s string) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
// The vocabulary defines whether several items with the same global identifier
// can coexist and, if so, how items with the same identifier are handled.
func (e *H5Element) ITEMIDRemoveF(format string, args ...any) *H5Element {
...
func (e *H5Element) ITEMPROPRemove(s string) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *H5Element) ITEMPROPRemoveF(format string, args ...any) *H5Element {
...
func (e *H5Element) ITEMREFRemove(s string) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
// with additional properties The itemref attribute can only be specified on
// elements that have an itemscope attribute specified.
func (e *H5Element) ITEMREFRemoveF(format string, args ...any) *H5Element {
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *H5Element) ITEMSCOPERemove(b bool) *H5Element {
	if e.BoolAttributes == nil {
		return e
	}
...
func (e *H5Element) ITEMTYPERemove(s string) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *H5Element) ITEMTYPERemoveF(format string, args ...any) *H5Element {
...
func (e *H5Element) LANGRemove(s string) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
// Identifying Languages (BCP47) IETF document
// xml:lang has priority over it.
func (e *H5Element) LANGRemoveF(format string, args ...any) *H5Element {
...
func (e *H5Element) NONCERemove(s string) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
// It is a cryptographic nonce (number used once) that is used by Content Security
// Policy to determine whether or not a given inline script is allowed to execute.
func (e *H5Element) NONCERemoveF(format string, args ...any) *H5Element {
...
const (
	...
	// on-screen at a time.
	H5Popover_auto H5PopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting outside
	// the popover area, and generally only allow one popover to be displayed
	// on-screen at a time.
	H5Popover_empty H5PopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases such
	// as nested popovers in menus.
	H5Popover_manual H5PopoverChoice = "manual"
)
...
func (e *H5Element) POPOVERRemove(c H5PopoverChoice) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *H5Element) ROLERemove(s string) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
// It is a simple string value that can be used to describe the role of an
// element.
func (e *H5Element) ROLERemoveF(format string, args ...any) *H5Element {
...
func (e *H5Element) SLOTRemove(s string) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
// the <slot> element whose name attribute's value matches that slot attribute's
// value.
func (e *H5Element) SLOTRemoveF(format string, args ...any) *H5Element {
...
const (
	...
	H5Spellcheck_empty H5SpellcheckChoice = ""
	// The element will be checked for spelling errors.
	H5Spellcheck_true H5SpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	H5Spellcheck_false H5SpellcheckChoice = "false"
)
...
func (e *H5Element) SPELLCHECKRemove(c H5SpellcheckChoice) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *H5Element) STYLEF(k string, format string, args ...any) *H5Element {
...
// font, size, and more
// Styles are written in CSS.
func (e *H5Element) IfSTYLE(condition bool, k string, v string) *H5Element {
	if condition {
		e.STYLE(k, v)
	}
	return e
...
// font, size, and more
// Styles are written in CSS.
func (e *H5Element) STYLE(k string, v string) *H5Element {
	if e.KVStrings == nil {
...
// font, size, and more
// Styles are written in CSS.
func (e *H5Element) IfSTYLEF(condition bool, k string, format string, args ...any) *H5Element {
	if condition {
...
// font, size, and more
// Styles are written in CSS.
func (e *H5Element) IfSTYLEPairs(condition bool, pairs ...string) *H5Element {
	if condition {
		e.STYLEPairs(pairs...)
	}
	return e
...
func (e *H5Element) TABINDEXRemove(i int) *H5Element {
	if e.IntAttributes == nil {
		return e
	}
...
func (e *H5Element) TITLERemove(s string) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
// <input> element, this is not good practice
// Use a <label> instead.
func (e *H5Element) TITLERemoveF(format string, args ...any) *H5Element {
...
const (
	...
	H5Translate_empty H5TranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	H5Translate_yes H5TranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	H5Translate_no H5TranslateChoice = "no"
)
...
func (e *H5Element) TRANSLATERemove(c H5TranslateChoice) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *H5Element) DATASTAR_ATTR(key string, expression string) *H5Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-attr
func (e *H5Element) IfDATASTAR_ATTR(condition bool, key string, expression string) *H5Element {
	if condition {
...
func (e *H5Element) DATASTAR_ATTRRemove(key string) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *H5Element) DATASTAR_BIND(key string, expression string) *H5Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-bind
func (e *H5Element) IfDATASTAR_BIND(condition bool, key string, expression string) *H5Element {
	if condition {
...
func (e *H5Element) DATASTAR_BINDRemove(key string) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
type H5ClassMod customDataKeyModifier
...
func (e *H5Element) DATASTAR_CLASS(key string, expression string, modifiers ...H5ClassMod) *H5Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m H5ClassMod, i int) customDataKeyModifier {
...
// Adds or removes a class to or from an element based on an expression.
func (e *H5Element) IfDATASTAR_CLASS(condition bool, key string, expression string, modifiers ...H5ClassMod) *H5Element {
	if condition {
...
func (e *H5Element) DATASTAR_CLASSRemove(key string) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
type H5ComputedMod customDataKeyModifier
...
func (e *H5Element) DATASTAR_COMPUTED(key string, expression string, modifiers ...H5ComputedMod) *H5Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m H5ComputedMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-computed
func (e *H5Element) IfDATASTAR_COMPUTED(condition bool, key string, expression string, modifiers ...H5ComputedMod) *H5Element {
	if condition {
...
func (e *H5Element) DATASTAR_COMPUTEDRemove(key string) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *H5Element) DATASTAR_EFFECT(expression string) *H5Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-effect
func (e *H5Element) IfDATASTAR_EFFECT(condition bool, expression string) *H5Element {
	if condition {
...
func (e *H5Element) DATASTAR_EFFECTRemove() *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
type H5IgnoreMod customDataKeyModifier

// Only ignore the element itself, not its descendants.
func H5IgnoreModSelf() H5IgnoreMod {
	return func() string {
		return "self"
	}
}
...
func (e *H5Element) DATASTAR_IGNORESet(b bool, modifiers ...H5IgnoreMod) *H5Element {
	key := customDataKey("data-ignore")
	customMods := lo.Map(modifiers, func(m H5IgnoreMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	if e.BoolAttributes == nil {
...
//
// See: https://data-star.dev/reference/attributes#data-ignore
func (e *H5Element) DATASTAR_IGNORE(modifiers ...H5IgnoreMod) *H5Element {
...
func (e *H5Element) DATASTAR_IGNORE_MORPHSet(b bool) *H5Element {
...
//
// See: https://data-star.dev/reference/attributes#data-ignore-morph
func (e *H5Element) DATASTAR_IGNORE_MORPH() *H5Element {
	return e.DATASTAR_IGNORE_MORPHSet(true)
}

type H5IndicatorMod customDataKeyModifier
...
func (e *H5Element) DATASTAR_INDICATOR(expression string, modifiers ...H5IndicatorMod) *H5Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m H5IndicatorMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *H5Element) IfDATASTAR_INDICATOR(condition bool, expression string, modifiers ...H5IndicatorMod) *H5Element {
	if condition {
...
func (e *H5Element) DATASTAR_INDICATORRemove() *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
type H5InitMod customDataKeyModifier

// Delay the event listener in milliseconds.
func H5InitModDelayMs(
	d time.Duration,
) H5InitMod {
	return func() string {
...
func H5InitModViewTransition() H5InitMod {
	return func() string {
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *H5Element) DATASTAR_INIT(expression string, modifiers ...H5InitMod) *H5Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m H5InitMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *H5Element) IfDATASTAR_INIT(condition bool, expression string, modifiers ...H5InitMod) *H5Element {
	if condition {
...
func (e *H5Element) DATASTAR_INITRemove() *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *H5Element) DATASTAR_JSON_SIGNALS(expression string, modifiers ...H5JsonSignalsMod) *H5Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m H5JsonSignalsMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-json-signals
func (e *H5Element) IfDATASTAR_JSON_SIGNALS(condition bool, expression string, modifiers ...H5JsonSignalsMod) *H5Element {
	if condition {
...
func (e *H5Element) DATASTAR_JSON_SIGNALSRemove() *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
func H5OnModDebounceMsNoTrailing(
	d time.Duration,
) H5OnMod {
	return func() string {
...
func H5OnModDebounceSecLeading(
	d time.Duration,
) H5OnMod {
	return func() string {
...
func H5OnModDebounceSecNoTrailing(
	d time.Duration,
) H5OnMod {
	return func() string {
...
func H5OnModThrottleMsNoLeading(
	d time.Duration,
) H5OnMod {
	return func() string {
...
func H5OnModThrottleMsTrailing(
	d time.Duration,
) H5OnMod {
	return func() string {
...
func H5OnModThrottleSecNoLeading(
	d time.Duration,
) H5OnMod {
	return func() string {
...
func H5OnModThrottleSecTrailing(
	d time.Duration,
) H5OnMod {
	return func() string {
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func H5OnModViewTransition() H5OnMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *H5Element) DATASTAR_ON(key string, expression string, modifiers ...H5OnMod) *H5Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m H5OnMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on
func (e *H5Element) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...H5OnMod) *H5Element {
	if condition {
...
func (e *H5Element) DATASTAR_ONRemove(key string) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
type H5OnIntersectMod customDataKeyModifier

// Only run the expression once
// Only works with built-in events.
func H5OnIntersectModOnce() H5OnIntersectMod {
	return func() string {
		return "once"
	}
}
...
func H5OnIntersectModHalf() H5OnIntersectMod {
	return func() string {
		return "half"
	}
}
...
func H5OnIntersectModFull() H5OnIntersectMod {
	return func() string {
		return "full"
	}
}
...
// Debounces the event handler
func H5OnIntersectModDebounceMs(
	d time.Duration,
) H5OnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms", d.Milliseconds())
...
// Debounce the event listener in milliseconds with leading edge.
func H5OnIntersectModDebounceMsLeading(
	d time.Duration,
) H5OnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.leading", d.Milliseconds())
...
// Debounce the event listener in milliseconds without trailing edge.
func H5OnIntersectModDebounceMsNoTrailing(
	d time.Duration,
) H5OnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.notrailing", d.Milliseconds())
...
// Debounces the event handler
func H5OnIntersectModDebounceSec(
	d time.Duration,
) H5OnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds", int(d.Seconds()))
...
// Debounce the event listener in seconds with leading edge.
func H5OnIntersectModDebounceSecLeading(
	d time.Duration,
) H5OnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.leading", int(d.Seconds()))
...
// Debounce the event listener in seconds without trailing edge.
func H5OnIntersectModDebounceSecNoTrailing(
	d time.Duration,
) H5OnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.notrailing", int(d.Seconds()))
...
// Throttles the event handler
func H5OnIntersectModThrottleMs(
	d time.Duration,
) H5OnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms", d.Milliseconds())
...
// Throttle the event listener in milliseconds without leading edge.
func H5OnIntersectModThrottleMsNoLeading(
	d time.Duration,
) H5OnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.noleading", d.Milliseconds())
...
// Throttle the event listener in milliseconds with trailing edge.
func H5OnIntersectModThrottleMsTrailing(
	d time.Duration,
) H5OnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.trailing", d.Milliseconds())
...
// Throttles the event listener in seconds.
func H5OnIntersectModThrottleSec(
	d time.Duration,
) H5OnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds", int(d.Seconds()))
...
// Throttle the event listener in seconds without leading edge.
func H5OnIntersectModThrottleSecNoLeading(
	d time.Duration,
) H5OnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.noleading", int(d.Seconds()))
...
// Throttle the event listener in seconds with trailing edge.
func H5OnIntersectModThrottleSecTrailing(
	d time.Duration,
) H5OnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.trailing", int(d.Seconds()))
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func H5OnIntersectModViewTransition() H5OnIntersectMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *H5Element) DATASTAR_ON_INTERSECT(expression string, modifiers ...H5OnIntersectMod) *H5Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m H5OnIntersectMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
// Runs an expression when the element intersects with the viewport.
func (e *H5Element) IfDATASTAR_ON_INTERSECT(condition bool, expression string, modifiers ...H5OnIntersectMod) *H5Element {
	if condition {
...
func (e *H5Element) DATASTAR_ON_INTERSECTRemove() *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
type H5OnIntervalMod customDataKeyModifier

// Sets the interval duration in milliseconds.
func H5OnIntervalModDurationMs(
	d time.Duration,
) H5OnIntervalMod {
	return func() string {
...
func H5OnIntervalModDurationMsLeading(
	d time.Duration,
) H5OnIntervalMod {
	return func() string {
...
func H5OnIntervalModDurationSec(
	d time.Duration,
) H5OnIntervalMod {
	return func() string {
...
// Sets the interval duration in seconds
// Execute the first interval immediately.
func H5OnIntervalModDurationSecLeading(
	d time.Duration,
) H5OnIntervalMod {
	return func() string {
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func H5OnIntervalModViewTransition() H5OnIntervalMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *H5Element) DATASTAR_ON_INTERVAL(expression string, modifiers ...H5OnIntervalMod) *H5Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m H5OnIntervalMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on-interval
func (e *H5Element) IfDATASTAR_ON_INTERVAL(condition bool, expression string, modifiers ...H5OnIntervalMod) *H5Element {
	if condition {
...
func (e *H5Element) DATASTAR_ON_INTERVALRemove() *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
type H5OnSignalPatchMod customDataKeyModifier

// Delay the event listener in milliseconds.
func H5OnSignalPatchModDelayMs(
	d time.Duration,
) H5OnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("delay.%dms", d.Milliseconds())
...
// Delay the event listener in seconds.
func H5OnSignalPatchModDelaySec(
	d time.Duration,
) H5OnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("delay.%ds", int(d.Seconds()))
...
// Debounces the event handler
func H5OnSignalPatchModDebounceMs(
	d time.Duration,
) H5OnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms", d.Milliseconds())
...
// Debounce the event listener in milliseconds with leading edge.
func H5OnSignalPatchModDebounceMsLeading(
	d time.Duration,
) H5OnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.leading", d.Milliseconds())
...
// Debounce the event listener in milliseconds without trailing edge.
func H5OnSignalPatchModDebounceMsNoTrailing(
	d time.Duration,
) H5OnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.notrailing", d.Milliseconds())
...
// Debounces the event handler
func H5OnSignalPatchModDebounceSec(
	d time.Duration,
) H5OnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds", int(d.Seconds()))
...
// Debounce the event listener in seconds with leading edge.
func H5OnSignalPatchModDebounceSecLeading(
	d time.Duration,
) H5OnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.leading", int(d.Seconds()))
...
// Debounce the event listener in seconds without trailing edge.
func H5OnSignalPatchModDebounceSecNoTrailing(
	d time.Duration,
) H5OnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.notrailing", int(d.Seconds()))
...
// Throttles the event handler
func H5OnSignalPatchModThrottleMs(
	d time.Duration,
) H5OnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms", d.Milliseconds())
...
// Throttle the event listener in milliseconds without leading edge.
func H5OnSignalPatchModThrottleMsNoLeading(
	d time.Duration,
) H5OnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.noleading", d.Milliseconds())
...
// Throttle the event listener in milliseconds with trailing edge.
func H5OnSignalPatchModThrottleMsTrailing(
	d time.Duration,
) H5OnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.trailing", d.Milliseconds())
...
// Throttles the event listener in seconds.
func H5OnSignalPatchModThrottleSec(
	d time.Duration,
) H5OnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds", int(d.Seconds()))
...
// Throttle the event listener in seconds without leading edge.
func H5OnSignalPatchModThrottleSecNoLeading(
	d time.Duration,
) H5OnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.noleading", int(d.Seconds()))
...
// Throttle the event listener in seconds with trailing edge.
func H5OnSignalPatchModThrottleSecTrailing(
	d time.Duration,
) H5OnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.trailing", int(d.Seconds()))
...
func (e *H5Element) DATASTAR_ON_SIGNAL_PATCH(expression string, modifiers ...H5OnSignalPatchMod) *H5Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m H5OnSignalPatchMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on-signal-patch
func (e *H5Element) IfDATASTAR_ON_SIGNAL_PATCH(condition bool, expression string, modifiers ...H5OnSignalPatchMod) *H5Element {
	if condition {
...
func (e *H5Element) DATASTAR_ON_SIGNAL_PATCHRemove() *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *H5Element) DATASTAR_ON_SIGNAL_PATCH_FILTER(expression string) *H5Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-on-signal-patch-filter
func (e *H5Element) IfDATASTAR_ON_SIGNAL_PATCH_FILTER(condition bool, expression string) *H5Element {
	if condition {
...
func (e *H5Element) DATASTAR_ON_SIGNAL_PATCH_FILTERRemove() *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *H5Element) DATASTAR_PRESERVE_ATTR(expression string) *H5Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-preserve-attr
func (e *H5Element) IfDATASTAR_PRESERVE_ATTR(condition bool, expression string) *H5Element {
	if condition {
...
func (e *H5Element) DATASTAR_PRESERVE_ATTRRemove() *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
type H5RefMod customDataKeyModifier
...
func (e *H5Element) DATASTAR_REF(expression string, modifiers ...H5RefMod) *H5Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m H5RefMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-ref
func (e *H5Element) IfDATASTAR_REF(condition bool, expression string, modifiers ...H5RefMod) *H5Element {
	if condition {
...
func (e *H5Element) DATASTAR_REFRemove() *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *H5Element) DATASTAR_SHOW(expression string) *H5Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-show
func (e *H5Element) IfDATASTAR_SHOW(condition bool, expression string) *H5Element {
	if condition {
...
func (e *H5Element) DATASTAR_SHOWRemove() *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
type H5SignalsMod customDataKeyModifier
...
func H5SignalsModIfMissing() H5SignalsMod {
	return func() string {
		return "ifmissing"
	}
}
...
func (e *H5Element) DATASTAR_SIGNALS(key string, expression string, modifiers ...H5SignalsMod) *H5Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m H5SignalsMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-signals
func (e *H5Element) IfDATASTAR_SIGNALS(condition bool, key string, expression string, modifiers ...H5SignalsMod) *H5Element {
	if condition {
...
func (e *H5Element) DATASTAR_SIGNALSRemove(key string) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
type H5StyleMod customDataKeyModifier
...
func (e *H5Element) DATASTAR_STYLE(key string, expression string, modifiers ...H5StyleMod) *H5Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m H5StyleMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-style
func (e *H5Element) IfDATASTAR_STYLE(condition bool, key string, expression string, modifiers ...H5StyleMod) *H5Element {
	if condition {
...
func (e *H5Element) DATASTAR_STYLERemove(key string) *H5Element {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *H5Element) DATASTAR_TEXT(expression string) *H5Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-text
func (e *H5Element) IfDATASTAR_TEXT(condition bool, expression string) *H5Element {
	if condition {
...
func (e *H5Element) DATASTAR_TEXTRemove() *H5Element {
	if e.StringAttributes == nil {
		return e
	}
