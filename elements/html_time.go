...
// package html time is generated from configuration file.
// Description:
package elements
...
// Create a new TIMEElement element.
...
func (e *TIMEElement) Attrs(attrs ...string) *TIMEElement {
	if len(attrs)%2 != 0 {
...
func (e *TIMEElement) AttrsMap(attrs map[string]string) *TIMEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	for k, v := range attrs {
...
func (e *TIMEElement) DATETIMERemove(s string) *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
// Machine-readable value.
func (e *TIMEElement) DATETIMERemoveF(format string, args ...any) *TIMEElement {
...
const (
	...
	TimeAutocapitalize_off TimeAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	TimeAutocapitalize_none TimeAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	TimeAutocapitalize_sentences TimeAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	TimeAutocapitalize_on TimeAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	TimeAutocapitalize_words TimeAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	TimeAutocapitalize_characters TimeAutocapitalizeChoice = "characters"
)
...
func (e *TIMEElement) AUTOCAPITALIZERemove(c TimeAutocapitalizeChoice) *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
// sighted user on a small device will equally miss the context created by the
// preceding content.
func (e *TIMEElement) AUTOFOCUSRemove(b bool) *TIMEElement {
	if e.BoolAttributes == nil {
		return e
	}
...
const (
	...
	TimeContenteditable_empty TimeContenteditableChoice = ""
	// The element is editable.
	TimeContenteditable_true TimeContenteditableChoice = "true"
	// The element is not editable.
	TimeContenteditable_false TimeContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	TimeContenteditable_plaintext_only TimeContenteditableChoice = "plaintext-only"
)
...
func (e *TIMEElement) CONTENTEDITABLERemove(c TimeContenteditableChoice) *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
const (
	...
	TimeDir_auto TimeDirChoice = "auto"
)
...
func (e *TIMEElement) DIRRemove(c TimeDirChoice) *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
const (
	...
	TimeDraggable_true TimeDraggableChoice = "true"
	// The element is not draggable.
	TimeDraggable_false TimeDraggableChoice = "false"
	...
	TimeDraggable_empty TimeDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged
	// For other elements, the event ondragstart must be set for drag and drop to work
	TimeDraggable_auto TimeDraggableChoice = "auto"
)
...
func (e *TIMEElement) DRAGGABLERemove(c TimeDraggableChoice) *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
const (
	...
	TimeHidden_empty TimeHiddenChoice = ""
	// set the element to the hidden state
	// Additionally, invalid values set the element to the hidden state.
	TimeHidden_hidden TimeHiddenChoice = "hidden"
	...
	//
	TimeHidden_until_found TimeHiddenChoice = "until-found"
)
...
func (e *TIMEElement) HIDDENRemove(c TimeHiddenChoice) *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
// Its purpose is to identify the element when linking (using a fragment
// identifier), scripting, or styling (with CSS).
func (e *TIMEElement) IDRemoveF(format string, args ...any) *TIMEElement {
...
// Hides the element and its content from assistive technologies by excluding them
// from the accessibility tree.
func (e *TIMEElement) INERTRemove(b bool) *TIMEElement {
	if e.BoolAttributes == nil {
		return e
	}
...
const (
	...
	TimeInputmode_none TimeInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	TimeInputmode_empty TimeInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	TimeInputmode_text TimeInputmodeChoice = "text"
	...
	TimeInputmode_decimal TimeInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9
	// Devices may or may not show a minus key.
	TimeInputmode_numeric TimeInputmodeChoice = "numeric"
	...
	// type="tel"> instead.
	TimeInputmode_tel TimeInputmodeChoice = "tel"
	...
	// instead.
	TimeInputmode_search TimeInputmodeChoice = "search"
	...
	// instead.
	TimeInputmode_email TimeInputmodeChoice = "email"
	...
	TimeInputmode_url TimeInputmodeChoice = "url"
)
...
func (e *TIMEElement) INPUTMODERemove(c TimeInputmodeChoice) *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
// successfully defined in the current document, and extends the element type it
// is being applied to.
func (e *TIMEElement) ISRemoveF(format string, args ...any) *TIMEElement {
...
// The vocabulary defines whether several items with the same global identifier
// can coexist and, if so, how items with the same identifier are handled.
func (e *TIMEElement) ITEMIDRemoveF(format string, args ...any) *TIMEElement {
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *TIMEElement) ITEMPROPRemoveF(format string, args ...any) *TIMEElement {
...
func (e *TIMEElement) ITEMREFRemove(s string) *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
// with additional properties The itemref attribute can only be specified on
// elements that have an itemscope attribute specified.
func (e *TIMEElement) ITEMREFRemoveF(format string, args ...any) *TIMEElement {
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *TIMEElement) ITEMSCOPERemove(b bool) *TIMEElement {
	if e.BoolAttributes == nil {
		return e
	}
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *TIMEElement) ITEMTYPERemoveF(format string, args ...any) *TIMEElement {
...
// Identifying Languages (BCP47) IETF document
// xml:lang has priority over it.
func (e *TIMEElement) LANGRemoveF(format string, args ...any) *TIMEElement {
...
func (e *TIMEElement) NONCERemove(s string) *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
// It is a cryptographic nonce (number used once) that is used by Content Security
// Policy to determine whether or not a given inline script is allowed to execute.
func (e *TIMEElement) NONCERemoveF(format string, args ...any) *TIMEElement {
...
func (e *TIMEElement) ROLERemove(s string) *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
// It is a simple string value that can be used to describe the role of an
// element.
func (e *TIMEElement) ROLERemoveF(format string, args ...any) *TIMEElement {
...
// the <slot> element whose name attribute's value matches that slot attribute's
// value.
func (e *TIMEElement) SLOTRemoveF(format string, args ...any) *TIMEElement {
...
const (
	...
	TimeSpellcheck_empty TimeSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	TimeSpellcheck_true TimeSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	TimeSpellcheck_false TimeSpellcheckChoice = "false"
)
...
func (e *TIMEElement) SPELLCHECKRemove(c TimeSpellcheckChoice) *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *TIMEElement) TABINDEXRemove(i int) *TIMEElement {
	if e.IntAttributes == nil {
		return e
	}
...
func (e *TIMEElement) TITLERemove(s string) *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
// <input> element, this is not good practice
// Use a <label> instead.
func (e *TIMEElement) TITLERemoveF(format string, args ...any) *TIMEElement {
...
const (
	...
	TimeTranslate_empty TimeTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	TimeTranslate_yes TimeTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	TimeTranslate_no TimeTranslateChoice = "no"
)
...
func (e *TIMEElement) TRANSLATERemove(c TimeTranslateChoice) *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *TIMEElement) DATASTAR_ATTR(key string, expression string) *TIMEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-attr
func (e *TIMEElement) IfDATASTAR_ATTR(condition bool, key string, expression string) *TIMEElement {
	if condition {
...
func (e *TIMEElement) DATASTAR_ATTRRemove(key string) *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *TIMEElement) DATASTAR_BIND(key string, expression string) *TIMEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-bind
func (e *TIMEElement) IfDATASTAR_BIND(condition bool, key string, expression string) *TIMEElement {
	if condition {
...
func (e *TIMEElement) DATASTAR_BINDRemove(key string) *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
type TimeClassMod customDataKeyModifier
...
func (e *TIMEElement) DATASTAR_CLASS(key string, expression string, modifiers ...TimeClassMod) *TIMEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m TimeClassMod, i int) customDataKeyModifier {
...
// Adds or removes a class to or from an element based on an expression.
func (e *TIMEElement) IfDATASTAR_CLASS(condition bool, key string, expression string, modifiers ...TimeClassMod) *TIMEElement {
	if condition {
...
func (e *TIMEElement) DATASTAR_CLASSRemove(key string) *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
type TimeComputedMod customDataKeyModifier
...
func (e *TIMEElement) DATASTAR_COMPUTED(key string, expression string, modifiers ...TimeComputedMod) *TIMEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m TimeComputedMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-computed
func (e *TIMEElement) IfDATASTAR_COMPUTED(condition bool, key string, expression string, modifiers ...TimeComputedMod) *TIMEElement {
	if condition {
...
func (e *TIMEElement) DATASTAR_COMPUTEDRemove(key string) *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *TIMEElement) DATASTAR_EFFECT(expression string) *TIMEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-effect
func (e *TIMEElement) IfDATASTAR_EFFECT(condition bool, expression string) *TIMEElement {
	if condition {
...
func (e *TIMEElement) DATASTAR_EFFECTRemove() *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
type TimeIgnoreMod customDataKeyModifier

// Only ignore the element itself, not its descendants.
func TimeIgnoreModSelf() TimeIgnoreMod {
	return func() string {
		return "self"
	}
}
...
func (e *TIMEElement) DATASTAR_IGNORESet(b bool, modifiers ...TimeIgnoreMod) *TIMEElement {
	key := customDataKey("data-ignore")
	customMods := lo.Map(modifiers, func(m TimeIgnoreMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	if e.BoolAttributes == nil {
...
//
// See: https://data-star.dev/reference/attributes#data-ignore
func (e *TIMEElement) DATASTAR_IGNORE(modifiers ...TimeIgnoreMod) *TIMEElement {
...
func (e *TIMEElement) DATASTAR_IGNORE_MORPHSet(b bool) *TIMEElement {
...
//
// See: https://data-star.dev/reference/attributes#data-ignore-morph
func (e *TIMEElement) DATASTAR_IGNORE_MORPH() *TIMEElement {
	return e.DATASTAR_IGNORE_MORPHSet(true)
}

type TimeIndicatorMod customDataKeyModifier
...
func (e *TIMEElement) DATASTAR_INDICATOR(expression string, modifiers ...TimeIndicatorMod) *TIMEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m TimeIndicatorMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *TIMEElement) IfDATASTAR_INDICATOR(condition bool, expression string, modifiers ...TimeIndicatorMod) *TIMEElement {
	if condition {
...
func (e *TIMEElement) DATASTAR_INDICATORRemove() *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
type TimeInitMod customDataKeyModifier

// Delay the event listener in milliseconds.
func TimeInitModDelayMs(
	d time.Duration,
) TimeInitMod {
	return func() string {
...
func TimeInitModViewTransition() TimeInitMod {
	return func() string {
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *TIMEElement) DATASTAR_INIT(expression string, modifiers ...TimeInitMod) *TIMEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m TimeInitMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *TIMEElement) IfDATASTAR_INIT(condition bool, expression string, modifiers ...TimeInitMod) *TIMEElement {
	if condition {
...
func (e *TIMEElement) DATASTAR_INITRemove() *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *TIMEElement) DATASTAR_JSON_SIGNALS(expression string, modifiers ...TimeJsonSignalsMod) *TIMEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m TimeJsonSignalsMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-json-signals
func (e *TIMEElement) IfDATASTAR_JSON_SIGNALS(condition bool, expression string, modifiers ...TimeJsonSignalsMod) *TIMEElement {
	if condition {
...
func (e *TIMEElement) DATASTAR_JSON_SIGNALSRemove() *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
type TimeOnMod customDataKeyModifier

// Only run the expression once
// Only works with built-in events.
func TimeOnModOnce() TimeOnMod {
	return func() string {
		return "once"
	}
}
...
// Only works with built-in events.
func TimeOnModPassive() TimeOnMod {
	return func() string {
		return "passive"
	}
}
...
// Only works with built-in events.
func TimeOnModCapture() TimeOnMod {
	return func() string {
		return "capture"
	}
}
...
func TimeOnModDebounceMsLeading(
	d time.Duration,
) TimeOnMod {
	return func() string {
...
func TimeOnModDebounceMsNoTrailing(
	d time.Duration,
) TimeOnMod {
	return func() string {
...
func TimeOnModDebounceSecLeading(
	d time.Duration,
) TimeOnMod {
	return func() string {
...
func TimeOnModDebounceSecNoTrailing(
	d time.Duration,
) TimeOnMod {
	return func() string {
...
func TimeOnModThrottleMsNoLeading(
	d time.Duration,
) TimeOnMod {
	return func() string {
...
func TimeOnModThrottleMsTrailing(
	d time.Duration,
) TimeOnMod {
	return func() string {
...
func TimeOnModThrottleSecNoLeading(
	d time.Duration,
) TimeOnMod {
	return func() string {
...
func TimeOnModThrottleSecTrailing(
	d time.Duration,
) TimeOnMod {
	return func() string {
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func TimeOnModViewTransition() TimeOnMod {
	return func() string {
		return "viewtransition"
	}
}
...
func TimeOnModWindow() TimeOnMod {
	return func() string {
		return "window"
	}
}
...
func TimeOnModPrevent() TimeOnMod {
	return func() string {
		return "prevent"
	}
}
...
func TimeOnModOutside() TimeOnMod {
	return func() string {
		return "outside"
	}
}
...
func (e *TIMEElement) DATASTAR_ON(key string, expression string, modifiers ...TimeOnMod) *TIMEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m TimeOnMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on
func (e *TIMEElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...TimeOnMod) *TIMEElement {
	if condition {
...
func (e *TIMEElement) DATASTAR_ONRemove(key string) *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
type TimeOnIntersectMod customDataKeyModifier

// Only run the expression once
// Only works with built-in events.
func TimeOnIntersectModOnce() TimeOnIntersectMod {
	return func() string {
		return "once"
	}
}
...
func TimeOnIntersectModHalf() TimeOnIntersectMod {
	return func() string {
		return "half"
	}
}
...
func TimeOnIntersectModFull() TimeOnIntersectMod {
	return func() string {
		return "full"
	}
}
...
// Delay the event listener in milliseconds.
func TimeOnIntersectModDelayMs(
	d time.Duration,
) TimeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("delay.%dms", d.Milliseconds())
...
// Delay the event listener in seconds.
func TimeOnIntersectModDelaySec(
	d time.Duration,
) TimeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("delay.%ds", int(d.Seconds()))
...
// Debounces the event handler
func TimeOnIntersectModDebounceMs(
	d time.Duration,
) TimeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms", d.Milliseconds())
...
// Debounce the event listener in milliseconds with leading edge.
func TimeOnIntersectModDebounceMsLeading(
	d time.Duration,
) TimeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.leading", d.Milliseconds())
...
// Debounce the event listener in milliseconds without trailing edge.
func TimeOnIntersectModDebounceMsNoTrailing(
	d time.Duration,
) TimeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.notrailing", d.Milliseconds())
...
// Debounces the event handler
func TimeOnIntersectModDebounceSec(
	d time.Duration,
) TimeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds", int(d.Seconds()))
...
// Debounce the event listener in seconds with leading edge.
func TimeOnIntersectModDebounceSecLeading(
	d time.Duration,
) TimeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.leading", int(d.Seconds()))
...
// Debounce the event listener in seconds without trailing edge.
func TimeOnIntersectModDebounceSecNoTrailing(
	d time.Duration,
) TimeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.notrailing", int(d.Seconds()))
...
// Throttles the event handler
func TimeOnIntersectModThrottleMs(
	d time.Duration,
) TimeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms", d.Milliseconds())
...
// Throttle the event listener in milliseconds without leading edge.
func TimeOnIntersectModThrottleMsNoLeading(
	d time.Duration,
) TimeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.noleading", d.Milliseconds())
...
// Throttle the event listener in milliseconds with trailing edge.
func TimeOnIntersectModThrottleMsTrailing(
	d time.Duration,
) TimeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.trailing", d.Milliseconds())
...
// Throttles the event listener in seconds.
func TimeOnIntersectModThrottleSec(
	d time.Duration,
) TimeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds", int(d.Seconds()))
...
// Throttle the event listener in seconds without leading edge.
func TimeOnIntersectModThrottleSecNoLeading(
	d time.Duration,
) TimeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.noleading", int(d.Seconds()))
...
// Throttle the event listener in seconds with trailing edge.
func TimeOnIntersectModThrottleSecTrailing(
	d time.Duration,
) TimeOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.trailing", int(d.Seconds()))
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func TimeOnIntersectModViewTransition() TimeOnIntersectMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *TIMEElement) DATASTAR_ON_INTERSECT(expression string, modifiers ...TimeOnIntersectMod) *TIMEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m TimeOnIntersectMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
// Runs an expression when the element intersects with the viewport.
func (e *TIMEElement) IfDATASTAR_ON_INTERSECT(condition bool, expression string, modifiers ...TimeOnIntersectMod) *TIMEElement {
	if condition {
...
func (e *TIMEElement) DATASTAR_ON_INTERSECTRemove() *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
type TimeOnIntervalMod customDataKeyModifier

// Sets the interval duration in milliseconds.
func TimeOnIntervalModDurationMs(
	d time.Duration,
) TimeOnIntervalMod {
	return func() string {
...
func TimeOnIntervalModDurationMsLeading(
	d time.Duration,
) TimeOnIntervalMod {
	return func() string {
...
func TimeOnIntervalModDurationSec(
	d time.Duration,
) TimeOnIntervalMod {
	return func() string {
...
// Sets the interval duration in seconds
// Execute the first interval immediately.
func TimeOnIntervalModDurationSecLeading(
	d time.Duration,
) TimeOnIntervalMod {
	return func() string {
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func TimeOnIntervalModViewTransition() TimeOnIntervalMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *TIMEElement) DATASTAR_ON_INTERVAL(expression string, modifiers ...TimeOnIntervalMod) *TIMEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m TimeOnIntervalMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on-interval
func (e *TIMEElement) IfDATASTAR_ON_INTERVAL(condition bool, expression string, modifiers ...TimeOnIntervalMod) *TIMEElement {
	if condition {
...
func (e *TIMEElement) DATASTAR_ON_INTERVALRemove() *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
type TimeOnSignalPatchMod customDataKeyModifier

// Delay the event listener in milliseconds.
func TimeOnSignalPatchModDelayMs(
	d time.Duration,
) TimeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("delay.%dms", d.Milliseconds())
	}
}
...
// Delay the event listener in seconds.
func TimeOnSignalPatchModDelaySec(
	d time.Duration,
) TimeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("delay.%ds", int(d.Seconds()))
...
// Debounces the event handler
func TimeOnSignalPatchModDebounceMs(
	d time.Duration,
) TimeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms", d.Milliseconds())
...
// Debounce the event listener in milliseconds with leading edge.
func TimeOnSignalPatchModDebounceMsLeading(
	d time.Duration,
) TimeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.leading", d.Milliseconds())
...
// Debounce the event listener in milliseconds without trailing edge.
func TimeOnSignalPatchModDebounceMsNoTrailing(
	d time.Duration,
) TimeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.notrailing", d.Milliseconds())
...
// Debounces the event handler
func TimeOnSignalPatchModDebounceSec(
	d time.Duration,
) TimeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds", int(d.Seconds()))
...
// Debounce the event listener in seconds with leading edge.
func TimeOnSignalPatchModDebounceSecLeading(
	d time.Duration,
) TimeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.leading", int(d.Seconds()))
...
// Debounce the event listener in seconds without trailing edge.
func TimeOnSignalPatchModDebounceSecNoTrailing(
	d time.Duration,
) TimeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.notrailing", int(d.Seconds()))
...
// Throttles the event handler
func TimeOnSignalPatchModThrottleMs(
	d time.Duration,
) TimeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms", d.Milliseconds())
...
// Throttle the event listener in milliseconds without leading edge.
func TimeOnSignalPatchModThrottleMsNoLeading(
	d time.Duration,
) TimeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.noleading", d.Milliseconds())
...
// Throttle the event listener in milliseconds with trailing edge.
func TimeOnSignalPatchModThrottleMsTrailing(
	d time.Duration,
) TimeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.trailing", d.Milliseconds())
...
// Throttles the event listener in seconds.
func TimeOnSignalPatchModThrottleSec(
	d time.Duration,
) TimeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds", int(d.Seconds()))
...
// Throttle the event listener in seconds without leading edge.
func TimeOnSignalPatchModThrottleSecNoLeading(
	d time.Duration,
) TimeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.noleading", int(d.Seconds()))
...
// Throttle the event listener in seconds with trailing edge.
func TimeOnSignalPatchModThrottleSecTrailing(
	d time.Duration,
) TimeOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.trailing", int(d.Seconds()))
...
func (e *TIMEElement) DATASTAR_ON_SIGNAL_PATCH(expression string, modifiers ...TimeOnSignalPatchMod) *TIMEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m TimeOnSignalPatchMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on-signal-patch
func (e *TIMEElement) IfDATASTAR_ON_SIGNAL_PATCH(condition bool, expression string, modifiers ...TimeOnSignalPatchMod) *TIMEElement {
	if condition {
...
func (e *TIMEElement) DATASTAR_ON_SIGNAL_PATCHRemove() *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *TIMEElement) DATASTAR_ON_SIGNAL_PATCH_FILTER(expression string) *TIMEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-on-signal-patch-filter
func (e *TIMEElement) IfDATASTAR_ON_SIGNAL_PATCH_FILTER(condition bool, expression string) *TIMEElement {
	if condition {
...
func (e *TIMEElement) DATASTAR_ON_SIGNAL_PATCH_FILTERRemove() *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *TIMEElement) DATASTAR_PRESERVE_ATTR(expression string) *TIMEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-preserve-attr
func (e *TIMEElement) IfDATASTAR_PRESERVE_ATTR(condition bool, expression string) *TIMEElement {
	if condition {
...
func (e *TIMEElement) DATASTAR_PRESERVE_ATTRRemove() *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
type TimeRefMod customDataKeyModifier
...
func (e *TIMEElement) DATASTAR_REF(expression string, modifiers ...TimeRefMod) *TIMEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m TimeRefMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-ref
func (e *TIMEElement) IfDATASTAR_REF(condition bool, expression string, modifiers ...TimeRefMod) *TIMEElement {
	if condition {
...
func (e *TIMEElement) DATASTAR_REFRemove() *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *TIMEElement) DATASTAR_SHOW(expression string) *TIMEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-show
func (e *TIMEElement) IfDATASTAR_SHOW(condition bool, expression string) *TIMEElement {
	if condition {
...
func (e *TIMEElement) DATASTAR_SHOWRemove() *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
type TimeSignalsMod customDataKeyModifier
...
func TimeSignalsModIfMissing() TimeSignalsMod {
	return func() string {
		return "ifmissing"
	}
}
...
func (e *TIMEElement) DATASTAR_SIGNALS(key string, expression string, modifiers ...TimeSignalsMod) *TIMEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m TimeSignalsMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-signals
func (e *TIMEElement) IfDATASTAR_SIGNALS(condition bool, key string, expression string, modifiers ...TimeSignalsMod) *TIMEElement {
	if condition {
...
func (e *TIMEElement) DATASTAR_SIGNALSRemove(key string) *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
type TimeStyleMod customDataKeyModifier
...
func (e *TIMEElement) DATASTAR_STYLE(key string, expression string, modifiers ...TimeStyleMod) *TIMEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m TimeStyleMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-style
func (e *TIMEElement) IfDATASTAR_STYLE(condition bool, key string, expression string, modifiers ...TimeStyleMod) *TIMEElement {
	if condition {
...
func (e *TIMEElement) DATASTAR_STYLERemove(key string) *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *TIMEElement) DATASTAR_TEXT(expression string) *TIMEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-text
func (e *TIMEElement) IfDATASTAR_TEXT(condition bool, expression string) *TIMEElement {
	if condition {
...
func (e *TIMEElement) DATASTAR_TEXTRemove() *TIMEElement {
	if e.StringAttributes == nil {
		return e
	}
