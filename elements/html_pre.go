...
// package html pre is generated from configuration file.
// Description:
package elements
...
// Create a new PREElement element.
// This will create a new element with the tag
// "pre" during rendering.
...
func (e *PREElement) Attr(name string, value string) *PREElement {
...
func (e *PREElement) Attrs(attrs ...string) *PREElement {
	if len(attrs)%2 != 0 {
...
func (e *PREElement) AttrsMap(attrs map[string]string) *PREElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	for k, v := range attrs {
...
func (e *PREElement) CustomData(key, value string) *PREElement {
...
func (e *PREElement) IfCustomData(condition bool, key, value string) *PREElement {
	if condition {
...
func (e *PREElement) IfCustomDataF(condition bool, key, format string, args ...any) *PREElement {
	if condition {
...
const (
	...
	PreAutocapitalize_off PreAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	PreAutocapitalize_none PreAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	PreAutocapitalize_sentences PreAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	PreAutocapitalize_on PreAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	PreAutocapitalize_words PreAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	PreAutocapitalize_characters PreAutocapitalizeChoice = "characters"
)
...
func (e *PREElement) AUTOCAPITALIZERemove(c PreAutocapitalizeChoice) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
// sighted user on a small device will equally miss the context created by the
// preceding content.
func (e *PREElement) AUTOFOCUSRemove(b bool) *PREElement {
	if e.BoolAttributes == nil {
		return e
	}
...
const (
	...
	PreContenteditable_empty PreContenteditableChoice = ""
	// The element is editable.
	PreContenteditable_true PreContenteditableChoice = "true"
	// The element is not editable.
	PreContenteditable_false PreContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	PreContenteditable_plaintext_only PreContenteditableChoice = "plaintext-only"
)
...
func (e *PREElement) CONTENTEDITABLERemove(c PreContenteditableChoice) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *PREElement) DIRRemove(c PreDirChoice) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
const (
	...
	PreDraggable_true PreDraggableChoice = "true"
	// The element is not draggable.
	PreDraggable_false PreDraggableChoice = "false"
	...
	PreDraggable_empty PreDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged
	// For other elements, the event ondragstart must be set for drag and drop to work
	PreDraggable_auto PreDraggableChoice = "auto"
)
...
func (e *PREElement) DRAGGABLERemove(c PreDraggableChoice) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
const (
	...
	PreHidden_empty PreHiddenChoice = ""
	// set the element to the hidden state
	// Additionally, invalid values set the element to the hidden state.
	PreHidden_hidden PreHiddenChoice = "hidden"
	...
	//
	PreHidden_until_found PreHiddenChoice = "until-found"
)
...
func (e *PREElement) HIDDENRemove(c PreHiddenChoice) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *PREElement) IDRemove(s string) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
// Its purpose is to identify the element when linking (using a fragment
// identifier), scripting, or styling (with CSS).
func (e *PREElement) IDRemoveF(format string, args ...any) *PREElement {
...
// Hides the element and its content from assistive technologies by excluding them
// from the accessibility tree.
func (e *PREElement) INERTRemove(b bool) *PREElement {
	if e.BoolAttributes == nil {
		return e
	}
...
const (
	...
	PreInputmode_none PreInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	PreInputmode_empty PreInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	PreInputmode_text PreInputmodeChoice = "text"
	...
	PreInputmode_decimal PreInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9
	// Devices may or may not show a minus key.
	PreInputmode_numeric PreInputmodeChoice = "numeric"
	...
	// type="tel"> instead.
	PreInputmode_tel PreInputmodeChoice = "tel"
	...
	// instead.
	PreInputmode_search PreInputmodeChoice = "search"
	...
	// instead.
	PreInputmode_email PreInputmodeChoice = "email"
	...
	PreInputmode_url PreInputmodeChoice = "url"
)
...
func (e *PREElement) INPUTMODERemove(c PreInputmodeChoice) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *PREElement) ISRemove(s string) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
// successfully defined in the current document, and extends the element type it
// is being applied to.
func (e *PREElement) ISRemoveF(format string, args ...any) *PREElement {
...
func (e *PREElement) ITEMIDRemove(s string) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
// The vocabulary defines whether several items with the same global identifier
// can coexist and, if so, how items with the same identifier are handled.
func (e *PREElement) ITEMIDRemoveF(format string, args ...any) *PREElement {
...
func (e *PREElement) ITEMPROPRemove(s string) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *PREElement) ITEMPROPRemoveF(format string, args ...any) *PREElement {
...
func (e *PREElement) ITEMREFRemove(s string) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
// with additional properties The itemref attribute can only be specified on
// elements that have an itemscope attribute specified.
func (e *PREElement) ITEMREFRemoveF(format string, args ...any) *PREElement {
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *PREElement) ITEMSCOPERemove(b bool) *PREElement {
	if e.BoolAttributes == nil {
		return e
	}
...
func (e *PREElement) ITEMTYPERemove(s string) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *PREElement) ITEMTYPERemoveF(format string, args ...any) *PREElement {
...
func (e *PREElement) LANGRemove(s string) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
// Identifying Languages (BCP47) IETF document
// xml:lang has priority over it.
func (e *PREElement) LANGRemoveF(format string, args ...any) *PREElement {
...
func (e *PREElement) NONCERemove(s string) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
// It is a cryptographic nonce (number used once) that is used by Content Security
// Policy to determine whether or not a given inline script is allowed to execute.
func (e *PREElement) NONCERemoveF(format string, args ...any) *PREElement {
...
const (
	...
	// on-screen at a time.
	PrePopover_auto PrePopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting outside
	// the popover area, and generally only allow one popover to be displayed
	// on-screen at a time.
	PrePopover_empty PrePopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases such
	// as nested popovers in menus.
	PrePopover_manual PrePopoverChoice = "manual"
)
...
func (e *PREElement) POPOVERRemove(c PrePopoverChoice) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *PREElement) ROLERemove(s string) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
// It is a simple string value that can be used to describe the role of an
// element.
func (e *PREElement) ROLERemoveF(format string, args ...any) *PREElement {
...
func (e *PREElement) SLOTRemove(s string) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
// the <slot> element whose name attribute's value matches that slot attribute's
// value.
func (e *PREElement) SLOTRemoveF(format string, args ...any) *PREElement {
...
const (
	...
	PreSpellcheck_empty PreSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	PreSpellcheck_true PreSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	PreSpellcheck_false PreSpellcheckChoice = "false"
)
...
func (e *PREElement) SPELLCHECKRemove(c PreSpellcheckChoice) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
// font, size, and more
// Styles are written in CSS.
func (e *PREElement) IfSTYLE(condition bool, k string, v string) *PREElement {
	if condition {
		e.STYLE(k, v)
	}
	return e
...
// font, size, and more
// Styles are written in CSS.
func (e *PREElement) IfSTYLEF(condition bool, k string, format string, args ...any) *PREElement {
	if condition {
...
// font, size, and more
// Styles are written in CSS.
func (e *PREElement) IfSTYLEPairs(condition bool, pairs ...string) *PREElement {
	if condition {
		e.STYLEPairs(pairs...)
	}
	return e
...
func (e *PREElement) TABINDEXRemove(i int) *PREElement {
	if e.IntAttributes == nil {
		return e
	}
...
func (e *PREElement) TITLERemove(s string) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
// <input> element, this is not good practice
// Use a <label> instead.
func (e *PREElement) TITLERemoveF(format string, args ...any) *PREElement {
...
const (
	...
	PreTranslate_empty PreTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	PreTranslate_yes PreTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	PreTranslate_no PreTranslateChoice = "no"
)
...
func (e *PREElement) TRANSLATERemove(c PreTranslateChoice) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *PREElement) DATASTAR_ATTR(key string, expression string) *PREElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-attr
func (e *PREElement) IfDATASTAR_ATTR(condition bool, key string, expression string) *PREElement {
	if condition {
...
func (e *PREElement) DATASTAR_ATTRRemove(key string) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *PREElement) DATASTAR_BIND(key string, expression string) *PREElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-bind
func (e *PREElement) IfDATASTAR_BIND(condition bool, key string, expression string) *PREElement {
	if condition {
...
func (e *PREElement) DATASTAR_BINDRemove(key string) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
type PreClassMod customDataKeyModifier
...
func (e *PREElement) DATASTAR_CLASS(key string, expression string, modifiers ...PreClassMod) *PREElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m PreClassMod, i int) customDataKeyModifier {
...
// Adds or removes a class to or from an element based on an expression.
func (e *PREElement) IfDATASTAR_CLASS(condition bool, key string, expression string, modifiers ...PreClassMod) *PREElement {
	if condition {
...
func (e *PREElement) DATASTAR_CLASSRemove(key string) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
type PreComputedMod customDataKeyModifier
...
func (e *PREElement) DATASTAR_COMPUTED(key string, expression string, modifiers ...PreComputedMod) *PREElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m PreComputedMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-computed
func (e *PREElement) IfDATASTAR_COMPUTED(condition bool, key string, expression string, modifiers ...PreComputedMod) *PREElement {
	if condition {
...
func (e *PREElement) DATASTAR_COMPUTEDRemove(key string) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *PREElement) DATASTAR_EFFECT(expression string) *PREElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-effect
func (e *PREElement) IfDATASTAR_EFFECT(condition bool, expression string) *PREElement {
	if condition {
...
func (e *PREElement) DATASTAR_EFFECTRemove() *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
type PreIgnoreMod customDataKeyModifier

// Only ignore the element itself, not its descendants.
func PreIgnoreModSelf() PreIgnoreMod {
	return func() string {
		return "self"
	}
}
...
func (e *PREElement) DATASTAR_IGNORESet(b bool, modifiers ...PreIgnoreMod) *PREElement {
	key := customDataKey("data-ignore")
	customMods := lo.Map(modifiers, func(m PreIgnoreMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	if e.BoolAttributes == nil {
...
//
// See: https://data-star.dev/reference/attributes#data-ignore
func (e *PREElement) DATASTAR_IGNORE(modifiers ...PreIgnoreMod) *PREElement {
...
func (e *PREElement) DATASTAR_IGNORE_MORPHSet(b bool) *PREElement {
...
//
// See: https://data-star.dev/reference/attributes#data-ignore-morph
func (e *PREElement) DATASTAR_IGNORE_MORPH() *PREElement {
	return e.DATASTAR_IGNORE_MORPHSet(true)
}

type PreIndicatorMod customDataKeyModifier
...
func (e *PREElement) DATASTAR_INDICATOR(expression string, modifiers ...PreIndicatorMod) *PREElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m PreIndicatorMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *PREElement) IfDATASTAR_INDICATOR(condition bool, expression string, modifiers ...PreIndicatorMod) *PREElement {
	if condition {
...
func (e *PREElement) DATASTAR_INDICATORRemove() *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
type PreInitMod customDataKeyModifier

// Delay the event listener in milliseconds.
func PreInitModDelayMs(
	d time.Duration,
) PreInitMod {
	return func() string {
...
func PreInitModViewTransition() PreInitMod {
	return func() string {
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *PREElement) DATASTAR_INIT(expression string, modifiers ...PreInitMod) *PREElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m PreInitMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *PREElement) IfDATASTAR_INIT(condition bool, expression string, modifiers ...PreInitMod) *PREElement {
	if condition {
...
func (e *PREElement) DATASTAR_INITRemove() *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *PREElement) DATASTAR_JSON_SIGNALS(expression string, modifiers ...PreJsonSignalsMod) *PREElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m PreJsonSignalsMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-json-signals
func (e *PREElement) IfDATASTAR_JSON_SIGNALS(condition bool, expression string, modifiers ...PreJsonSignalsMod) *PREElement {
	if condition {
...
func (e *PREElement) DATASTAR_JSON_SIGNALSRemove() *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
type PreOnMod customDataKeyModifier

// Only run the expression once
// Only works with built-in events.
func PreOnModOnce() PreOnMod {
	return func() string {
		return "once"
	}
}
...
func PreOnModDebounceMsLeading(
	d time.Duration,
) PreOnMod {
	return func() string {
...
func PreOnModDebounceMsNoTrailing(
	d time.Duration,
) PreOnMod {
	return func() string {
...
func PreOnModDebounceSecLeading(
	d time.Duration,
) PreOnMod {
	return func() string {
...
func PreOnModDebounceSecNoTrailing(
	d time.Duration,
) PreOnMod {
	return func() string {
...
func PreOnModThrottleMsNoLeading(
	d time.Duration,
) PreOnMod {
	return func() string {
...
func PreOnModThrottleMsTrailing(
	d time.Duration,
) PreOnMod {
	return func() string {
...
func PreOnModThrottleSecNoLeading(
	d time.Duration,
) PreOnMod {
	return func() string {
...
func PreOnModThrottleSecTrailing(
	d time.Duration,
) PreOnMod {
	return func() string {
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func PreOnModViewTransition() PreOnMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *PREElement) DATASTAR_ON(key string, expression string, modifiers ...PreOnMod) *PREElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m PreOnMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on
func (e *PREElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...PreOnMod) *PREElement {
	if condition {
...
func (e *PREElement) DATASTAR_ONRemove(key string) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
type PreOnIntersectMod customDataKeyModifier

// Only run the expression once
// Only works with built-in events.
func PreOnIntersectModOnce() PreOnIntersectMod {
	return func() string {
		return "once"
	}
}
...
func PreOnIntersectModHalf() PreOnIntersectMod {
	return func() string {
		return "half"
	}
}
...
func PreOnIntersectModFull() PreOnIntersectMod {
	return func() string {
		return "full"
	}
}
...
// Delay the event listener in seconds.
func PreOnIntersectModDelaySec(
	d time.Duration,
) PreOnIntersectMod {
	return func() string {
		return fmt.Sprintf("delay.%ds", int(d.Seconds()))
...
// Debounces the event handler
func PreOnIntersectModDebounceMs(
	d time.Duration,
) PreOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms", d.Milliseconds())
...
// Debounce the event listener in milliseconds with leading edge.
func PreOnIntersectModDebounceMsLeading(
	d time.Duration,
) PreOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.leading", d.Milliseconds())
...
// Debounce the event listener in milliseconds without trailing edge.
func PreOnIntersectModDebounceMsNoTrailing(
	d time.Duration,
) PreOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.notrailing", d.Milliseconds())
...
// Debounces the event handler
func PreOnIntersectModDebounceSec(
	d time.Duration,
) PreOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds", int(d.Seconds()))
...
// Debounce the event listener in seconds with leading edge.
func PreOnIntersectModDebounceSecLeading(
	d time.Duration,
) PreOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.leading", int(d.Seconds()))
...
// Debounce the event listener in seconds without trailing edge.
func PreOnIntersectModDebounceSecNoTrailing(
	d time.Duration,
) PreOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.notrailing", int(d.Seconds()))
...
// Throttles the event handler
func PreOnIntersectModThrottleMs(
	d time.Duration,
) PreOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms", d.Milliseconds())
...
// Throttle the event listener in milliseconds without leading edge.
func PreOnIntersectModThrottleMsNoLeading(
	d time.Duration,
) PreOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.noleading", d.Milliseconds())
...
// Throttle the event listener in milliseconds with trailing edge.
func PreOnIntersectModThrottleMsTrailing(
	d time.Duration,
) PreOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.trailing", d.Milliseconds())
...
// Throttles the event listener in seconds.
func PreOnIntersectModThrottleSec(
	d time.Duration,
) PreOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds", int(d.Seconds()))
...
// Throttle the event listener in seconds without leading edge.
func PreOnIntersectModThrottleSecNoLeading(
	d time.Duration,
) PreOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.noleading", int(d.Seconds()))
...
// Throttle the event listener in seconds with trailing edge.
func PreOnIntersectModThrottleSecTrailing(
	d time.Duration,
) PreOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.trailing", int(d.Seconds()))
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func PreOnIntersectModViewTransition() PreOnIntersectMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *PREElement) DATASTAR_ON_INTERSECT(expression string, modifiers ...PreOnIntersectMod) *PREElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m PreOnIntersectMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
// Runs an expression when the element intersects with the viewport.
func (e *PREElement) IfDATASTAR_ON_INTERSECT(condition bool, expression string, modifiers ...PreOnIntersectMod) *PREElement {
	if condition {
...
func (e *PREElement) DATASTAR_ON_INTERSECTRemove() *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
type PreOnIntervalMod customDataKeyModifier

// Sets the interval duration in milliseconds.
func PreOnIntervalModDurationMs(
	d time.Duration,
) PreOnIntervalMod {
	return func() string {
...
func PreOnIntervalModDurationMsLeading(
	d time.Duration,
) PreOnIntervalMod {
	return func() string {
...
func PreOnIntervalModDurationSec(
	d time.Duration,
) PreOnIntervalMod {
	return func() string {
...
// Sets the interval duration in seconds
// Execute the first interval immediately.
func PreOnIntervalModDurationSecLeading(
	d time.Duration,
) PreOnIntervalMod {
	return func() string {
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func PreOnIntervalModViewTransition() PreOnIntervalMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *PREElement) DATASTAR_ON_INTERVAL(expression string, modifiers ...PreOnIntervalMod) *PREElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m PreOnIntervalMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on-interval
func (e *PREElement) IfDATASTAR_ON_INTERVAL(condition bool, expression string, modifiers ...PreOnIntervalMod) *PREElement {
	if condition {
...
func (e *PREElement) DATASTAR_ON_INTERVALRemove() *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
type PreOnSignalPatchMod customDataKeyModifier

// Delay the event listener in milliseconds.
func PreOnSignalPatchModDelayMs(
	d time.Duration,
) PreOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("delay.%dms", d.Milliseconds())
...
// Delay the event listener in seconds.
func PreOnSignalPatchModDelaySec(
	d time.Duration,
) PreOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("delay.%ds", int(d.Seconds()))
...
// Debounces the event handler
func PreOnSignalPatchModDebounceMs(
	d time.Duration,
) PreOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms", d.Milliseconds())
...
// Debounce the event listener in milliseconds with leading edge.
func PreOnSignalPatchModDebounceMsLeading(
	d time.Duration,
) PreOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.leading", d.Milliseconds())
...
// Debounce the event listener in milliseconds without trailing edge.
func PreOnSignalPatchModDebounceMsNoTrailing(
	d time.Duration,
) PreOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.notrailing", d.Milliseconds())
...
// Debounces the event handler
func PreOnSignalPatchModDebounceSec(
	d time.Duration,
) PreOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds", int(d.Seconds()))
...
// Debounce the event listener in seconds with leading edge.
func PreOnSignalPatchModDebounceSecLeading(
	d time.Duration,
) PreOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.leading", int(d.Seconds()))
...
// Debounce the event listener in seconds without trailing edge.
func PreOnSignalPatchModDebounceSecNoTrailing(
	d time.Duration,
) PreOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.notrailing", int(d.Seconds()))
...
// Throttles the event handler
func PreOnSignalPatchModThrottleMs(
	d time.Duration,
) PreOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms", d.Milliseconds())
...
// Throttle the event listener in milliseconds without leading edge.
func PreOnSignalPatchModThrottleMsNoLeading(
	d time.Duration,
) PreOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.noleading", d.Milliseconds())
...
// Throttle the event listener in milliseconds with trailing edge.
func PreOnSignalPatchModThrottleMsTrailing(
	d time.Duration,
) PreOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.trailing", d.Milliseconds())
...
// Throttles the event listener in seconds.
func PreOnSignalPatchModThrottleSec(
	d time.Duration,
) PreOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds", int(d.Seconds()))
...
// Throttle the event listener in seconds without leading edge.
func PreOnSignalPatchModThrottleSecNoLeading(
	d time.Duration,
) PreOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.noleading", int(d.Seconds()))
...
// Throttle the event listener in seconds with trailing edge.
func PreOnSignalPatchModThrottleSecTrailing(
	d time.Duration,
) PreOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.trailing", int(d.Seconds()))
...
func (e *PREElement) DATASTAR_ON_SIGNAL_PATCH(expression string, modifiers ...PreOnSignalPatchMod) *PREElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m PreOnSignalPatchMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on-signal-patch
func (e *PREElement) IfDATASTAR_ON_SIGNAL_PATCH(condition bool, expression string, modifiers ...PreOnSignalPatchMod) *PREElement {
	if condition {
...
func (e *PREElement) DATASTAR_ON_SIGNAL_PATCHRemove() *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *PREElement) DATASTAR_ON_SIGNAL_PATCH_FILTER(expression string) *PREElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-on-signal-patch-filter
func (e *PREElement) IfDATASTAR_ON_SIGNAL_PATCH_FILTER(condition bool, expression string) *PREElement {
	if condition {
...
func (e *PREElement) DATASTAR_ON_SIGNAL_PATCH_FILTERRemove() *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *PREElement) DATASTAR_PRESERVE_ATTR(expression string) *PREElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-preserve-attr
func (e *PREElement) IfDATASTAR_PRESERVE_ATTR(condition bool, expression string) *PREElement {
	if condition {
...
func (e *PREElement) DATASTAR_PRESERVE_ATTRRemove() *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
type PreRefMod customDataKeyModifier
...
func (e *PREElement) DATASTAR_REF(expression string, modifiers ...PreRefMod) *PREElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m PreRefMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-ref
func (e *PREElement) IfDATASTAR_REF(condition bool, expression string, modifiers ...PreRefMod) *PREElement {
	if condition {
...
func (e *PREElement) DATASTAR_REFRemove() *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *PREElement) DATASTAR_SHOW(expression string) *PREElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-show
func (e *PREElement) IfDATASTAR_SHOW(condition bool, expression string) *PREElement {
	if condition {
...
func (e *PREElement) DATASTAR_SHOWRemove() *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
type PreSignalsMod customDataKeyModifier
...
func PreSignalsModIfMissing() PreSignalsMod {
	return func() string {
		return "ifmissing"
	}
}
...
func (e *PREElement) DATASTAR_SIGNALS(key string, expression string, modifiers ...PreSignalsMod) *PREElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m PreSignalsMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-signals
func (e *PREElement) IfDATASTAR_SIGNALS(condition bool, key string, expression string, modifiers ...PreSignalsMod) *PREElement {
	if condition {
...
func (e *PREElement) DATASTAR_SIGNALSRemove(key string) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
type PreStyleMod customDataKeyModifier
...
func (e *PREElement) DATASTAR_STYLE(key string, expression string, modifiers ...PreStyleMod) *PREElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m PreStyleMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-style
func (e *PREElement) IfDATASTAR_STYLE(condition bool, key string, expression string, modifiers ...PreStyleMod) *PREElement {
	if condition {
...
func (e *PREElement) DATASTAR_STYLERemove(key string) *PREElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *PREElement) DATASTAR_TEXT(expression string) *PREElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-text
func (e *PREElement) IfDATASTAR_TEXT(condition bool, expression string) *PREElement {
	if condition {
...
func (e *PREElement) DATASTAR_TEXTRemove() *PREElement {
	if e.StringAttributes == nil {
		return e
	}
