...
// package html ol is generated from configuration file.
// Description:
package elements
...
// Create a new OLElement element.
...
func (e *OLElement) Attr(name string, value string) *OLElement {
...
func (e *OLElement) Attrs(attrs ...string) *OLElement {
	if len(attrs)%2 != 0 {
...
func (e *OLElement) AttrsMap(attrs map[string]string) *OLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	for k, v := range attrs {
...
const (
	// Numbers (default)
	OlType_1 OlTypeChoice = "1"
	// Lowercase letters
	OlType_a OlTypeChoice = "a"
	// Uppercase letters
	OlType_A OlTypeChoice = "A"
...
const (
	...
	OlAutocapitalize_off OlAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	OlAutocapitalize_none OlAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	OlAutocapitalize_sentences OlAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	OlAutocapitalize_on OlAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	OlAutocapitalize_words OlAutocapitalizeChoice = "words"
...
const (
	...
	OlContenteditable_empty OlContenteditableChoice = ""
	// The element is editable.
	OlContenteditable_true OlContenteditableChoice = "true"
	// The element is not editable.
	OlContenteditable_false OlContenteditableChoice = "false"
...
const (
	...
	OlDraggable_true OlDraggableChoice = "true"
	// The element is not draggable.
	OlDraggable_false OlDraggableChoice = "false"
	...
	OlDraggable_empty OlDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged
	// For other elements, the event ondragstart must be set for drag and drop to work
...
const (
	...
	OlHidden_empty OlHiddenChoice = ""
	// set the element to the hidden state
	// Additionally, invalid values set the element to the hidden state.
	OlHidden_hidden OlHiddenChoice = "hidden"
...
// Its purpose is to identify the element when linking (using a fragment
// identifier), scripting, or styling (with CSS).
func (e *OLElement) IDRemoveF(format string, args ...any) *OLElement {
...
const (
	...
	OlInputmode_none OlInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	OlInputmode_empty OlInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	OlInputmode_text OlInputmodeChoice = "text"
	...
	OlInputmode_decimal OlInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9
	// Devices may or may not show a minus key.
	OlInputmode_numeric OlInputmodeChoice = "numeric"
	...
	// type="tel"> instead.
	OlInputmode_tel OlInputmodeChoice = "tel"
	...
	// instead.
	OlInputmode_search OlInputmodeChoice = "search"
	...
	// instead.
	OlInputmode_email OlInputmodeChoice = "email"
...
// successfully defined in the current document, and extends the element type it
// is being applied to.
func (e *OLElement) ISRemoveF(format string, args ...any) *OLElement {
...
// The vocabulary defines whether several items with the same global identifier
// can coexist and, if so, how items with the same identifier are handled.
func (e *OLElement) ITEMIDRemoveF(format string, args ...any) *OLElement {
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *OLElement) ITEMPROPRemoveF(format string, args ...any) *OLElement {
...
// with additional properties The itemref attribute can only be specified on
// elements that have an itemscope attribute specified.
func (e *OLElement) ITEMREFRemoveF(format string, args ...any) *OLElement {
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *OLElement) ITEMTYPERemoveF(format string, args ...any) *OLElement {
...
// Identifying Languages (BCP47) IETF document
// xml:lang has priority over it.
func (e *OLElement) LANGRemoveF(format string, args ...any) *OLElement {
...
// It is a cryptographic nonce (number used once) that is used by Content Security
// Policy to determine whether or not a given inline script is allowed to execute.
func (e *OLElement) NONCERemoveF(format string, args ...any) *OLElement {
...
const (
	...
	// on-screen at a time.
	OlPopover_auto OlPopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting outside
	// the popover area, and generally only allow one popover to be displayed
	// on-screen at a time.
	OlPopover_empty OlPopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases such
	// as nested popovers in menus.
	OlPopover_manual OlPopoverChoice = "manual"
)
...
func (e *OLElement) POPOVERRemove(c OlPopoverChoice) *OLElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *OLElement) ROLERemove(s string) *OLElement {
	if e.StringAttributes == nil {
		return e
	}
...
// It is a simple string value that can be used to describe the role of an
// element.
func (e *OLElement) ROLERemoveF(format string, args ...any) *OLElement {
...
// the <slot> element whose name attribute's value matches that slot attribute's
// value.
func (e *OLElement) SLOTRemoveF(format string, args ...any) *OLElement {
...
const (
	...
	OlSpellcheck_empty OlSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	OlSpellcheck_true OlSpellcheckChoice = "true"
...
func (e *OLElement) STYLEF(k string, format string, args ...any) *OLElement {
...
// <input> element, this is not good practice
// Use a <label> instead.
func (e *OLElement) TITLERemoveF(format string, args ...any) *OLElement {
...
const (
	...
	OlTranslate_empty OlTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	OlTranslate_yes OlTranslateChoice = "yes"
...
func (e *OLElement) DATASTAR_ATTR(key string, expression string) *OLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-attr
func (e *OLElement) IfDATASTAR_ATTR(condition bool, key string, expression string) *OLElement {
	if condition {
...
func (e *OLElement) DATASTAR_ATTRRemove(key string) *OLElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *OLElement) DATASTAR_BIND(key string, expression string) *OLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-bind
func (e *OLElement) IfDATASTAR_BIND(condition bool, key string, expression string) *OLElement {
	if condition {
...
func (e *OLElement) DATASTAR_BINDRemove(key string) *OLElement {
	if e.StringAttributes == nil {
		return e
	}
...
type OlClassMod customDataKeyModifier
...
func (e *OLElement) DATASTAR_CLASS(key string, expression string, modifiers ...OlClassMod) *OLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m OlClassMod, i int) customDataKeyModifier {
...
// Adds or removes a class to or from an element based on an expression.
func (e *OLElement) IfDATASTAR_CLASS(condition bool, key string, expression string, modifiers ...OlClassMod) *OLElement {
	if condition {
...
func (e *OLElement) DATASTAR_CLASSRemove(key string) *OLElement {
	if e.StringAttributes == nil {
		return e
	}
...
type OlComputedMod customDataKeyModifier
...
func (e *OLElement) DATASTAR_COMPUTED(key string, expression string, modifiers ...OlComputedMod) *OLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m OlComputedMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-computed
func (e *OLElement) IfDATASTAR_COMPUTED(condition bool, key string, expression string, modifiers ...OlComputedMod) *OLElement {
	if condition {
...
func (e *OLElement) DATASTAR_COMPUTEDRemove(key string) *OLElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *OLElement) DATASTAR_EFFECT(expression string) *OLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-effect
func (e *OLElement) IfDATASTAR_EFFECT(condition bool, expression string) *OLElement {
	if condition {
...
func (e *OLElement) DATASTAR_EFFECTRemove() *OLElement {
	if e.StringAttributes == nil {
		return e
	}
...
type OlIgnoreMod customDataKeyModifier

// Only ignore the element itself, not its descendants.
func OlIgnoreModSelf() OlIgnoreMod {
	return func() string {
		return "self"
	}
}
...
func (e *OLElement) DATASTAR_IGNORESet(b bool, modifiers ...OlIgnoreMod) *OLElement {
	key := customDataKey("data-ignore")
	customMods := lo.Map(modifiers, func(m OlIgnoreMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	if e.BoolAttributes == nil {
...
//
// See: https://data-star.dev/reference/attributes#data-ignore
func (e *OLElement) DATASTAR_IGNORE(modifiers ...OlIgnoreMod) *OLElement {
...
func (e *OLElement) DATASTAR_IGNORE_MORPHSet(b bool) *OLElement {
...
//
// See: https://data-star.dev/reference/attributes#data-ignore-morph
func (e *OLElement) DATASTAR_IGNORE_MORPH() *OLElement {
	return e.DATASTAR_IGNORE_MORPHSet(true)
}

type OlIndicatorMod customDataKeyModifier
...
func (e *OLElement) DATASTAR_INDICATOR(expression string, modifiers ...OlIndicatorMod) *OLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m OlIndicatorMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *OLElement) IfDATASTAR_INDICATOR(condition bool, expression string, modifiers ...OlIndicatorMod) *OLElement {
	if condition {
...
func (e *OLElement) DATASTAR_INDICATORRemove() *OLElement {
	if e.StringAttributes == nil {
		return e
	}
...
type OlInitMod customDataKeyModifier

// Delay the event listener in milliseconds.
func OlInitModDelayMs(
	d time.Duration,
) OlInitMod {
	return func() string {
...
func OlInitModViewTransition() OlInitMod {
	return func() string {
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *OLElement) DATASTAR_INIT(expression string, modifiers ...OlInitMod) *OLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m OlInitMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *OLElement) IfDATASTAR_INIT(condition bool, expression string, modifiers ...OlInitMod) *OLElement {
	if condition {
...
func (e *OLElement) DATASTAR_INITRemove() *OLElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *OLElement) DATASTAR_JSON_SIGNALS(expression string, modifiers ...OlJsonSignalsMod) *OLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m OlJsonSignalsMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-json-signals
func (e *OLElement) IfDATASTAR_JSON_SIGNALS(condition bool, expression string, modifiers ...OlJsonSignalsMod) *OLElement {
	if condition {
...
func (e *OLElement) DATASTAR_JSON_SIGNALSRemove() *OLElement {
	if e.StringAttributes == nil {
		return e
	}
...
func OlOnModDebounceMsNoTrailing(
	d time.Duration,
) OlOnMod {
	return func() string {
...
func OlOnModDebounceSecLeading(
	d time.Duration,
) OlOnMod {
	return func() string {
...
func OlOnModDebounceSecNoTrailing(
	d time.Duration,
) OlOnMod {
	return func() string {
...
func OlOnModThrottleMsNoLeading(
	d time.Duration,
) OlOnMod {
	return func() string {
...
func OlOnModThrottleMsTrailing(
	d time.Duration,
) OlOnMod {
	return func() string {
...
func OlOnModThrottleSecNoLeading(
	d time.Duration,
) OlOnMod {
	return func() string {
...
func OlOnModThrottleSecTrailing(
	d time.Duration,
) OlOnMod {
	return func() string {
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func OlOnModViewTransition() OlOnMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *OLElement) DATASTAR_ON(key string, expression string, modifiers ...OlOnMod) *OLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m OlOnMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on
func (e *OLElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...OlOnMod) *OLElement {
	if condition {
...
func (e *OLElement) DATASTAR_ONRemove(key string) *OLElement {
	if e.StringAttributes == nil {
		return e
	}
...
type OlOnIntersectMod customDataKeyModifier

// Only run the expression once
// Only works with built-in events.
func OlOnIntersectModOnce() OlOnIntersectMod {
	return func() string {
		return "once"
	}
}
...
func OlOnIntersectModHalf() OlOnIntersectMod {
	return func() string {
		return "half"
	}
}
...
func OlOnIntersectModFull() OlOnIntersectMod {
	return func() string {
		return "full"
	}
}
...
// Debounces the event handler
func OlOnIntersectModDebounceMs(
	d time.Duration,
) OlOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms", d.Milliseconds())
...
// Debounce the event listener in milliseconds with leading edge.
func OlOnIntersectModDebounceMsLeading(
	d time.Duration,
) OlOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.leading", d.Milliseconds())
...
// Debounce the event listener in milliseconds without trailing edge.
func OlOnIntersectModDebounceMsNoTrailing(
	d time.Duration,
) OlOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.notrailing", d.Milliseconds())
...
// Debounces the event handler
func OlOnIntersectModDebounceSec(
	d time.Duration,
) OlOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds", int(d.Seconds()))
...
// Debounce the event listener in seconds with leading edge.
func OlOnIntersectModDebounceSecLeading(
	d time.Duration,
) OlOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.leading", int(d.Seconds()))
...
// Debounce the event listener in seconds without trailing edge.
func OlOnIntersectModDebounceSecNoTrailing(
	d time.Duration,
) OlOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.notrailing", int(d.Seconds()))
...
// Throttles the event handler
func OlOnIntersectModThrottleMs(
	d time.Duration,
) OlOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms", d.Milliseconds())
...
// Throttle the event listener in milliseconds without leading edge.
func OlOnIntersectModThrottleMsNoLeading(
	d time.Duration,
) OlOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.noleading", d.Milliseconds())
...
// Throttle the event listener in milliseconds with trailing edge.
func OlOnIntersectModThrottleMsTrailing(
	d time.Duration,
) OlOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.trailing", d.Milliseconds())
...
// Throttles the event listener in seconds.
func OlOnIntersectModThrottleSec(
	d time.Duration,
) OlOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds", int(d.Seconds()))
...
// Throttle the event listener in seconds without leading edge.
func OlOnIntersectModThrottleSecNoLeading(
	d time.Duration,
) OlOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.noleading", int(d.Seconds()))
...
// Throttle the event listener in seconds with trailing edge.
func OlOnIntersectModThrottleSecTrailing(
	d time.Duration,
) OlOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.trailing", int(d.Seconds()))
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func OlOnIntersectModViewTransition() OlOnIntersectMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *OLElement) DATASTAR_ON_INTERSECT(expression string, modifiers ...OlOnIntersectMod) *OLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m OlOnIntersectMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
// Runs an expression when the element intersects with the viewport.
func (e *OLElement) IfDATASTAR_ON_INTERSECT(condition bool, expression string, modifiers ...OlOnIntersectMod) *OLElement {
	if condition {
...
func (e *OLElement) DATASTAR_ON_INTERSECTRemove() *OLElement {
	if e.StringAttributes == nil {
		return e
	}
...
type OlOnIntervalMod customDataKeyModifier

// Sets the interval duration in milliseconds.
func OlOnIntervalModDurationMs(
	d time.Duration,
) OlOnIntervalMod {
	return func() string {
...
func OlOnIntervalModDurationMsLeading(
	d time.Duration,
) OlOnIntervalMod {
	return func() string {
...
func OlOnIntervalModDurationSec(
	d time.Duration,
) OlOnIntervalMod {
	return func() string {
...
// Sets the interval duration in seconds
// Execute the first interval immediately.
func OlOnIntervalModDurationSecLeading(
	d time.Duration,
) OlOnIntervalMod {
	return func() string {
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func OlOnIntervalModViewTransition() OlOnIntervalMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *OLElement) DATASTAR_ON_INTERVAL(expression string, modifiers ...OlOnIntervalMod) *OLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m OlOnIntervalMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on-interval
func (e *OLElement) IfDATASTAR_ON_INTERVAL(condition bool, expression string, modifiers ...OlOnIntervalMod) *OLElement {
	if condition {
...
func (e *OLElement) DATASTAR_ON_INTERVALRemove() *OLElement {
	if e.StringAttributes == nil {
		return e
	}
...
type OlOnSignalPatchMod customDataKeyModifier

// Delay the event listener in milliseconds.
func OlOnSignalPatchModDelayMs(
	d time.Duration,
) OlOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("delay.%dms", d.Milliseconds())
...
// Delay the event listener in seconds.
func OlOnSignalPatchModDelaySec(
	d time.Duration,
) OlOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("delay.%ds", int(d.Seconds()))
...
// Debounces the event handler
func OlOnSignalPatchModDebounceMs(
	d time.Duration,
) OlOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms", d.Milliseconds())
...
// Debounce the event listener in milliseconds with leading edge.
func OlOnSignalPatchModDebounceMsLeading(
	d time.Duration,
) OlOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.leading", d.Milliseconds())
...
// Debounce the event listener in milliseconds without trailing edge.
func OlOnSignalPatchModDebounceMsNoTrailing(
	d time.Duration,
) OlOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.notrailing", d.Milliseconds())
...
// Debounces the event handler
func OlOnSignalPatchModDebounceSec(
	d time.Duration,
) OlOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds", int(d.Seconds()))
...
// Debounce the event listener in seconds with leading edge.
func OlOnSignalPatchModDebounceSecLeading(
	d time.Duration,
) OlOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.leading", int(d.Seconds()))
...
// Debounce the event listener in seconds without trailing edge.
func OlOnSignalPatchModDebounceSecNoTrailing(
	d time.Duration,
) OlOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.notrailing", int(d.Seconds()))
...
// Throttles the event handler
func OlOnSignalPatchModThrottleMs(
	d time.Duration,
) OlOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms", d.Milliseconds())
...
// Throttle the event listener in milliseconds without leading edge.
func OlOnSignalPatchModThrottleMsNoLeading(
	d time.Duration,
) OlOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.noleading", d.Milliseconds())
...
// Throttle the event listener in milliseconds with trailing edge.
func OlOnSignalPatchModThrottleMsTrailing(
	d time.Duration,
) OlOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.trailing", d.Milliseconds())
...
// Throttles the event listener in seconds.
func OlOnSignalPatchModThrottleSec(
	d time.Duration,
) OlOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds", int(d.Seconds()))
...
// Throttle the event listener in seconds without leading edge.
func OlOnSignalPatchModThrottleSecNoLeading(
	d time.Duration,
) OlOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.noleading", int(d.Seconds()))
...
// Throttle the event listener in seconds with trailing edge.
func OlOnSignalPatchModThrottleSecTrailing(
	d time.Duration,
) OlOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.trailing", int(d.Seconds()))
...
func (e *OLElement) DATASTAR_ON_SIGNAL_PATCH(expression string, modifiers ...OlOnSignalPatchMod) *OLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m OlOnSignalPatchMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on-signal-patch
func (e *OLElement) IfDATASTAR_ON_SIGNAL_PATCH(condition bool, expression string, modifiers ...OlOnSignalPatchMod) *OLElement {
	if condition {
...
func (e *OLElement) DATASTAR_ON_SIGNAL_PATCHRemove() *OLElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *OLElement) DATASTAR_ON_SIGNAL_PATCH_FILTER(expression string) *OLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-on-signal-patch-filter
func (e *OLElement) IfDATASTAR_ON_SIGNAL_PATCH_FILTER(condition bool, expression string) *OLElement {
	if condition {
...
func (e *OLElement) DATASTAR_ON_SIGNAL_PATCH_FILTERRemove() *OLElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *OLElement) DATASTAR_PRESERVE_ATTR(expression string) *OLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-preserve-attr
func (e *OLElement) IfDATASTAR_PRESERVE_ATTR(condition bool, expression string) *OLElement {
	if condition {
...
func (e *OLElement) DATASTAR_PRESERVE_ATTRRemove() *OLElement {
	if e.StringAttributes == nil {
		return e
	}
...
type OlRefMod customDataKeyModifier
...
func (e *OLElement) DATASTAR_REF(expression string, modifiers ...OlRefMod) *OLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m OlRefMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-ref
func (e *OLElement) IfDATASTAR_REF(condition bool, expression string, modifiers ...OlRefMod) *OLElement {
	if condition {
...
func (e *OLElement) DATASTAR_SHOW(expression string) *OLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-show
func (e *OLElement) IfDATASTAR_SHOW(condition bool, expression string) *OLElement {
	if condition {
...
func (e *OLElement) DATASTAR_SHOWRemove() *OLElement {
	if e.StringAttributes == nil {
		return e
	}
...
type OlSignalsMod customDataKeyModifier
...
func OlSignalsModIfMissing() OlSignalsMod {
	return func() string {
		return "ifmissing"
	}
}
...
func (e *OLElement) DATASTAR_SIGNALS(key string, expression string, modifiers ...OlSignalsMod) *OLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m OlSignalsMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-signals
func (e *OLElement) IfDATASTAR_SIGNALS(condition bool, key string, expression string, modifiers ...OlSignalsMod) *OLElement {
	if condition {
...
func (e *OLElement) DATASTAR_SIGNALSRemove(key string) *OLElement {
	if e.StringAttributes == nil {
		return e
	}
...
type OlStyleMod customDataKeyModifier
...
func (e *OLElement) DATASTAR_STYLE(key string, expression string, modifiers ...OlStyleMod) *OLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m OlStyleMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-style
func (e *OLElement) IfDATASTAR_STYLE(condition bool, key string, expression string, modifiers ...OlStyleMod) *OLElement {
	if condition {
...
func (e *OLElement) DATASTAR_STYLERemove(key string) *OLElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *OLElement) DATASTAR_TEXT(expression string) *OLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-text
func (e *OLElement) IfDATASTAR_TEXT(condition bool, expression string) *OLElement {
	if condition {
