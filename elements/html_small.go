...
// package html small is generated from configuration file.
// Description:
package elements
...
// Create a new SMALLElement element.
// This will create a new element with the tag
// "small" during rendering.
...
func (e *SMALLElement) Attr(name string, value string) *SMALLElement {
...
func (e *SMALLElement) Attrs(attrs ...string) *SMALLElement {
	if len(attrs)%2 != 0 {
...
func (e *SMALLElement) AttrsMap(attrs map[string]string) *SMALLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	for k, v := range attrs {
...
func (e *SMALLElement) CustomData(key, value string) *SMALLElement {
...
func (e *SMALLElement) IfCustomData(condition bool, key, value string) *SMALLElement {
	if condition {
...
func (e *SMALLElement) CustomDataF(key, format string, args ...any) *SMALLElement {
	return e.CustomData(key, fmt.Sprintf(format, args...))
}

func (e *SMALLElement) IfCustomDataF(condition bool, key, format string, args ...any) *SMALLElement {
	if condition {
...
func (e *SMALLElement) CustomDataRemove(key string) *SMALLElement {
	if e.CustomDataAttributes == nil {
		return e
	}
...
const (
	...
	SmallAutocapitalize_off SmallAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	SmallAutocapitalize_none SmallAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	SmallAutocapitalize_sentences SmallAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	SmallAutocapitalize_on SmallAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	SmallAutocapitalize_words SmallAutocapitalizeChoice = "words"
	// Automatically capitalize all characters.
	SmallAutocapitalize_characters SmallAutocapitalizeChoice = "characters"
)
...
func (e *SMALLElement) AUTOCAPITALIZERemove(c SmallAutocapitalizeChoice) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
// sighted user on a small device will equally miss the context created by the
// preceding content.
func (e *SMALLElement) AUTOFOCUSRemove(b bool) *SMALLElement {
	if e.BoolAttributes == nil {
		return e
	}
...
const (
	...
	SmallContenteditable_empty SmallContenteditableChoice = ""
	// The element is editable.
	SmallContenteditable_true SmallContenteditableChoice = "true"
	// The element is not editable.
	SmallContenteditable_false SmallContenteditableChoice = "false"
	// which indicates that the element's raw text is editable, but rich text
	// formatting is disabled.
	SmallContenteditable_plaintext_only SmallContenteditableChoice = "plaintext-only"
)
...
func (e *SMALLElement) CONTENTEDITABLERemove(c SmallContenteditableChoice) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
const (
	...
	SmallDir_auto SmallDirChoice = "auto"
)
...
func (e *SMALLElement) DIRRemove(c SmallDirChoice) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
const (
	...
	SmallDraggable_true SmallDraggableChoice = "true"
	// The element is not draggable.
	SmallDraggable_false SmallDraggableChoice = "false"
	...
	SmallDraggable_empty SmallDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged
	// For other elements, the event ondragstart must be set for drag and drop to work
	SmallDraggable_auto SmallDraggableChoice = "auto"
)
...
func (e *SMALLElement) DRAGGABLERemove(c SmallDraggableChoice) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
const (
	...
	SmallEnterkeyhint_enter SmallEnterkeyhintChoice = "enter"
	// Typically meaning there is nothing more to input and the input method editor
	// (IME) will be closed.
	SmallEnterkeyhint_done SmallEnterkeyhintChoice = "done"
	// Typically meaning to take the user to the target of the text they typed.
	SmallEnterkeyhint_go SmallEnterkeyhintChoice = "go"
	// Typically meaning to take the user to the next field that will accept text.
	SmallEnterkeyhint_next SmallEnterkeyhintChoice = "next"
	// Typically meaning to take the user to the previous field that will accept text.
	SmallEnterkeyhint_previous SmallEnterkeyhintChoice = "previous"
	// Typically taking the user to the results of searching for the text they have
	// typed.
	SmallEnterkeyhint_search SmallEnterkeyhintChoice = "search"
	// Typically delivering the text to its target.
	SmallEnterkeyhint_send SmallEnterkeyhintChoice = "send"
)

// The enterkeyhint global attribute is an enumerated attribute defining what
// action label (or icon) to present for the enter key on virtual keyboards.
// Remove the attribute ENTERKEYHINT from the element.
func (e *SMALLElement) ENTERKEYHINTRemove(c SmallEnterkeyhintChoice) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
const (
	...
	SmallHidden_empty SmallHiddenChoice = ""
	// set the element to the hidden state
	// Additionally, invalid values set the element to the hidden state.
	SmallHidden_hidden SmallHiddenChoice = "hidden"
	...
	//
	SmallHidden_until_found SmallHiddenChoice = "until-found"
)
...
func (e *SMALLElement) HIDDENRemove(c SmallHiddenChoice) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SMALLElement) IDRemove(s string) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
// Its purpose is to identify the element when linking (using a fragment
// identifier), scripting, or styling (with CSS).
func (e *SMALLElement) IDRemoveF(format string, args ...any) *SMALLElement {
...
// Hides the element and its content from assistive technologies by excluding them
// from the accessibility tree.
func (e *SMALLElement) INERTRemove(b bool) *SMALLElement {
	if e.BoolAttributes == nil {
		return e
	}
...
const (
	...
	SmallInputmode_none SmallInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	SmallInputmode_empty SmallInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	SmallInputmode_text SmallInputmodeChoice = "text"
	...
	SmallInputmode_decimal SmallInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9
	// Devices may or may not show a minus key.
	SmallInputmode_numeric SmallInputmodeChoice = "numeric"
	...
	// type="tel"> instead.
	SmallInputmode_tel SmallInputmodeChoice = "tel"
	...
	// instead.
	SmallInputmode_search SmallInputmodeChoice = "search"
	...
	// instead.
	SmallInputmode_email SmallInputmodeChoice = "email"
	...
	SmallInputmode_url SmallInputmodeChoice = "url"
)
...
func (e *SMALLElement) INPUTMODERemove(c SmallInputmodeChoice) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SMALLElement) ISRemove(s string) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
// successfully defined in the current document, and extends the element type it
// is being applied to.
func (e *SMALLElement) ISRemoveF(format string, args ...any) *SMALLElement {
...
func (e *SMALLElement) ITEMIDRemove(s string) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
// The vocabulary defines whether several items with the same global identifier
// can coexist and, if so, how items with the same identifier are handled.
func (e *SMALLElement) ITEMIDRemoveF(format string, args ...any) *SMALLElement {
...
func (e *SMALLElement) ITEMPROPRemove(s string) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *SMALLElement) ITEMPROPRemoveF(format string, args ...any) *SMALLElement {
...
func (e *SMALLElement) ITEMREFRemove(s string) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
// with additional properties The itemref attribute can only be specified on
// elements that have an itemscope attribute specified.
func (e *SMALLElement) ITEMREFRemoveF(format string, args ...any) *SMALLElement {
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *SMALLElement) ITEMSCOPERemove(b bool) *SMALLElement {
	if e.BoolAttributes == nil {
		return e
	}
...
func (e *SMALLElement) ITEMTYPERemove(s string) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
// wide range of elements including <audio>, <embed>, <iframe>, <img>, <link>,
// <object>, <source>, <track>, and <video>.
func (e *SMALLElement) ITEMTYPERemoveF(format string, args ...any) *SMALLElement {
...
func (e *SMALLElement) LANGRemove(s string) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
// Identifying Languages (BCP47) IETF document
// xml:lang has priority over it.
func (e *SMALLElement) LANGRemoveF(format string, args ...any) *SMALLElement {
...
func (e *SMALLElement) NONCERemove(s string) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
// It is a cryptographic nonce (number used once) that is used by Content Security
// Policy to determine whether or not a given inline script is allowed to execute.
func (e *SMALLElement) NONCERemoveF(format string, args ...any) *SMALLElement {
...
const (
	...
	// on-screen at a time.
	SmallPopover_auto SmallPopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting outside
	// the popover area, and generally only allow one popover to be displayed
	// on-screen at a time.
	SmallPopover_empty SmallPopoverChoice = ""
	// manual popovers must always be explicitly hidden, but allow for use cases such
	// as nested popovers in menus.
	SmallPopover_manual SmallPopoverChoice = "manual"
)
...
func (e *SMALLElement) POPOVERRemove(c SmallPopoverChoice) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SMALLElement) ROLERemove(s string) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
// It is a simple string value that can be used to describe the role of an
// element.
func (e *SMALLElement) ROLERemoveF(format string, args ...any) *SMALLElement {
...
func (e *SMALLElement) SLOTRemove(s string) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
// the <slot> element whose name attribute's value matches that slot attribute's
// value.
func (e *SMALLElement) SLOTRemoveF(format string, args ...any) *SMALLElement {
...
const (
	...
	SmallSpellcheck_empty SmallSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	SmallSpellcheck_true SmallSpellcheckChoice = "true"
	// The element will not be checked for spelling errors.
	SmallSpellcheck_false SmallSpellcheckChoice = "false"
)
...
func (e *SMALLElement) SPELLCHECKRemove(c SmallSpellcheckChoice) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SMALLElement) STYLEF(k string, format string, args ...any) *SMALLElement {
...
// font, size, and more
// Styles are written in CSS.
func (e *SMALLElement) IfSTYLE(condition bool, k string, v string) *SMALLElement {
	if condition {
		e.STYLE(k, v)
	}
	return e
...
// font, size, and more
// Styles are written in CSS.
func (e *SMALLElement) STYLE(k string, v string) *SMALLElement {
	if e.KVStrings == nil {
...
// font, size, and more
// Styles are written in CSS.
func (e *SMALLElement) IfSTYLEF(condition bool, k string, format string, args ...any) *SMALLElement {
	if condition {
...
// font, size, and more
// Styles are written in CSS.
func (e *SMALLElement) IfSTYLEPairs(condition bool, pairs ...string) *SMALLElement {
	if condition {
		e.STYLEPairs(pairs...)
	}
	return e
...
func (e *SMALLElement) TABINDEXRemove(i int) *SMALLElement {
	if e.IntAttributes == nil {
		return e
	}
...
func (e *SMALLElement) TITLERemove(s string) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
// <input> element, this is not good practice
// Use a <label> instead.
func (e *SMALLElement) TITLERemoveF(format string, args ...any) *SMALLElement {
...
const (
	...
	SmallTranslate_empty SmallTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	SmallTranslate_yes SmallTranslateChoice = "yes"
	// indicates that the element must not be translated when the page is localized.
	SmallTranslate_no SmallTranslateChoice = "no"
)
...
func (e *SMALLElement) TRANSLATERemove(c SmallTranslateChoice) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SMALLElement) DATASTAR_ATTR(key string, expression string) *SMALLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-attr
func (e *SMALLElement) IfDATASTAR_ATTR(condition bool, key string, expression string) *SMALLElement {
	if condition {
...
func (e *SMALLElement) DATASTAR_ATTRRemove(key string) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SMALLElement) DATASTAR_BIND(key string, expression string) *SMALLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-bind
func (e *SMALLElement) IfDATASTAR_BIND(condition bool, key string, expression string) *SMALLElement {
	if condition {
...
func (e *SMALLElement) DATASTAR_BINDRemove(key string) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
type SmallClassMod customDataKeyModifier
...
func (e *SMALLElement) DATASTAR_CLASS(key string, expression string, modifiers ...SmallClassMod) *SMALLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m SmallClassMod, i int) customDataKeyModifier {
...
// Adds or removes a class to or from an element based on an expression.
func (e *SMALLElement) IfDATASTAR_CLASS(condition bool, key string, expression string, modifiers ...SmallClassMod) *SMALLElement {
	if condition {
...
func (e *SMALLElement) DATASTAR_CLASSRemove(key string) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
type SmallComputedMod customDataKeyModifier
...
func (e *SMALLElement) DATASTAR_COMPUTED(key string, expression string, modifiers ...SmallComputedMod) *SMALLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m SmallComputedMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-computed
func (e *SMALLElement) IfDATASTAR_COMPUTED(condition bool, key string, expression string, modifiers ...SmallComputedMod) *SMALLElement {
	if condition {
...
func (e *SMALLElement) DATASTAR_COMPUTEDRemove(key string) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SMALLElement) DATASTAR_EFFECT(expression string) *SMALLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-effect
func (e *SMALLElement) IfDATASTAR_EFFECT(condition bool, expression string) *SMALLElement {
	if condition {
...
func (e *SMALLElement) DATASTAR_EFFECTRemove() *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
type SmallIgnoreMod customDataKeyModifier

// Only ignore the element itself, not its descendants.
func SmallIgnoreModSelf() SmallIgnoreMod {
	return func() string {
		return "self"
	}
}
...
func (e *SMALLElement) DATASTAR_IGNORESet(b bool, modifiers ...SmallIgnoreMod) *SMALLElement {
	key := customDataKey("data-ignore")
	customMods := lo.Map(modifiers, func(m SmallIgnoreMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	if e.BoolAttributes == nil {
...
//
// See: https://data-star.dev/reference/attributes#data-ignore
func (e *SMALLElement) DATASTAR_IGNORE(modifiers ...SmallIgnoreMod) *SMALLElement {
...
func (e *SMALLElement) DATASTAR_IGNORE_MORPHSet(b bool) *SMALLElement {
...
//
// See: https://data-star.dev/reference/attributes#data-ignore-morph
func (e *SMALLElement) DATASTAR_IGNORE_MORPH() *SMALLElement {
	return e.DATASTAR_IGNORE_MORPHSet(true)
}

type SmallIndicatorMod customDataKeyModifier
...
func (e *SMALLElement) DATASTAR_INDICATOR(expression string, modifiers ...SmallIndicatorMod) *SMALLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m SmallIndicatorMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *SMALLElement) IfDATASTAR_INDICATOR(condition bool, expression string, modifiers ...SmallIndicatorMod) *SMALLElement {
	if condition {
...
func (e *SMALLElement) DATASTAR_INDICATORRemove() *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
type SmallInitMod customDataKeyModifier

// Delay the event listener in milliseconds.
func SmallInitModDelayMs(
	d time.Duration,
) SmallInitMod {
	return func() string {
...
func SmallInitModViewTransition() SmallInitMod {
	return func() string {
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *SMALLElement) DATASTAR_INIT(expression string, modifiers ...SmallInitMod) *SMALLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m SmallInitMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-indicator
func (e *SMALLElement) IfDATASTAR_INIT(condition bool, expression string, modifiers ...SmallInitMod) *SMALLElement {
	if condition {
...
func (e *SMALLElement) DATASTAR_INITRemove() *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SMALLElement) DATASTAR_JSON_SIGNALS(expression string, modifiers ...SmallJsonSignalsMod) *SMALLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m SmallJsonSignalsMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-json-signals
func (e *SMALLElement) IfDATASTAR_JSON_SIGNALS(condition bool, expression string, modifiers ...SmallJsonSignalsMod) *SMALLElement {
	if condition {
...
func (e *SMALLElement) DATASTAR_JSON_SIGNALSRemove() *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
type SmallOnMod customDataKeyModifier

// Only run the expression once
// Only works with built-in events.
func SmallOnModOnce() SmallOnMod {
	return func() string {
		return "once"
	}
}
...
// Only works with built-in events.
func SmallOnModPassive() SmallOnMod {
	return func() string {
		return "passive"
	}
}
...
// Only works with built-in events.
func SmallOnModCapture() SmallOnMod {
	return func() string {
		return "capture"
	}
}
...
func SmallOnModDebounceMsLeading(
	d time.Duration,
) SmallOnMod {
	return func() string {
...
func SmallOnModDebounceMsNoTrailing(
	d time.Duration,
) SmallOnMod {
	return func() string {
...
func SmallOnModDebounceSecLeading(
	d time.Duration,
) SmallOnMod {
	return func() string {
...
func SmallOnModDebounceSecNoTrailing(
	d time.Duration,
) SmallOnMod {
	return func() string {
...
func SmallOnModThrottleMsNoLeading(
	d time.Duration,
) SmallOnMod {
	return func() string {
...
func SmallOnModThrottleMsTrailing(
	d time.Duration,
) SmallOnMod {
	return func() string {
...
func SmallOnModThrottleSecNoLeading(
	d time.Duration,
) SmallOnMod {
	return func() string {
...
func SmallOnModThrottleSecTrailing(
	d time.Duration,
) SmallOnMod {
	return func() string {
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func SmallOnModViewTransition() SmallOnMod {
	return func() string {
		return "viewtransition"
	}
}
...
func SmallOnModWindow() SmallOnMod {
	return func() string {
		return "window"
	}
}
...
func SmallOnModPrevent() SmallOnMod {
	return func() string {
		return "prevent"
	}
}
...
func SmallOnModOutside() SmallOnMod {
	return func() string {
		return "outside"
	}
}
...
func SmallOnModStop() SmallOnMod {
	return func() string {
		return "stop"
	}
}
...
func (e *SMALLElement) DATASTAR_ON(key string, expression string, modifiers ...SmallOnMod) *SMALLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m SmallOnMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on
func (e *SMALLElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...SmallOnMod) *SMALLElement {
	if condition {
...
func (e *SMALLElement) DATASTAR_ONRemove(key string) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
type SmallOnIntersectMod customDataKeyModifier

// Only run the expression once
// Only works with built-in events.
func SmallOnIntersectModOnce() SmallOnIntersectMod {
	return func() string {
		return "once"
	}
}
...
func SmallOnIntersectModHalf() SmallOnIntersectMod {
	return func() string {
		return "half"
	}
}
...
func SmallOnIntersectModFull() SmallOnIntersectMod {
	return func() string {
		return "full"
	}
}
...
// Delay the event listener in milliseconds.
func SmallOnIntersectModDelayMs(
	d time.Duration,
) SmallOnIntersectMod {
	return func() string {
		return fmt.Sprintf("delay.%dms", d.Milliseconds())
...
// Delay the event listener in seconds.
func SmallOnIntersectModDelaySec(
	d time.Duration,
) SmallOnIntersectMod {
	return func() string {
		return fmt.Sprintf("delay.%ds", int(d.Seconds()))
...
// Debounces the event handler
func SmallOnIntersectModDebounceMs(
	d time.Duration,
) SmallOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms", d.Milliseconds())
...
// Debounce the event listener in milliseconds with leading edge.
func SmallOnIntersectModDebounceMsLeading(
	d time.Duration,
) SmallOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.leading", d.Milliseconds())
...
// Debounce the event listener in milliseconds without trailing edge.
func SmallOnIntersectModDebounceMsNoTrailing(
	d time.Duration,
) SmallOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.notrailing", d.Milliseconds())
...
// Debounces the event handler
func SmallOnIntersectModDebounceSec(
	d time.Duration,
) SmallOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds", int(d.Seconds()))
...
// Debounce the event listener in seconds with leading edge.
func SmallOnIntersectModDebounceSecLeading(
	d time.Duration,
) SmallOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.leading", int(d.Seconds()))
...
// Debounce the event listener in seconds without trailing edge.
func SmallOnIntersectModDebounceSecNoTrailing(
	d time.Duration,
) SmallOnIntersectMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.notrailing", int(d.Seconds()))
...
// Throttles the event handler
func SmallOnIntersectModThrottleMs(
	d time.Duration,
) SmallOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms", d.Milliseconds())
...
// Throttle the event listener in milliseconds without leading edge.
func SmallOnIntersectModThrottleMsNoLeading(
	d time.Duration,
) SmallOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.noleading", d.Milliseconds())
...
// Throttle the event listener in milliseconds with trailing edge.
func SmallOnIntersectModThrottleMsTrailing(
	d time.Duration,
) SmallOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.trailing", d.Milliseconds())
...
// Throttles the event listener in seconds.
func SmallOnIntersectModThrottleSec(
	d time.Duration,
) SmallOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds", int(d.Seconds()))
...
// Throttle the event listener in seconds without leading edge.
func SmallOnIntersectModThrottleSecNoLeading(
	d time.Duration,
) SmallOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.noleading", int(d.Seconds()))
...
// Throttle the event listener in seconds with trailing edge.
func SmallOnIntersectModThrottleSecTrailing(
	d time.Duration,
) SmallOnIntersectMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.trailing", int(d.Seconds()))
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func SmallOnIntersectModViewTransition() SmallOnIntersectMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *SMALLElement) DATASTAR_ON_INTERSECT(expression string, modifiers ...SmallOnIntersectMod) *SMALLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m SmallOnIntersectMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
// Runs an expression when the element intersects with the viewport.
func (e *SMALLElement) IfDATASTAR_ON_INTERSECT(condition bool, expression string, modifiers ...SmallOnIntersectMod) *SMALLElement {
	if condition {
...
func (e *SMALLElement) DATASTAR_ON_INTERSECTRemove() *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
type SmallOnIntervalMod customDataKeyModifier

// Sets the interval duration in milliseconds.
func SmallOnIntervalModDurationMs(
	d time.Duration,
) SmallOnIntervalMod {
	return func() string {
...
func SmallOnIntervalModDurationMsLeading(
	d time.Duration,
) SmallOnIntervalMod {
	return func() string {
...
func SmallOnIntervalModDurationSec(
	d time.Duration,
) SmallOnIntervalMod {
	return func() string {
...
// Sets the interval duration in seconds
// Execute the first interval immediately.
func SmallOnIntervalModDurationSecLeading(
	d time.Duration,
) SmallOnIntervalMod {
	return func() string {
...
// Wraps the expression in 'document.startViewTransition()' when the View
// Transition API is available.
func SmallOnIntervalModViewTransition() SmallOnIntervalMod {
	return func() string {
		return "viewtransition"
	}
}
...
func (e *SMALLElement) DATASTAR_ON_INTERVAL(expression string, modifiers ...SmallOnIntervalMod) *SMALLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m SmallOnIntervalMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on-interval
func (e *SMALLElement) IfDATASTAR_ON_INTERVAL(condition bool, expression string, modifiers ...SmallOnIntervalMod) *SMALLElement {
	if condition {
...
func (e *SMALLElement) DATASTAR_ON_INTERVALRemove() *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
type SmallOnSignalPatchMod customDataKeyModifier

// Delay the event listener in milliseconds.
func SmallOnSignalPatchModDelayMs(
	d time.Duration,
) SmallOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("delay.%dms", d.Milliseconds())
	}
}
...
// Delay the event listener in seconds.
func SmallOnSignalPatchModDelaySec(
	d time.Duration,
) SmallOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("delay.%ds", int(d.Seconds()))
...
// Debounces the event handler
func SmallOnSignalPatchModDebounceMs(
	d time.Duration,
) SmallOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms", d.Milliseconds())
...
// Debounce the event listener in milliseconds with leading edge.
func SmallOnSignalPatchModDebounceMsLeading(
	d time.Duration,
) SmallOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.leading", d.Milliseconds())
...
// Debounce the event listener in milliseconds without trailing edge.
func SmallOnSignalPatchModDebounceMsNoTrailing(
	d time.Duration,
) SmallOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%dms.notrailing", d.Milliseconds())
...
// Debounces the event handler
func SmallOnSignalPatchModDebounceSec(
	d time.Duration,
) SmallOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds", int(d.Seconds()))
...
// Debounce the event listener in seconds with leading edge.
func SmallOnSignalPatchModDebounceSecLeading(
	d time.Duration,
) SmallOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.leading", int(d.Seconds()))
...
// Debounce the event listener in seconds without trailing edge.
func SmallOnSignalPatchModDebounceSecNoTrailing(
	d time.Duration,
) SmallOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("debounce.%ds.notrailing", int(d.Seconds()))
...
// Throttles the event handler
func SmallOnSignalPatchModThrottleMs(
	d time.Duration,
) SmallOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms", d.Milliseconds())
...
// Throttle the event listener in milliseconds without leading edge.
func SmallOnSignalPatchModThrottleMsNoLeading(
	d time.Duration,
) SmallOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.noleading", d.Milliseconds())
...
// Throttle the event listener in milliseconds with trailing edge.
func SmallOnSignalPatchModThrottleMsTrailing(
	d time.Duration,
) SmallOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%dms.trailing", d.Milliseconds())
...
// Throttles the event listener in seconds.
func SmallOnSignalPatchModThrottleSec(
	d time.Duration,
) SmallOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds", int(d.Seconds()))
...
// Throttle the event listener in seconds without leading edge.
func SmallOnSignalPatchModThrottleSecNoLeading(
	d time.Duration,
) SmallOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.noleading", int(d.Seconds()))
...
// Throttle the event listener in seconds with trailing edge.
func SmallOnSignalPatchModThrottleSecTrailing(
	d time.Duration,
) SmallOnSignalPatchMod {
	return func() string {
		return fmt.Sprintf("throttle.%ds.trailing", int(d.Seconds()))
...
func (e *SMALLElement) DATASTAR_ON_SIGNAL_PATCH(expression string, modifiers ...SmallOnSignalPatchMod) *SMALLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m SmallOnSignalPatchMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-on-signal-patch
func (e *SMALLElement) IfDATASTAR_ON_SIGNAL_PATCH(condition bool, expression string, modifiers ...SmallOnSignalPatchMod) *SMALLElement {
	if condition {
...
func (e *SMALLElement) DATASTAR_ON_SIGNAL_PATCHRemove() *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SMALLElement) DATASTAR_ON_SIGNAL_PATCH_FILTER(expression string) *SMALLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-on-signal-patch-filter
func (e *SMALLElement) IfDATASTAR_ON_SIGNAL_PATCH_FILTER(condition bool, expression string) *SMALLElement {
	if condition {
...
func (e *SMALLElement) DATASTAR_ON_SIGNAL_PATCH_FILTERRemove() *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SMALLElement) DATASTAR_PRESERVE_ATTR(expression string) *SMALLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-preserve-attr
func (e *SMALLElement) IfDATASTAR_PRESERVE_ATTR(condition bool, expression string) *SMALLElement {
	if condition {
...
func (e *SMALLElement) DATASTAR_PRESERVE_ATTRRemove() *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
type SmallRefMod customDataKeyModifier
...
func (e *SMALLElement) DATASTAR_REF(expression string, modifiers ...SmallRefMod) *SMALLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m SmallRefMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-ref
func (e *SMALLElement) IfDATASTAR_REF(condition bool, expression string, modifiers ...SmallRefMod) *SMALLElement {
	if condition {
...
func (e *SMALLElement) DATASTAR_REFRemove() *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SMALLElement) DATASTAR_SHOW(expression string) *SMALLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-show
func (e *SMALLElement) IfDATASTAR_SHOW(condition bool, expression string) *SMALLElement {
	if condition {
...
func (e *SMALLElement) DATASTAR_SHOWRemove() *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
type SmallSignalsMod customDataKeyModifier
...
func SmallSignalsModIfMissing() SmallSignalsMod {
	return func() string {
		return "ifmissing"
	}
}
...
func (e *SMALLElement) DATASTAR_SIGNALS(key string, expression string, modifiers ...SmallSignalsMod) *SMALLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m SmallSignalsMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-signals
func (e *SMALLElement) IfDATASTAR_SIGNALS(condition bool, key string, expression string, modifiers ...SmallSignalsMod) *SMALLElement {
	if condition {
...
func (e *SMALLElement) DATASTAR_SIGNALSRemove(key string) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
type SmallStyleMod customDataKeyModifier
...
func (e *SMALLElement) DATASTAR_STYLE(key string, expression string, modifiers ...SmallStyleMod) *SMALLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m SmallStyleMod, i int) customDataKeyModifier {
		return customDataKeyModifier(m)
	})
	key = customDataKey(key, customMods...)
	e.StringAttributes.Set(key, expression)
...
//
// See: https://data-star.dev/reference/attributes#data-style
func (e *SMALLElement) IfDATASTAR_STYLE(condition bool, key string, expression string, modifiers ...SmallStyleMod) *SMALLElement {
	if condition {
...
func (e *SMALLElement) DATASTAR_STYLERemove(key string) *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SMALLElement) DATASTAR_TEXT(expression string) *SMALLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
//
// See: https://data-star.dev/reference/attributes#data-text
func (e *SMALLElement) IfDATASTAR_TEXT(condition bool, expression string) *SMALLElement {
	if condition {
...
func (e *SMALLElement) DATASTAR_TEXTRemove() *SMALLElement {
	if e.StringAttributes == nil {
		return e
	}
