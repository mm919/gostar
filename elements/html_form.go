...
// package html form is generated from configuration file.
// Description:
package elements
...
// Create a new FORMElement element.
// This will create a new element with the tag
// "form" during rendering.
...
func (e *FORMElement) Attr(name string, value string) *FORMElement {
...
func (e *FORMElement) Attrs(attrs ...string) *FORMElement {
	if len(attrs)%2 != 0 {
...
func (e *FORMElement) AttrsMap(attrs map[string]string) *FORMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	for k, v := range attrs {
...
func (e *FORMElement) ACCEPT_CHARSET(s string) *FORMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
const (
	...
	// (Default)
	FormAutocomplete_on FormAutocompleteChoice = "on"
...
const (
	...
	FormEnctype_application_x_www_form_urlencoded FormEnctypeChoice = "application/x-www-form-urlencoded"
	// Use this value if you are using enctype that requires a file upload.
	FormEnctype_multipart_form_data FormEnctypeChoice = "multipart/form-data"
...
const (
	...
	// (Default)
	FormMethod_get FormMethodChoice = "get"
	// The browser method to use when submitting the form.
...
const (
	...
	FormTarget__self FormTargetChoice = "_self"
	// Load the response into a new unnamed browsing context.
	FormTarget__blank FormTargetChoice = "_blank"
	...
	FormTarget__parent FormTargetChoice = "_parent"
...
const (
	...
	FormAutocapitalize_off FormAutocapitalizeChoice = "off"
	// Do not automatically capitalize any text.
	FormAutocapitalize_none FormAutocapitalizeChoice = "none"
	// Automatically capitalize the first character of each sentence.
	FormAutocapitalize_sentences FormAutocapitalizeChoice = "sentences"
	// Automatically capitalize the first character of each sentence.
	FormAutocapitalize_on FormAutocapitalizeChoice = "on"
	// Automatically capitalize the first character of each word.
	FormAutocapitalize_words FormAutocapitalizeChoice = "words"
...
const (
	...
	FormContenteditable_empty FormContenteditableChoice = ""
	// The element is editable.
	FormContenteditable_true FormContenteditableChoice = "true"
	// The element is not editable.
	FormContenteditable_false FormContenteditableChoice = "false"
...
const (
	...
	FormDraggable_true FormDraggableChoice = "true"
	// The element is not draggable.
	FormDraggable_false FormDraggableChoice = "false"
	...
	FormDraggable_empty FormDraggableChoice = ""
	// drag behavior is the default browser behavior: only text selections, images,
	// and links can be dragged
	// For other elements, the event ondragstart must be set for drag and drop to work
...
const (
	...
	FormHidden_empty FormHiddenChoice = ""
	// set the element to the hidden state
	// Additionally, invalid values set the element to the hidden state.
	FormHidden_hidden FormHiddenChoice = "hidden"
...
const (
	...
	FormInputmode_none FormInputmodeChoice = "none"
	// Standard input keyboard for the user's current locale.
	FormInputmode_empty FormInputmodeChoice = ""
	// Standard input keyboard for the user's current locale.
	FormInputmode_text FormInputmodeChoice = "text"
	...
	FormInputmode_decimal FormInputmodeChoice = "decimal"
	// Numeric input keyboard, but only requires the digits 0–9
	// Devices may or may not show a minus key.
	FormInputmode_numeric FormInputmodeChoice = "numeric"
	...
	// type="tel"> instead.
	FormInputmode_tel FormInputmodeChoice = "tel"
	...
	// instead.
	FormInputmode_search FormInputmodeChoice = "search"
	...
	// instead.
	FormInputmode_email FormInputmodeChoice = "email"
...
const (
	...
	// on-screen at a time.
	FormPopover_auto FormPopoverChoice = "auto"
	// Popovers that have the auto state can be "light dismissed" by selecting outside
	// the popover area, and generally only allow one popover to be displayed
	// on-screen at a time.
	FormPopover_empty FormPopoverChoice = ""
...
const (
	...
	FormSpellcheck_empty FormSpellcheckChoice = ""
	// The element will be checked for spelling errors.
	FormSpellcheck_true FormSpellcheckChoice = "true"
...
const (
	...
	FormTranslate_empty FormTranslateChoice = ""
	// indicates that the element should be translated when the page is localized.
	FormTranslate_yes FormTranslateChoice = "yes"
