...
func (m *Attribute_KV) CloneVT() *Attribute_KV {
	...
	r := new(Attribute_KV)
	r.KeyValueDelimiter = m.KeyValueDelimiter
	r.PairDelimiter = m.PairDelimiter
...
func (m *Attribute_Custom_Modifier) CloneVT() *Attribute_Custom_Modifier {
	...
	r := new(Attribute_Custom_Modifier)
	r.Name = m.Name
	r.Description = m.Description
...
func (m *Attribute_Type_Delimited) CloneVT() isAttribute_Type_Type {
	...
	r := new(Attribute_Type_Delimited)
	r.Delimited = m.Delimited
	return r
}
...
func (m *Attribute_Type_Choices) CloneVT() isAttribute_Type_Type {
	...
	r := new(Attribute_Type_Choices)
	r.Choices = m.Choices.CloneVT()
	return r
}
...
func (m *Attribute_Type_DurationMs) CloneVT() isAttribute_Type_Type {
	...
	r := new(Attribute_Type_DurationMs)
...
func (m *Attribute_KV) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.PairDelimiter) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.PairDelimiter)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.KeyValueDelimiter) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.KeyValueDelimiter)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *Attribute_Type_Delimited) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.Delimited)))
	i--
	dAtA[i] = 0x12
	return len(dAtA) - i, nil
}
...
func (m *Attribute_KV) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.KeyValueDelimiter = stringValue
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PairDelimiter", wireType)
...
func (m *Attribute_Custom) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Modifiers = append(m.Modifiers, &Attribute_Custom_Modifier{})
			if err := m.Modifiers[len(m.Modifiers)-1].UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *Attribute_Type) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Type = &Attribute_Type_Delimited{Delimited: stringValue}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Kv", wireType)
			...
			if oneof, ok := m.Type.(*Attribute_Type_Kv); ok {
				if err := oneof.Kv.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &Attribute_KV{}
		...
		case 7:
			...
			if oneof, ok := m.Type.(*Attribute_Type_Choices); ok {
				if err := oneof.Choices.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &Attribute_Choices{}
